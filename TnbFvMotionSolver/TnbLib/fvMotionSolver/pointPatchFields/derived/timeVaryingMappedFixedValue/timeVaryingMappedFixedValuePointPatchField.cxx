#include <timeVaryingMappedFixedValuePointPatchField.hxx>
...
template<class Type>
tnbLib::timeVaryingMappedFixedValuePointPatchField<Type>::
...
template<class Type>
void tnbLib::timeVaryingMappedFixedValuePointPatchField<Type>::autoMap
(
...
template<class Type>
void tnbLib::timeVaryingMappedFixedValuePointPatchField<Type>::rmap
(
...
template<class Type>
void tnbLib::timeVaryingMappedFixedValuePointPatchField<Type>::checkTable()
{
	// Initialise
...
template<class Type>
void tnbLib::timeVaryingMappedFixedValuePointPatchField<Type>::updateCoeffs()
{
	if (this->updated())
	{
		return;
...
template<class Type>
void tnbLib::timeVaryingMappedFixedValuePointPatchField<Type>::write
(
	Ostream& os
) const
{
