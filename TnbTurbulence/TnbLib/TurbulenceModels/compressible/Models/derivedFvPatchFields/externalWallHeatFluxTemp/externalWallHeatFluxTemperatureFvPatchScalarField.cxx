#include <externalWallHeatFluxTemperatureFvPatchScalarField.hxx>
...
using tnbLib::constant::physicoChemical::sigma;
...
<
	tnbLib::externalWallHeatFluxTemperatureFvPatchScalarField::operationMode,
	3
> tnbLib::externalWallHeatFluxTemperatureFvPatchScalarField::operationModeNames;
...
void tnbLib::externalWallHeatFluxTemperatureFvPatchScalarField::autoMap
(
...
void tnbLib::externalWallHeatFluxTemperatureFvPatchScalarField::rmap
(
...
void tnbLib::externalWallHeatFluxTemperatureFvPatchScalarField::updateCoeffs()
{
	if (updated())
	{
		return;
...
void tnbLib::externalWallHeatFluxTemperatureFvPatchScalarField::write
(
	Ostream& os
) const
{
