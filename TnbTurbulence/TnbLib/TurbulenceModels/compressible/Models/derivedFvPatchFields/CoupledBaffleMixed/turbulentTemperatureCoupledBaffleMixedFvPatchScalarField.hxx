...
namespace tnbLib
{
	namespace compressible
	{
		...
		public:
			...
			static const char* typeName_() { return "compressible::turbulentTemperatureCoupledBaffleMixed"; }
			...
			FoamTurbulence_EXPORT turbulentTemperatureCoupledBaffleMixedFvPatchScalarField
			(
				const fvPatch&,
