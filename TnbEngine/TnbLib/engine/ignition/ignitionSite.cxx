...
void tnbLib::ignitionSite::findIgnitionCells(const fvMesh& mesh)
{
...
const tnbLib::labelList& tnbLib::ignitionSite::cells() const
{
...
bool tnbLib::ignitionSite::igniting() const
{
...
bool tnbLib::ignitionSite::ignited() const
{
    scalar curTime = db_.value();
    scalar deltaT = db_.deltaTValue();
