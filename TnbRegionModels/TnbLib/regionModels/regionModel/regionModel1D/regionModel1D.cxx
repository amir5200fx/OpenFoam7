...
void tnbLib::regionModels::regionModel1D::constructMeshObjects()
{
	nMagSfPtr_.reset
	(
...
void tnbLib::regionModels::regionModel1D::initialise()
{
	if (debug)
	{
...
bool tnbLib::regionModels::regionModel1D::read()
{
	if (regionModel::read())
	{
...
bool tnbLib::regionModels::regionModel1D::read(const dictionary& dict)
{
...
tnbLib::tmp<tnbLib::labelField> tnbLib::regionModels::regionModel1D::moveMesh
(
...
tnbLib::regionModels::regionModel1D::regionModel1D
(
	const fvMesh& mesh,
