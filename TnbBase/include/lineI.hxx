...
inline tnbLib::line<Point, PointRef>::line(const Point& start, const Point& end)
	:
	a_(start),
	b_(end)
{}
...
template<class Point, class PointRef>
inline tnbLib::line<Point, PointRef>::line
(
...
template<class Point, class PointRef>
inline tnbLib::line<Point, PointRef>::line(Istream& is)
{
	is >> *this;
}
...
template<class Point, class PointRef>
inline PointRef tnbLib::line<Point, PointRef>::start() const
{
	return a_;
}

template<class Point, class PointRef>
inline PointRef tnbLib::line<Point, PointRef>::end() const
{
	return b_;
}
...
template<class Point, class PointRef>
inline Point tnbLib::line<Point, PointRef>::centre() const
{
	return 0.5*(a_ + b_);
}
...
template<class Point, class PointRef>
inline tnbLib::scalar tnbLib::line<Point, PointRef>::mag() const
{
...
template<class Point, class PointRef>
inline Point tnbLib::line<Point, PointRef>::vec() const
{
	return b_ - a_;
}
...
template<class Point, class PointRef>
tnbLib::PointHit<Point> tnbLib::line<Point, PointRef>::nearestDist
(
	const Point& p
) const
{
...
template<class Point, class PointRef>
tnbLib::scalar tnbLib::line<Point, PointRef>::nearestDist
(
...
template<class Point, class PointRef>
bool tnbLib::line<Point, PointRef>::insideBoundBox(const Point& p) const
{
	if
		(
