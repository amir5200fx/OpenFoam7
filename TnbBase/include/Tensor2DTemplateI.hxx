...
template<class Cmpt>
inline tnbLib::Tensor2D<Cmpt>::Tensor2D()
{}


template<class Cmpt>
inline tnbLib::Tensor2D<Cmpt>::Tensor2D(const tnbLib::zero)
	:
...
template<class Cmpt>
inline tnbLib::Tensor2D<Cmpt>::Tensor2D(const SymmTensor2D<Cmpt>& st)
{
...
template<class Cmpt>
inline tnbLib::Tensor2D<Cmpt>::Tensor2D(const SphericalTensor2D<Cmpt>& st)
{
...
template<class Cmpt>
inline tnbLib::Tensor2D<Cmpt>::Tensor2D(Istream& is)
	:
	Tensor2D::msType(is)
{}
...
template<class Cmpt>
inline tnbLib::Vector2D<Cmpt> tnbLib::Tensor2D<Cmpt>::x() const
{
	return Vector2D<Cmpt>(this->v_[XX], this->v_[XY]);
}

template<class Cmpt>
inline tnbLib::Vector2D<Cmpt> tnbLib::Tensor2D<Cmpt>::y() const
{
...
template<class Cmpt>
inline const Cmpt& tnbLib::Tensor2D<Cmpt>::xx() const
{
	return this->v_[XX];
}

template<class Cmpt>
inline const Cmpt& tnbLib::Tensor2D<Cmpt>::xy() const
{
	return this->v_[XY];
}

template<class Cmpt>
inline const Cmpt& tnbLib::Tensor2D<Cmpt>::yx() const
{
	return this->v_[YX];
}

template<class Cmpt>
inline const Cmpt& tnbLib::Tensor2D<Cmpt>::yy() const
{
	return this->v_[YY];
}
...
template<class Cmpt>
inline Cmpt& tnbLib::Tensor2D<Cmpt>::xx()
{
	return this->v_[XX];
}

template<class Cmpt>
inline Cmpt& tnbLib::Tensor2D<Cmpt>::xy()
{
	return this->v_[XY];
}

template<class Cmpt>
inline Cmpt& tnbLib::Tensor2D<Cmpt>::yx()
{
	return this->v_[YX];
}

template<class Cmpt>
inline Cmpt& tnbLib::Tensor2D<Cmpt>::yy()
{
	return this->v_[YY];
}
...
template<class Cmpt>
inline tnbLib::Tensor2D<Cmpt> tnbLib::Tensor2D<Cmpt>::T() const
{
...
template<class Cmpt>
inline void tnbLib::Tensor2D<Cmpt>::operator=(const SymmTensor2D<Cmpt>& st)
{
	this->v_[XX] = st.xx(); this->v_[XY] = st.xy();
	this->v_[YX] = st.xy(); this->v_[YY] = st.yy();
}
...
template<class Cmpt>
inline void tnbLib::Tensor2D<Cmpt>::operator=(const SphericalTensor2D<Cmpt>& st)
{
	this->v_[XX] = st.ii(); this->v_[XY] = 0;
	this->v_[YX] = 0; this->v_[YY] = st.ii();
}
