...
template<class Type>
tnbLib::Distribution<Type>::Distribution()
	:
...
template<class Type>
tnbLib::Distribution<Type>::Distribution(const Type& binWidth)
	:
	List<List<scalar>>(pTraits<Type>::nComponents),
	binWidth_(binWidth),
	listStarts_(pTraits<Type>::nComponents, 0)
...
template<class Type>
tnbLib::Distribution<Type>::Distribution(const Distribution<Type>& d)
	:
	List<List<scalar>>(d),
...
template<class Type>
tnbLib::Distribution<Type>::Distribution(Distribution<Type>&& d)
	:
...
template<class Type>
tnbLib::scalar tnbLib::Distribution<Type>::totalWeight(direction cmpt) const
{
...
template<class Type>
tnbLib::List<tnbLib::label> tnbLib::Distribution<Type>::keys(direction cmpt) const
{
...
template<class Type>
tnbLib::label tnbLib::Distribution<Type>::index
(
	direction cmpt,
	label n
)
...
template<class Type>
tnbLib::Pair<tnbLib::label> tnbLib::Distribution<Type>::validLimits
(
	direction cmpt
) const
{
...
template<class Type>
Type tnbLib::Distribution<Type>::mean() const
{
	Type meanValue(Zero);
...
template<class Type>
Type tnbLib::Distribution<Type>::median() const
{
...
template<class Type>
void tnbLib::Distribution<Type>::add
(
...
template<class Type>
tnbLib::List<tnbLib::List<tnbLib::Pair<tnbLib::scalar>>>tnbLib::
...
template<class Type>
void tnbLib::Distribution<Type>::clear()
{
	for (direction cmpt = 0; cmpt < pTraits<Type>::nComponents; cmpt++)
	{
		(*this)[cmpt].clear();
...
template<class Type>
void tnbLib::Distribution<Type>::write(const fileName& filePrefix) const
{
	List<List<Pair<scalar>>> rawDistribution = raw();
...
template<class Type>
void tnbLib::Distribution<Type>::operator=
(
...
template<class Type>
tnbLib::Distribution<Type> tnbLib::operator+
(
