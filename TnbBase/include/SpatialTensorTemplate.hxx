#pragma once
#ifndef _SpatialTensorTemplate_Header
#define _SpatialTensorTemplate_Header
...
See also
	tnbLib::MatrixSpace
	tnbLib::Tensor
	tnbLib::SpatialVector

\*---------------------------------------------------------------------------*/

#include <TensorTemplate.hxx>
#include <SpatialVectorTemplate.hxx>
...
namespace tnbLib
{
	...
	public:
		...
		inline SpatialTensor(const tnbLib::zero);
...
#include <SpatialTensorTemplateI.hxx>

#endif // !_SpatialTensorTemplate_Header
