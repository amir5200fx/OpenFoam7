...
template<unsigned nBits>
tnbLib::Ostream& tnbLib::PackedList<nBits>::iteratorBase::printInfo
(
	Ostream& os
) const
{
...
template<unsigned nBits>
tnbLib::Ostream& tnbLib::PackedList<nBits>::printBits
(
	Ostream& os,
...
template<unsigned nBits>
tnbLib::Ostream& tnbLib::PackedList<nBits>::printInfo
(
	Ostream& os,
	const bool fullOutput
) const
...
template<unsigned nBits>
tnbLib::Istream& tnbLib::PackedList<nBits>::read(Istream& is)
{
...
template<unsigned nBits>
tnbLib::Ostream& tnbLib::PackedList<nBits>::write
(
	Ostream& os,
...
template<unsigned nBits>
void tnbLib::PackedList<nBits>::operator=(PackedList<nBits>&& lst)
{
	transfer(lst);
}
...
template<unsigned nBits>
void tnbLib::PackedList<nBits>::operator=(const labelUList& lst)
{
...
template<unsigned nBits>
void tnbLib::PackedList<nBits>::operator=(const UIndirectList<label>& lst)
{
	setCapacity(lst.size());
	size_ = lst.size();
...
template<unsigned nBits>
void tnbLib::writeEntry(Ostream& os, const PackedList<nBits>& l)
{
	os << l;
}
...
template<unsigned nBits>
tnbLib::Istream& tnbLib::operator>>(Istream& is, PackedList<nBits>& lst)
{
	return lst.read(is);
}
