...
void tnbLib::mapDistributeBase::flipAndCombine
(
...
T tnbLib::mapDistributeBase::accessAndFlip
(
	const UList<T>& fld,
	const label index,
	const bool hasFlip,
...
// Distribute list.
template<class T, class negateOp>
void tnbLib::mapDistributeBase::distribute
(
...
template<class T>
void tnbLib::mapDistributeBase::send(PstreamBuffers& pBufs, const List<T>& field)
const
{
	// Stream data into buffer
	for (label domain = 0; domain < Pstream::nProcs(); domain++)
...
template<class T>
void tnbLib::mapDistributeBase::receive(PstreamBuffers& pBufs, List<T>& field)
const
{
	// Consume
...
template<class T>
void tnbLib::mapDistributeBase::reverseDistribute
(
	const label constructSize,
	List<T>& fld,
	const int tag
