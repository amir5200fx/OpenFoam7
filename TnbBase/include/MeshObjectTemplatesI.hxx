...
tnbLib::MeshObject<Mesh, MeshObjectType, Type>::MeshObject(const Mesh& mesh)
	:
...
template<class Mesh, template<class> class MeshObjectType, class Type>
const Type& tnbLib::MeshObject<Mesh, MeshObjectType, Type>::New
(
	const Mesh& mesh
)
{
...
template<class Mesh, template<class> class MeshObjectType, class Type>
bool tnbLib::MeshObject<Mesh, MeshObjectType, Type>::Delete(const Mesh& mesh)
{
	if
		(
			mesh.thisDb().objectRegistry::template foundObject<Type>
...
template<class Mesh, template<class> class MeshObjectType, class Type>
tnbLib::MeshObject<Mesh, MeshObjectType, Type>::~MeshObject()
{
...
template<class Mesh>
void tnbLib::meshObject::movePoints(objectRegistry& obr)
{
...
template<class Mesh>
void tnbLib::meshObject::updateMesh(objectRegistry& obr, const mapPolyMesh& mpm)
{
	HashTable<GeometricMeshObject<Mesh>*> meshObjects
	(
		obr.lookupClass<GeometricMeshObject<Mesh>>()
...
template<class Mesh>
void tnbLib::meshObject::addPatch(objectRegistry& obr, const label patchi)
{
	HashTable<GeometricMeshObject<Mesh>*> meshObjects
	(
		obr.lookupClass<GeometricMeshObject<Mesh>>()
...
template<class Mesh>
void tnbLib::meshObject::reorderPatches
(
	objectRegistry& obr,
...
void tnbLib::meshObject::clear(objectRegistry& obr)
{
...
>
void tnbLib::meshObject::clearUpto(objectRegistry& obr)
{
