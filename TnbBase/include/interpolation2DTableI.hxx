#pragma once
#include <openFoamTableReader.hxx>

// * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * //

template<class Type>
void tnbLib::interpolation2DTable<Type>::readTable()
{
...
template<class Type>
tnbLib::interpolation2DTable<Type>::interpolation2DTable()
	:
...
template<class Type>
tnbLib::interpolation2DTable<Type>::interpolation2DTable(const fileName& fName)
	:
	List<Tuple2<scalar, List<Tuple2<scalar, Type>>>>(),
	boundsHandling_(interpolation2DTable::WARN),
	fileName_(fName),
...
template<class Type>
tnbLib::interpolation2DTable<Type>::interpolation2DTable(const dictionary& dict)
	:
	List<Tuple2<scalar, List<Tuple2<scalar, Type>>>>(),
...
template<class Type>
Type tnbLib::interpolation2DTable<Type>::interpolateValue
(
...
tnbLib::label tnbLib::interpolation2DTable<Type>::Xi
(
	const BinaryOp& bop,
	const scalar valueX,
	const bool reverse
...
template<class Type>
Type tnbLib::interpolation2DTable<Type>::operator()
(
	const scalar valueX,
	const scalar valueY
	) const
...
template<class Type>
tnbLib::word tnbLib::interpolation2DTable<Type>::boundsHandlingToWord
(
...
template<class Type>
typename tnbLib::interpolation2DTable<Type>::boundsHandling
tnbLib::interpolation2DTable<Type>::wordToBoundsHandling
(
	const word& bound
) const
{
...
template<class Type>
typename tnbLib::interpolation2DTable<Type>::boundsHandling
tnbLib::interpolation2DTable<Type>::outOfBounds
(
	const boundsHandling& bound
)
{
...
template<class Type>
void tnbLib::interpolation2DTable<Type>::checkOrder() const
{
	label n = this->size();
	const table& t = *this;
...
template<class Type>
void tnbLib::interpolation2DTable<Type>::write(Ostream& os) const
{
