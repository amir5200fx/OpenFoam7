#include <QRMatrix.hxx>

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class MatrixType>
tnbLib::QRMatrix<MatrixType>::QRMatrix(const MatrixType& M)
{
	decompose(M);
}
...
template<class MatrixType>
void tnbLib::QRMatrix<MatrixType>::decompose(const MatrixType& M)
{
	const label m = M.m();
	const label n = M.n();
...
template<class MatrixType>
void tnbLib::QRMatrix<MatrixType>::solvex
(
	Field<cmptType>& x
) const
{
...
template<class MatrixType>
void tnbLib::QRMatrix<MatrixType>::solve
(
	Field<cmptType>& x,
...
template<class MatrixType>
tnbLib::tmp<tnbLib::Field<typename MatrixType::cmptType>>
tnbLib::QRMatrix<MatrixType>::solve
(
	const Field<cmptType>& source
) const
{
...
template<class MatrixType>
typename tnbLib::QRMatrix<MatrixType>::QMatrixType
tnbLib::QRMatrix<MatrixType>::inv() const
{
	const label m = Q_.m();
