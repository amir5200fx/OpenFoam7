#include <LduMatrixTemplate.hxx> // added by amir

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

template<class Type, class DType, class LUType>
void tnbLib::LduMatrix<Type, DType, LUType>::sumDiag()
{
...
template<class Type, class DType, class LUType>
void tnbLib::LduMatrix<Type, DType, LUType>::negSumDiag()
{
	if (!lowerPtr_ && !upperPtr_)
	{
		return;
...
template<class Type, class DType, class LUType>
void tnbLib::LduMatrix<Type, DType, LUType>::sumMagOffDiag
(
	Field<LUType>& sumOff
) const
{
...
tnbLib::LduMatrix<Type, DType, LUType>::H(const Field<Type>& psi) const
{
...
template<class Type, class DType, class LUType>
tnbLib::tmp<tnbLib::Field<Type>>
tnbLib::LduMatrix<Type, DType, LUType>::H(const tmp<Field<Type>>& tpsi) const
{
...
template<class Type, class DType, class LUType>
tnbLib::tmp<tnbLib::Field<Type>>
tnbLib::LduMatrix<Type, DType, LUType>::faceH(const Field<Type>& psi) const
{
	const Field<LUType>& Lower = const_cast<const LduMatrix&>(*this).lower();
	const Field<LUType>& Upper = const_cast<const LduMatrix&>(*this).upper();
...
template<class Type, class DType, class LUType>
tnbLib::tmp<tnbLib::Field<Type>>
tnbLib::LduMatrix<Type, DType, LUType>::faceH(const tmp<Field<Type>>& tpsi) const
{
...
template<class Type, class DType, class LUType>
void tnbLib::LduMatrix<Type, DType, LUType>::operator=(const LduMatrix& A)
{
	if (this == &A)
	{
...
template<class Type, class DType, class LUType>
void tnbLib::LduMatrix<Type, DType, LUType>::negate()
{
	if (diagPtr_)
	{
		diagPtr_->negate();
...
template<class Type, class DType, class LUType>
void tnbLib::LduMatrix<Type, DType, LUType>::operator*=
(
...
template<class Type, class DType, class LUType>
void tnbLib::LduMatrix<Type, DType, LUType>::operator*=(scalar s)
{
	if (diagPtr_)
	{
		*diagPtr_ *= s;
