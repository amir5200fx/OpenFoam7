...
void tnbLib::GAMGProcAgglomeration::printStats
(
	Ostream& os,
...
tnbLib::labelListList tnbLib::GAMGProcAgglomeration::globalCellCells
(
	const lduMesh& mesh
)
{
	...
	forAll(cellCells, celli)
	{
		tnbLib::stableSort(cellCells[celli]);
	}
...
bool tnbLib::GAMGProcAgglomeration::agglomerate
(
...
tnbLib::GAMGProcAgglomeration::GAMGProcAgglomeration
(
	GAMGAgglomeration& agglom,
...
tnbLib::autoPtr<tnbLib::GAMGProcAgglomeration> tnbLib::GAMGProcAgglomeration::New
(
	const word& type,
	GAMGAgglomeration& agglom,
	const dictionary& controlDict
