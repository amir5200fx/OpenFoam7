...
(
	...
	:
	MeshObject<lduMesh, tnbLib::GeometricMeshObject, GAMGAgglomeration>(mesh),
...
tnbLib::autoPtr<tnbLib::GAMGAgglomeration> tnbLib::GAMGAgglomeration::New
(
	const lduMesh& mesh,
...
bool tnbLib::GAMGAgglomeration::hasMeshLevel(const label i) const
{
	if (i == 0)
	{
		return true;
...
void tnbLib::GAMGAgglomeration::clearLevel(const label i)
{
	if (hasMeshLevel(i))
	{
...
const tnbLib::labelList& tnbLib::GAMGAgglomeration::procAgglomMap
(
	const label leveli
) const
{
...
const tnbLib::labelList& tnbLib::GAMGAgglomeration::agglomProcIDs
(
	const label leveli
) const
{
...
bool tnbLib::GAMGAgglomeration::hasProcMesh(const label leveli) const
{
	return procCommunicator_[leveli] != -1;
}


tnbLib::label tnbLib::GAMGAgglomeration::procCommunicator(const label leveli) const
{
	return procCommunicator_[leveli];
}


const tnbLib::labelList& tnbLib::GAMGAgglomeration::cellOffsets
(
	const label leveli
) const
{
...
const tnbLib::labelListList& tnbLib::GAMGAgglomeration::faceMap
(
	const label leveli
) const
{
...
const tnbLib::labelListList& tnbLib::GAMGAgglomeration::boundaryMap
(
	const label leveli
) const
{
...
const tnbLib::labelListListList& tnbLib::GAMGAgglomeration::boundaryFaceMap
(
	const label leveli
) const
{
...
bool tnbLib::GAMGAgglomeration::checkRestriction
(
