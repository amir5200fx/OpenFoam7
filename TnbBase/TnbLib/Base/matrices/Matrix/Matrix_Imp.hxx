...
template<class Form, class Type>
tnbLib::Matrix<Form, Type>::Matrix(const label m, const label n)
	:
	mRows_(m),
	nCols_(n),
	v_(nullptr)
...
template<class Form, class Type>
tnbLib::Matrix<Form, Type>::Matrix(const label m, const label n, const zero)
	:
	mRows_(m),
	nCols_(n),
	v_(nullptr)
...
template<class Form, class Type>
tnbLib::Matrix<Form, Type>::Matrix(const label m, const label n, const Type& s)
	:
	mRows_(m),
	nCols_(n),
	v_(nullptr)
...
template<class Form, class Type>
tnbLib::Matrix<Form, Type>::Matrix(const Matrix<Form, Type>& M)
	:
	mRows_(M.mRows_),
	nCols_(M.nCols_),
	v_(nullptr)
...
tnbLib::Matrix<Form, Type>::Matrix(const Matrix<Form2, Type>& M)
	:
	mRows_(M.m()),
	nCols_(M.n()),
	v_(nullptr)
...
template<class Form, class Type>
void tnbLib::Matrix<Form, Type>::transfer(Matrix<Form, Type>& M)
{
	clear();
...
template<class Form, class Type>
void tnbLib::Matrix<Form, Type>::setSize(const label m, const label n)
{
...
template<class Form, class Type>
void tnbLib::Matrix<Form, Type>::operator=(const Matrix<Form, Type>& M)
{
	if (this == &M)
	{
		FatalErrorInFunction
...
template<class Form, class Type>
template<class MatrixType>
void tnbLib::Matrix<Form, Type>::operator=
(
	const ConstMatrixBlock<MatrixType>& Mb
	)
{
...
template<class Form, class Type>
void tnbLib::Matrix<Form, Type>::operator=(const Type& s)
{
	if (v_)
	{
		const label mn = size();
...
template<class Form, class Type>
void tnbLib::Matrix<Form, Type>::operator=(const zero)
{
	if (v_)
	{
		const label mn = size();
...
template<class Form, class Type>
const Type& tnbLib::max(const Matrix<Form, Type>& M)
{
...
template<class Form, class Type>
const Type& tnbLib::min(const Matrix<Form, Type>& M)
{
	const label mn = M.size();
...
template<class Form, class Type>
Form tnbLib::operator-(const Matrix<Form, Type>& M)
{
	Form nM(M.m(), M.n());
...
template<class Form, class Type>
Form tnbLib::operator*(const scalar s, const Matrix<Form, Type>& M)
{
	Form sM(M.m(), M.n());
...
template<class Form, class Type>
Form tnbLib::operator*(const Matrix<Form, Type>& M, const scalar s)
{
	Form sM(M.m(), M.n());
...
typename tnbLib::typeOfInnerProduct<Type, Form1, Form2>::type
tnbLib::operator*
(
...
template<class Form, class Type>
inline tnbLib::tmp<tnbLib::Field<Type>> tnbLib::operator*
(
