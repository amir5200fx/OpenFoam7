    ...
    (                                                                          \
        ...
        (                                                                      \
            ...
            Dfunc(df1.dimensions())                                            \
                                                                               ...
                                                                               \
    tnbLib::OpFunc(tRes.ref().field(), df1.field());                             \
                                                                               \
    return tRes;                                                               \
}                                                                              \
                                                                               \
    ...
    (                                                                          \
        ...
        (                                                                      \
            ...
            dt1.dimensions() Op df2.dimensions()                               \
                                                                               ...
                                                                               \
    tnbLib::OpFunc(tRes.ref().field(), dt1.value(), df2.field());                \
                                                                               \
    return tRes;                                                               \
}                                                                              \
                                                                               \
    ...
    (                                                                          \
        ...
        (                                                                      \
            ...
            dt1.dimensions() Op df2.dimensions()                               \
                                                                               ...
                                                                               \
    tnbLib::OpFunc(tRes.ref().field(), dt1.value(), tdf2().field());             \
                                                                               \
    tdf2.clear();                                                              \
                                                                               \
    return tRes;                                                               \
    ...
    (                                                                          \
        ...
        (                                                                      \
            ...
            df1.dimensions() Op dt2.dimensions()                               \
                                                                               ...
                                                                               \
    tnbLib::OpFunc(tRes.ref().field(), df1.field(), dt2.value());                \
                                                                               \
    return tRes;                                                               \
}                                                                              \
                                                                               \
    ...
    (                                                                          \
        ...
        (                                                                      \
            ...
            df1.dimensions() Op dt2.dimensions()                               \
                                                                               ...
                                                                               \
    tnbLib::OpFunc(tRes.ref().field(), tdf1().field(), dt2.value());             \
                                                                               \
    tdf1.clear();                                                              \
                                                                               \
    return tRes;                                                               \
