...
void tnbLib::ISstream::readWordToken(token& t)
{
	word* wPtr = new word;
...
tnbLib::Istream& tnbLib::ISstream::readVariable(string& str)
{
	static const int maxLen = 1024;
	static const int errLen = 80; // truncate error message for readability
	static char buf[maxLen];
...
tnbLib::Istream& tnbLib::ISstream::readVerbatim(string& str)
{
