...
tnbLib::decomposedBlockData::decomposedBlockData
(
	const label comm,
	const IOobject& io,
...
bool tnbLib::decomposedBlockData::readMasterHeader(IOobject& io, Istream& is)
{
	if (debug)
	{
...
void tnbLib::decomposedBlockData::writeHeader
(
	Ostream& os,
...
tnbLib::autoPtr<tnbLib::ISstream> tnbLib::decomposedBlockData::readBlock
(
	const label blocki,
	Istream& is,
	IOobject& headerIO
...
bool tnbLib::decomposedBlockData::readBlocks
(
	const label comm,
...
tnbLib::autoPtr<tnbLib::ISstream> tnbLib::decomposedBlockData::readBlocks
(
	const label comm,
...
void tnbLib::decomposedBlockData::gather
(
	const label comm,
	const label data,
	labelList& datas
...
void tnbLib::decomposedBlockData::gatherSlaveData
(
	const label comm,
...
tnbLib::label tnbLib::decomposedBlockData::calcNumProcs
(
	const label comm,
...
bool tnbLib::decomposedBlockData::writeBlocks
(
	const label comm,
...
bool tnbLib::decomposedBlockData::read()
{
	autoPtr<ISstream> isPtr;
...
bool tnbLib::decomposedBlockData::writeData(Ostream& os) const
{
...
bool tnbLib::decomposedBlockData::writeObject
(
	IOstream::streamFormat fmt,
...
tnbLib::label tnbLib::decomposedBlockData::numBlocks(const fileName& fName)
{
	label nBlocks = 0;
