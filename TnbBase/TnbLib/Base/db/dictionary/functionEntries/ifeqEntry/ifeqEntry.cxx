...
void tnbLib::functionEntries::ifeqEntry::readToken(token& t, Istream& is)
{
...
tnbLib::token tnbLib::functionEntries::ifeqEntry::expand
(
...
bool tnbLib::functionEntries::ifeqEntry::equalToken
(
	const token& t1,
	const token& t2
)
...
void tnbLib::functionEntries::ifeqEntry::skipUntil
(
...
bool tnbLib::functionEntries::ifeqEntry::evaluate
(
	const bool doIf,
	DynamicList<filePos>& stack,
...
bool tnbLib::functionEntries::ifeqEntry::execute
(
	const bool doIf,
	DynamicList<filePos>& stack,
	dictionary& parentDict,
