...
namespace tnbLib
{
	namespace fileOperations
	{
		...
		(
			tnbLib::debug::floatOptimisationSwitch("maxMasterFileBufferSize", 1e9)
		);
		registerOptSwitch
		(
...
tnbLib::labelList tnbLib::fileOperations::masterUncollatedFileOperation::subRanks
(
	const label n
)
{
...
tnbLib::word
tnbLib::fileOperations::masterUncollatedFileOperation::findInstancePath
(
...
tnbLib::fileName
tnbLib::fileOperations::masterUncollatedFileOperation::filePathInfo
(
...
tnbLib::fileName
tnbLib::fileOperations::masterUncollatedFileOperation::localObjectPath
(
	const IOobject& io,
...
) const
{
	...
	case fileOperation::PROCUNCOLLATED:
	{
		...
		(
			"processor"
			+ tnbLib::name(Pstream::myProcNo(Pstream::worldComm))
		);
		return
			processorsPath
			(
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::uniformFile
(
...
void tnbLib::fileOperations::masterUncollatedFileOperation::readAndSend
(
...
)
{
	...
	{
		off_t count(tnbLib::fileSize(filePath));
...
tnbLib::fileOperations::masterUncollatedFileOperation::read
(
	IOobject& io,
	const label comm,
...
tnbLib::fileOperations::masterUncollatedFileOperation::
masterUncollatedFileOperation
(
	const bool verbose
)
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::mkDir
(
	const fileName& dir,
	mode_t mode
) const
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::chMod
(
...
tnbLib::mode_t 
tnbLib::fileOperations::masterUncollatedFileOperation::mode
(
	const fileName& fName,
...
tnbLib::fileType tnbLib::fileOperations::masterUncollatedFileOperation::type
(
	const fileName& fName,
	const bool checkVariants,
	const bool followLink
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::exists
(
	const fileName& fName,
	const bool checkVariants,
	const bool followLink
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::isDir
(
	const fileName& fName,
	const bool followLink
) const
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::isFile
(
	const fileName& fName,
	const bool checkVariants,
	const bool followLink
...
off_t tnbLib::fileOperations::masterUncollatedFileOperation::fileSize
(
	const fileName& fName,
	const bool checkVariants,
	const bool followLink
...
time_t tnbLib::fileOperations::masterUncollatedFileOperation::lastModified
(
	const fileName& fName,
	const bool checkVariants,
	const bool followLink
...
double tnbLib::fileOperations::masterUncollatedFileOperation::highResLastModified
(
	const fileName& fName,
	const bool checkVariants,
	const bool followLink
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::mvBak
(
	const fileName& fName,
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::rm
(
	const fileName& fName
) const
{
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::rmDir
(
	const fileName& dir
) const
{
...
tnbLib::fileNameList tnbLib::fileOperations::masterUncollatedFileOperation::readDir
(
	const fileName& dir,
	const fileType type,
	const bool filtergz,
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::cp
(
	const fileName& src,
	const fileName& dst,
	const bool followLink
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::ln
(
	const fileName& src,
	const fileName& dst
) const
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::mv
(
	const fileName& src,
	const fileName& dst,
	const bool followLink
...
tnbLib::fileName tnbLib::fileOperations::masterUncollatedFileOperation::filePath
(
	const bool checkGlobal,
	const IOobject& io,
	const word& typeName
...
tnbLib::fileName tnbLib::fileOperations::masterUncollatedFileOperation::dirPath
(
	const bool checkGlobal,
	const IOobject& io
) const
...
tnbLib::IOobject
tnbLib::fileOperations::masterUncollatedFileOperation::findInstance
(
...
tnbLib::fileNameList
tnbLib::fileOperations::masterUncollatedFileOperation::readObjects
(
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::readHeader
(
	IOobject& io,
	const fileName& fName,
	const word& typeName
...
tnbLib::autoPtr<tnbLib::ISstream>
tnbLib::fileOperations::masterUncollatedFileOperation::readStream
(
	regIOobject& io,
	const fileName& fName,
	const word& typeName,
...
) const
{
	...
	if (isCollated)
	{
		...
		else
		{
			...
			// Get size of file
			off_t sz = tnbLib::fileSize(fName);
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::read
(
	regIOobject& io,
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::writeObject
(
...
tnbLib::instantList tnbLib::fileOperations::masterUncollatedFileOperation::findTimes
(
...
void tnbLib::fileOperations::masterUncollatedFileOperation::setTime
(
	const Time& tm
) const
{
...
tnbLib::autoPtr<tnbLib::ISstream>
tnbLib::fileOperations::masterUncollatedFileOperation::NewIFstream
(
	const fileName& filePath
) const
{
...
tnbLib::fileOperations::masterUncollatedFileOperation::NewOFstream
(
...
void tnbLib::fileOperations::masterUncollatedFileOperation::flush() const
{
	fileOperation::flush();
	times_.clear();
}
...
tnbLib::label tnbLib::fileOperations::masterUncollatedFileOperation::addWatch
(
	const fileName& fName
) const
{
...
bool tnbLib::fileOperations::masterUncollatedFileOperation::removeWatch
(
...
tnbLib::label tnbLib::fileOperations::masterUncollatedFileOperation::findWatch
(
...
void tnbLib::fileOperations::masterUncollatedFileOperation::addWatches
(
	regIOobject& rio,
...
tnbLib::fileName tnbLib::fileOperations::masterUncollatedFileOperation::getFile
(
	const label watchIndex
) const
{
...
void tnbLib::fileOperations::masterUncollatedFileOperation::updateStates
(
	const bool masterOnly,
	const bool syncPar
) const
...
tnbLib::fileMonitor::fileState
tnbLib::fileOperations::masterUncollatedFileOperation::getState
(
	const label watchFd
) const
{
...
void tnbLib::fileOperations::masterUncollatedFileOperation::setUnmodified
(
	const label watchFd
) const
{
