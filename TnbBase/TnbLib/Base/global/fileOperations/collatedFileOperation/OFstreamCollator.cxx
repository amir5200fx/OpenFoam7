...
bool tnbLib::OFstreamCollator::writeFile
(
	const label comm,
	const word& typeName,
...
void* tnbLib::OFstreamCollator::writeAll(void *threadarg)
{
...
void tnbLib::OFstreamCollator::waitForBufferSpace(const off_t wantedSize) const
{
	while (true)
	{
...
tnbLib::OFstreamCollator::OFstreamCollator(const off_t maxBufferSize)
	:
...
tnbLib::OFstreamCollator::OFstreamCollator
(
...
bool tnbLib::OFstreamCollator::write
(
	const word& typeName,
	const fileName& fName,
	const string& data,
...
void tnbLib::OFstreamCollator::waitAll()
{
