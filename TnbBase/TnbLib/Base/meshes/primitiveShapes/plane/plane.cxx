...
tnbLib::FixedList<tnbLib::scalar, 4> tnbLib::plane::planeCoeffs() const
{
...
tnbLib::point tnbLib::plane::aPoint() const
{
	// Perturb base point
...
tnbLib::plane::side tnbLib::plane::sideOfPlane(const point& p) const
{
...
tnbLib::point tnbLib::plane::mirror(const point& p) const
{
...
void tnbLib::plane::writeDict(Ostream& os) const
{
