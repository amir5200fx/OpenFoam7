...
tnbLib::scalar tnbLib::primitiveMeshTools::faceSkewness
(
...
tnbLib::scalar tnbLib::primitiveMeshTools::boundaryFaceSkewness
(
	const primitiveMesh& mesh,
	const pointField& p,
	const vectorField& fCtrs,
...
tnbLib::scalar tnbLib::primitiveMeshTools::faceOrthogonality
(
	const point& ownCc,
	const point& neiCc,
	const vector& s
...
tnbLib::tmp<tnbLib::scalarField> tnbLib::primitiveMeshTools::faceOrthogonality
(
	const primitiveMesh& mesh,
...
tnbLib::tmp<tnbLib::scalarField> tnbLib::primitiveMeshTools::faceSkewness
(
	const primitiveMesh& mesh,
	const pointField& p,
	const vectorField& fCtrs,
...
void tnbLib::primitiveMeshTools::facePyramidVolume
(
	const primitiveMesh& mesh,
...
void tnbLib::primitiveMeshTools::cellClosedness
(
	const primitiveMesh& mesh,
...
tnbLib::tmp<tnbLib::scalarField> tnbLib::primitiveMeshTools::faceConcavity
(
	const scalar maxSin,
	const primitiveMesh& mesh,
	const pointField& p,
...
tnbLib::tmp<tnbLib::scalarField> tnbLib::primitiveMeshTools::faceFlatness
(
	const primitiveMesh& mesh,
	const pointField& p,
	const vectorField& fCtrs,
...
tnbLib::tmp<tnbLib::scalarField> tnbLib::primitiveMeshTools::cellDeterminant
(
	const primitiveMesh& mesh,
	const Vector<label>& meshD,
	const vectorField& faceAreas,
