...
void tnbLib::primitiveMesh::calcEdges(const bool doFaceEdges) const
{
	if (debug)
	{
...
const tnbLib::labelListList& tnbLib::primitiveMesh::pointEdges() const
{
	if (!pePtr_)
	{
		// calcEdges(true);
