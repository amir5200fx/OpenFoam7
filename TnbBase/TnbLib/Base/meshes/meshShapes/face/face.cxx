...
bool tnbLib::face::sameVertices(const face& a, const face& b)
{
	label sizeA = a.size();
	label sizeB = b.size();
...
tnbLib::point tnbLib::face::centre(const pointField& points) const
{
...
tnbLib::vector tnbLib::face::area(const pointField& p) const
{
	const label nPoints = size();
...
tnbLib::vector tnbLib::face::normal(const pointField& points) const
{
...
tnbLib::tensor tnbLib::face::inertia
(
	const pointField& p,
	const point& refPt,
	scalar density
...
tnbLib::label tnbLib::longestEdge(const face& f, const pointField& pts)
{
