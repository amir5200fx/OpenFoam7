...
const tnbLib::List<tnbLib::labelPairList>&
...
const tnbLib::labelList& tnbLib::polyBoundaryMesh::patchID() const
{
...
const tnbLib::HashTable<tnbLib::labelList, tnbLib::word>&
tnbLib::polyBoundaryMesh::groupPatchIDs() const
{
...
void tnbLib::polyBoundaryMesh::setGroup
(
...
tnbLib::labelList tnbLib::polyBoundaryMesh::findIndices
(
	const keyType& key,
...
tnbLib::label tnbLib::polyBoundaryMesh::findIndex(const keyType& key) const
{
	if (!key.empty())
	{
		if (key.isPattern())
...
void tnbLib::polyBoundaryMesh::matchGroups
(
...
void tnbLib::polyBoundaryMesh::shuffle
(
