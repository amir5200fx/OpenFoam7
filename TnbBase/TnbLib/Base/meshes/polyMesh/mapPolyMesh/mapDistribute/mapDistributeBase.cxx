...
tnbLib::List<tnbLib::labelPair> tnbLib::mapDistributeBase::schedule
(
...
const tnbLib::List<tnbLib::labelPair>& tnbLib::mapDistributeBase::schedule() const
{
...
void tnbLib::mapDistributeBase::checkReceivedSize
(
	const label proci,
...
void tnbLib::mapDistributeBase::printLayout(Ostream& os) const
{
...
void tnbLib::mapDistributeBase::calcCompactAddressing
(
...
void tnbLib::mapDistributeBase::exchangeAddressing
(
	const int tag,
	const globalIndex& globalNumbering,
	labelList& elements,
...
tnbLib::mapDistributeBase::mapDistributeBase()
	:
	constructSize_(0),
	subHasFlip_(false),
...
tnbLib::mapDistributeBase::mapDistributeBase(const mapDistributeBase& map)
	:
...
tnbLib::mapDistributeBase::mapDistributeBase(mapDistributeBase&& map)
	:
	constructSize_(map.constructSize_),
...
tnbLib::mapDistributeBase::mapDistributeBase(Istream& is)
{
	is >> *this;
}
...
void tnbLib::mapDistributeBase::transfer(mapDistributeBase& rhs)
{
...
tnbLib::label tnbLib::mapDistributeBase::renumber
(
	const globalIndex& globalNumbering,
...
void tnbLib::mapDistributeBase::compact(const boolList& elemIsUsed, const int tag)
{
...
void tnbLib::mapDistributeBase::compact
(
