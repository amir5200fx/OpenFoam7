...
void tnbLib::globalMeshData::calcSharedPoints() const
{
	if
		(
			nGlobalPoints_ != -1
...
void tnbLib::globalMeshData::calcGlobalPointSlaves() const
{
	if (debug)
	{
...
void tnbLib::globalMeshData::calcPointConnectivity
(
...
void tnbLib::globalMeshData::calcGlobalPointEdges
(
...
tnbLib::label tnbLib::globalMeshData::findTransform
(
...
void tnbLib::globalMeshData::calcGlobalEdgeSlaves() const
{
	if (debug)
	{
...
void tnbLib::globalMeshData::calcGlobalEdgeOrientation() const
{
	if (debug)
	{
...
void tnbLib::globalMeshData::calcPointBoundaryFaces
(
...
void tnbLib::globalMeshData::calcGlobalPointBoundaryFaces() const
{
	if (debug)
	{
...
void tnbLib::globalMeshData::calcGlobalPointBoundaryCells() const
{
	if (debug)
	{
...
void tnbLib::globalMeshData::calcGlobalCoPointSlaves() const
{
	if (debug)
	{
...
tnbLib::label tnbLib::globalMeshData::nGlobalPoints() const
{
	if (nGlobalPoints_ == -1)
	{
		calcSharedPoints();
...
const tnbLib::labelList& tnbLib::globalMeshData::sharedPointLabels() const
{
...
const tnbLib::labelList& tnbLib::globalMeshData::sharedPointAddr() const
{
...
const tnbLib::indirectPrimitivePatch& tnbLib::globalMeshData::coupledPatch() const
{
...
const tnbLib::labelList& tnbLib::globalMeshData::coupledPatchMeshEdges() const
{
...
const tnbLib::Map<tnbLib::label>& tnbLib::globalMeshData::coupledPatchMeshEdgeMap()
const
{
...
const tnbLib::globalIndex& tnbLib::globalMeshData::globalPointNumbering() const
{
...
const tnbLib::globalIndexAndTransform&
tnbLib::globalMeshData::globalTransforms() const
{
...
const tnbLib::labelListList& tnbLib::globalMeshData::globalPointSlaves() const
{
...
const tnbLib::labelListList& tnbLib::globalMeshData::globalPointTransformedSlaves()
const
{
...
const tnbLib::mapDistribute& tnbLib::globalMeshData::globalPointSlavesMap() const
{
...
const tnbLib::globalIndex& tnbLib::globalMeshData::globalEdgeNumbering() const
{
...
const tnbLib::labelListList& tnbLib::globalMeshData::globalEdgeSlaves() const
{
...
const tnbLib::labelListList& tnbLib::globalMeshData::globalEdgeTransformedSlaves()
const
{
...
const tnbLib::PackedBoolList& tnbLib::globalMeshData::globalEdgeOrientation() const
{
...
const tnbLib::mapDistribute& tnbLib::globalMeshData::globalEdgeSlavesMap() const
{
...
const tnbLib::globalIndex& tnbLib::globalMeshData::globalBoundaryFaceNumbering()
const
{
...
const tnbLib::labelListList& tnbLib::globalMeshData::globalPointBoundaryFaces()
const
{
...
tnbLib::globalMeshData::globalPointTransformedBoundaryFaces() const
{
...
const tnbLib::mapDistribute& tnbLib::globalMeshData::globalPointBoundaryFacesMap()
const
{
...
const tnbLib::labelList& tnbLib::globalMeshData::boundaryCells() const
{
...
const tnbLib::globalIndex& tnbLib::globalMeshData::globalBoundaryCellNumbering()
const
{
...
const tnbLib::labelListList& tnbLib::globalMeshData::globalPointBoundaryCells()
const
{
...
const tnbLib::labelListList&
tnbLib::globalMeshData::globalPointTransformedBoundaryCells() const
{
...
const tnbLib::mapDistribute& tnbLib::globalMeshData::globalPointBoundaryCellsMap()
const
{
...
const tnbLib::labelListList& tnbLib::globalMeshData::globalCoPointSlaves() const
{
...
const tnbLib::mapDistribute& tnbLib::globalMeshData::globalCoPointSlavesMap() const
{
...
tnbLib::autoPtr<tnbLib::globalIndex> tnbLib::globalMeshData::mergePoints
(
