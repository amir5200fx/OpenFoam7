...
tnbLib::label tnbLib::globalPoints::findSamePoint
(
...
tnbLib::labelPairList tnbLib::globalPoints::addSendTransform
(
	const label patchi,
...
tnbLib::label tnbLib::globalPoints::meshToLocalPoint
(
...
tnbLib::label tnbLib::globalPoints::localToMeshPoint
(
...
bool tnbLib::globalPoints::storeInitialInfo
(
	const labelPairList& nbrInfo,
	const label localPointi
)
...
void tnbLib::globalPoints::printProcPoint
(
	const labelList& patchToMeshPoint,
...
void tnbLib::globalPoints::printProcPoints
(
	const labelList& patchToMeshPoint,
...
void tnbLib::globalPoints::sendPatchPoints
(
...
void tnbLib::globalPoints::receivePatchPoints
(
	const bool mergeSeparated,
	const Map<label>& meshToPatchPoint,
	const labelList& patchToMeshPoint,
...
void tnbLib::globalPoints::remove
(
	const labelList& patchToMeshPoint,
...
tnbLib::labelList tnbLib::globalPoints::reverseMeshPoints
(
...
void tnbLib::globalPoints::calculateSharedPoints
(
	const Map<label>& meshToPatchPoint, // from mesh point to local numbering
...
tnbLib::globalPoints::globalPoints
(
	const polyMesh& mesh,
	const bool keepAllPoints,
	const bool mergeSeparated
