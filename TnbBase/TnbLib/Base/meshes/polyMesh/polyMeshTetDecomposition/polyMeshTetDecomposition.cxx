...
const tnbLib::scalar tnbLib::polyMeshTetDecomposition::minTetQuality = sqr(small);


// * * * * * * * * * * * * * Static Member Functions * * * * * * * * * * * * //

tnbLib::scalar tnbLib::polyMeshTetDecomposition::minQuality
(
	const polyMesh& mesh,
	const point& cC,
	const label fI,
...
tnbLib::label tnbLib::polyMeshTetDecomposition::findSharedBasePoint
(
	const polyMesh& mesh,
	label fI,
	const point& nCc,
...
tnbLib::label tnbLib::polyMeshTetDecomposition::findBasePoint
(
	const polyMesh& mesh,
	label fI,
	scalar tol,
...
tnbLib::labelList tnbLib::polyMeshTetDecomposition::findFaceBasePts
(
	const polyMesh& mesh,
	scalar tol,
	bool report
...
bool tnbLib::polyMeshTetDecomposition::checkFaceTets
(
	const polyMesh& mesh,
	scalar tol,
	const bool report,
...
tnbLib::List<tnbLib::tetIndices> tnbLib::polyMeshTetDecomposition::faceTetIndices
(
	const polyMesh& mesh,
	label fI,
	label cI
...
tnbLib::List<tnbLib::tetIndices> tnbLib::polyMeshTetDecomposition::cellTetIndices
(
	const polyMesh& mesh,
	label cI
)
...
tnbLib::tetIndices tnbLib::polyMeshTetDecomposition::findTet
(
	const polyMesh& mesh,
	label cI,
	const point& pt
