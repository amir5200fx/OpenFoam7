...
void tnbLib::cyclicPolyPatch::calcTransforms()
{
	if (size())
	{
		// Half0
...
tnbLib::vector tnbLib::cyclicPolyPatch::findFaceMaxRadius
(
...
const tnbLib::word& tnbLib::cyclicPolyPatch::neighbPatchName() const
{
...
tnbLib::label tnbLib::cyclicPolyPatch::neighbPatchID() const
{
	if (neighbPatchID_ == -1)
	{
...
void tnbLib::cyclicPolyPatch::transformPosition(pointField& l) const
{
	if (!parallel())
	{
		if (transform() == ROTATIONAL)
		{
			l =
				tnbLib::transform(forwardT(), l - rotationCentre_)
				+ rotationCentre_;
		}
		else
		{
...
void tnbLib::cyclicPolyPatch::transformPosition(point& l, const label facei) const
{
	if (!parallel())
	{
		const tensor& T =
...
void tnbLib::cyclicPolyPatch::initGeometry(PstreamBuffers& pBufs)
{
...
void tnbLib::cyclicPolyPatch::calcGeometry(PstreamBuffers& pBufs)
{
	calcGeometry
	(
		*this,
...
void tnbLib::cyclicPolyPatch::initMovePoints
(
...
void tnbLib::cyclicPolyPatch::movePoints
(
	PstreamBuffers& pBufs,
	const pointField& p
)
...
void tnbLib::cyclicPolyPatch::initUpdateMesh(PstreamBuffers& pBufs)
{
	polyPatch::initUpdateMesh(pBufs);
}


void tnbLib::cyclicPolyPatch::updateMesh(PstreamBuffers& pBufs)
{
...
void tnbLib::cyclicPolyPatch::initOrder
(
	PstreamBuffers&,
