...
tnbLib::pointField tnbLib::oldCyclicPolyPatch::calcFaceCentres
(
...
tnbLib::pointField tnbLib::oldCyclicPolyPatch::getAnchorPoints
(
	const UList<face>& faces,
	const pointField& points
)
...
tnbLib::label tnbLib::oldCyclicPolyPatch::findMaxArea
(
	const pointField& points,
...
bool tnbLib::oldCyclicPolyPatch::getGeometricHalves
(
...
void tnbLib::oldCyclicPolyPatch::getCentresAndAnchors
(
	const primitivePatch& pp,
...
) const
{
	...
	case ROTATIONAL:
	{
		...
		ppPoints = tnbLib::transform(reverseT, pp.points());
	...
	default:
	{
		...
		if (mag(n0 & n1) < 1 - matchTolerance())
		{
			...
			forAll(half0Ctrs, facei)
			{
				half0Ctrs[facei] = tnbLib::transform
				(
					reverseT,
					half0Ctrs[facei]
				);
				anchors0[facei] = tnbLib::transform
				(
					reverseT,
					anchors0[facei]
				);
...
bool tnbLib::oldCyclicPolyPatch::matchAnchors
(
	const bool report,
	const primitivePatch& pp,
...
tnbLib::label tnbLib::oldCyclicPolyPatch::getConsistentRotationFace
(
...
tnbLib::oldCyclicPolyPatch::oldCyclicPolyPatch
(
	const word& name,
	const label size,
	const label start,
...
void tnbLib::oldCyclicPolyPatch::initGeometry(PstreamBuffers& pBufs)
{
	polyPatch::initGeometry(pBufs);
}


void tnbLib::oldCyclicPolyPatch::calcGeometry
(
...
void tnbLib::oldCyclicPolyPatch::calcGeometry(PstreamBuffers& pBufs)
{}


void tnbLib::oldCyclicPolyPatch::initMovePoints
(
...
void tnbLib::oldCyclicPolyPatch::movePoints
(
	PstreamBuffers& pBufs,
	const pointField& p
)
...
void tnbLib::oldCyclicPolyPatch::initUpdateMesh(PstreamBuffers& pBufs)
{
	polyPatch::initUpdateMesh(pBufs);
}


void tnbLib::oldCyclicPolyPatch::updateMesh(PstreamBuffers& pBufs)
{
	polyPatch::updateMesh(pBufs);
}


void tnbLib::oldCyclicPolyPatch::initOrder
(
	PstreamBuffers&,
	const primitivePatch& pp
) const
...
bool tnbLib::oldCyclicPolyPatch::order
(
	PstreamBuffers&,
	const primitivePatch& pp,
	labelList& faceMap,
...
void tnbLib::oldCyclicPolyPatch::write(Ostream& os) const
{
