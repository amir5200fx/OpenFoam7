...
tnbLib::processorCyclicPolyPatch::processorCyclicPolyPatch
(
	const label size,
	const label start,
	const label index,
...
tnbLib::word tnbLib::processorCyclicPolyPatch::newName
(
...
tnbLib::labelList tnbLib::processorCyclicPolyPatch::patchIDs
(
	const word& cyclicPolyPatchName,
	const polyBoundaryMesh& bm
)
...
int tnbLib::processorCyclicPolyPatch::tag() const
{
	if (tag_ == -1)
	{
...
void tnbLib::processorCyclicPolyPatch::initGeometry(PstreamBuffers& pBufs)
{
...
void tnbLib::processorCyclicPolyPatch::calcGeometry(PstreamBuffers& pBufs)
{
...
void tnbLib::processorCyclicPolyPatch::initMovePoints
(
...
void tnbLib::processorCyclicPolyPatch::movePoints
(
	PstreamBuffers& pBufs,
	const pointField&
)
...
void tnbLib::processorCyclicPolyPatch::initUpdateMesh(PstreamBuffers& pBufs)
{
	processorPolyPatch::initUpdateMesh(pBufs);
}


void tnbLib::processorCyclicPolyPatch::updateMesh(PstreamBuffers& pBufs)
{
	referPatchID_ = -1;
...
void tnbLib::processorCyclicPolyPatch::initOrder
(
	PstreamBuffers& pBufs,
...
bool tnbLib::processorCyclicPolyPatch::order
(
	PstreamBuffers& pBufs,
	const primitivePatch& pp,
	labelList& faceMap,
...
void tnbLib::processorCyclicPolyPatch::write(Ostream& os) const
{
