...
tnbLib::word tnbLib::processorPolyPatch::newName
(
...
)
{
	return
		"procBoundary"
		+ tnbLib::name(myProcNo)
		+ "to"
		+ tnbLib::name(neighbProcNo);
}


void tnbLib::processorPolyPatch::initGeometry(PstreamBuffers& pBufs)
{
	if (Pstream::parRun())
	{
...
void tnbLib::processorPolyPatch::calcGeometry(PstreamBuffers& pBufs)
{
	if (Pstream::parRun())
	{
		{
...
void tnbLib::processorPolyPatch::initMovePoints
(
...
void tnbLib::processorPolyPatch::movePoints
(
	PstreamBuffers& pBufs,
	const pointField&
)
...
void tnbLib::processorPolyPatch::initUpdateMesh(PstreamBuffers& pBufs)
{
...
void tnbLib::processorPolyPatch::updateMesh(PstreamBuffers& pBufs)
{
	// For completeness
...
void tnbLib::processorPolyPatch::initOrder
(
	PstreamBuffers& pBufs,
...
tnbLib::label tnbLib::processorPolyPatch::matchFace
(
	const face& a,
