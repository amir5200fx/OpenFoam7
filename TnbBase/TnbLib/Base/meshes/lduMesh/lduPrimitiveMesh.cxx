...
#include <UIndirectListI.hxx>  // added by amir
...
void tnbLib::lduPrimitiveMesh::checkUpperTriangular
(
	const label size,
	const labelUList& l,
	const labelUList& u
...
tnbLib::label tnbLib::lduPrimitiveMesh::totalSize
(
...
tnbLib::labelList tnbLib::lduPrimitiveMesh::upperTriOrder
(
	const label nCells,
...
tnbLib::lduPrimitiveMesh::lduPrimitiveMesh
(
	const label nCells,
	labelList& l,
	labelList& u,
...
void tnbLib::lduPrimitiveMesh::addInterfaces
(
...
const tnbLib::lduMesh& tnbLib::lduPrimitiveMesh::mesh
(
	const lduMesh& myMesh,
	const PtrList<lduPrimitiveMesh>& otherMeshes,
	const label meshI
...
void tnbLib::lduPrimitiveMesh::gather
(
	const label comm,
	const lduMesh& mesh,
	const labelList& procIDs,
