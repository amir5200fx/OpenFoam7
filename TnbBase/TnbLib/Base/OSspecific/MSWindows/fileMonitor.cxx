...
#include <regIOobject.hxx>  // for fileModificationSkew symbol
...
const tnbLib::NamedEnum<tnbLib::fileMonitor::fileState, 3>
tnbLib::fileMonitor::fileStateNames_;
...
void tnbLib::fileMonitor::checkFiles() const
{
	if (useInotify_)
	{
#ifdef FOAM_USE_INOTIFY
...
tnbLib::fileMonitor::fileMonitor(const bool useInotify)
	:
	useInotify_(useInotify),
	localState_(20),
	state_(20),
...
tnbLib::fileMonitor::~fileMonitor()
{}
...
// regIOobject)
tnbLib::label tnbLib::fileMonitor::addWatch(const fileName& fName)
{
	label watchFd;
...
bool tnbLib::fileMonitor::removeWatch(const label watchFd)
{
	if (debug)
	{
...
const tnbLib::fileName& tnbLib::fileMonitor::getFile(const label watchFd) const
{
	return watchFile_[watchFd];
}


tnbLib::fileMonitor::fileState tnbLib::fileMonitor::getState(const label watchFd)
const
{
...
void tnbLib::fileMonitor::updateStates
(
...
void tnbLib::fileMonitor::setUnmodified(const label watchFd)
{
	state_[watchFd] = UNMODIFIED;
	localState_[watchFd] = UNMODIFIED;
