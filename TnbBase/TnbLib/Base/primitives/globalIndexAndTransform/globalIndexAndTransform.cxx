...
tnbLib::label tnbLib::globalIndexAndTransform::matchTransform
(
...
void tnbLib::globalIndexAndTransform::determineTransforms()
{
...
void tnbLib::globalIndexAndTransform::determineTransformPermutations()
{
...
void tnbLib::globalIndexAndTransform::determinePatchTransformSign()
{
	const polyBoundaryMesh& patches = mesh_.boundaryMesh();
...
bool tnbLib::globalIndexAndTransform::uniqueTransform
(
	const point& pt,
...
tnbLib::globalIndexAndTransform::globalIndexAndTransform(const polyMesh& mesh)
	:
	mesh_(mesh),
	transforms_(),
