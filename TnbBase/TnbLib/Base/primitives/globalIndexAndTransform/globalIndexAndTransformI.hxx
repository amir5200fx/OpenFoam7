...
bool tnbLib::globalIndexAndTransform::less::operator()
(
	const labelPair& a,
	const labelPair& b
	) const
...
tnbLib::label tnbLib::globalIndexAndTransform::encodeTransformIndex
(
...
tnbLib::labelList tnbLib::globalIndexAndTransform::decodeTransformIndex
(
...
tnbLib::label tnbLib::globalIndexAndTransform::addToTransformIndex
(
	const label transformIndex,
	const label patchi,
...
tnbLib::label tnbLib::globalIndexAndTransform::minimumTransformIndex
(
...
tnbLib::label tnbLib::globalIndexAndTransform::subtractTransformIndex
(
	const label transformIndex0,
	const label transformIndex1
) const
...
tnbLib::labelPair tnbLib::globalIndexAndTransform::encode
(
	const label index,
	const label transformIndex
) const
...
tnbLib::label tnbLib::globalIndexAndTransform::index
(
...
tnbLib::label tnbLib::globalIndexAndTransform::processor
(
	const labelPair& globalIAndTransform
) const
{
...
tnbLib::label tnbLib::globalIndexAndTransform::transformIndex
(
	const labelPair& globalIAndTransform
) const
{
...
tnbLib::label tnbLib::globalIndexAndTransform::nIndependentTransforms() const
{
...
tnbLib::globalIndexAndTransform::transforms() const
{
	return transforms_;
}
...
const tnbLib::List<tnbLib::vectorTensorTransform>&
tnbLib::globalIndexAndTransform::transformPermutations() const
{
	return transformPermutations_;
}


tnbLib::label tnbLib::globalIndexAndTransform::nullTransformIndex() const
{
	return nullTransformIndex_;
}


const tnbLib::labelPairList&
tnbLib::globalIndexAndTransform::patchTransformSign() const
{
	return patchTransformSign_;
}


const tnbLib::vectorTensorTransform& tnbLib::globalIndexAndTransform::transform
(
...
tnbLib::labelList tnbLib::globalIndexAndTransform::transformIndicesForPatches
(
...
tnbLib::pointField tnbLib::globalIndexAndTransform::transformPatches
(
	const labelHashSet& patchis,
	const point& pt
) const
