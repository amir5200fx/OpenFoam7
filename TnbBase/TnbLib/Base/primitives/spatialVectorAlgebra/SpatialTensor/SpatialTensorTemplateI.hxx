...
template<class Cmpt>
inline tnbLib::SpatialTensor<Cmpt>::SpatialTensor()
{}


template<class Cmpt>
inline tnbLib::SpatialTensor<Cmpt>::SpatialTensor(const tnbLib::zero)
	:
...
template<class Cmpt>
inline tnbLib::SpatialTensor<Cmpt>::SpatialTensor(Istream& is)
	:
...
namespace tnbLib
{
	...
	template<class Cmpt>
	inline tnbLib::SpatialTensor<Cmpt> operator^
		(
