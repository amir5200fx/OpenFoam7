...
tnbLib::scalar tnbLib::incGammaRatio_Q(const scalar a, const scalar x)
{
	const scalar BIG = 14;
	const scalar x0 = 17;
...
tnbLib::scalar tnbLib::incGammaRatio_P(const scalar a, const scalar x)
{
	return 1 - incGammaRatio_Q(a, x);
}


tnbLib::scalar tnbLib::incGamma_Q(const scalar a, const scalar x)
{
	return incGammaRatio_Q(a, x)*tgamma(a);
}


tnbLib::scalar tnbLib::incGamma_P(const scalar a, const scalar x)
{
