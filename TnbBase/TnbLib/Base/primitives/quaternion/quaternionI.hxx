...
inline tnbLib::quaternion tnbLib::quaternion::unit(const vector& v)
{
...
)
{
	...
	if (trace > 0)
	{
		scalar s = 0.5 / tnbLib::sqrt(trace + 1.0);
...
inline tnbLib::quaternion tnbLib::quaternion::normalized() const
{
...
inline tnbLib::vector tnbLib::quaternion::twoAxes
(
	const scalar t11,
	const scalar t12,
	const scalar c2,
...
inline tnbLib::vector tnbLib::quaternion::threeAxes
(
	const scalar t11,
	const scalar t12,
	const scalar s2,
...
inline tnbLib::vector tnbLib::quaternion::eulerAngles
(
	const rotationSequence rs
) const
{
