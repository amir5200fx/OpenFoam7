...
tnbLib::UIPstream::UIPstream(const int fromProcNo, PstreamBuffers& buffers)
	:
	...
	messageSize_(0)
{
			...
			)
	{
		FatalErrorInFunction
			...
			<< " receives (using UIPstream)" << tnbLib::exit(FatalError);
	}
...
tnbLib::label tnbLib::UIPstream::read
(
	const commsTypes commsType,
	const int fromProcNo,
	char* buf,
