...
tnbLib::mixtureViscosityModels::plastic::plastic
(
    const word& name,
...
tnbLib::mixtureViscosityModels::plastic::mu(const volScalarField& muc) const
{
    return min
    (
        muc
...
bool tnbLib::mixtureViscosityModels::plastic::read
(
    const dictionary& viscosityProperties
)
{
