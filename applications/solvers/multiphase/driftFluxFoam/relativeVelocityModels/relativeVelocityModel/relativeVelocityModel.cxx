...
tnbLib::wordList tnbLib::relativeVelocityModel::UdmPatchFieldTypes() const
{
...
tnbLib::relativeVelocityModel::relativeVelocityModel
(
...
tnbLib::autoPtr<tnbLib::relativeVelocityModel> tnbLib::relativeVelocityModel::New
(
    const dictionary& dict,
    const incompressibleTwoPhaseInteractingMixture& mixture
)
...
tmp<volScalarField> tnbLib::relativeVelocityModel::rho() const
{
    return alphac_ * rhoc_ + alphad_ * rhod_;
}


tmp<volSymmTensorField> tnbLib::relativeVelocityModel::tauDm() const
{
