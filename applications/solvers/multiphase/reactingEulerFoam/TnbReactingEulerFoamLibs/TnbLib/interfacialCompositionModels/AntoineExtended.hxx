...
namespace tnbLib
{
    namespace saturationModels
    {
        ...
        public:
            ...
            FoamReactingEulerFoamLibs_EXPORT AntoineExtended(const dictionary& dict, const objectRegistry& db);


            //- Destructor
            FoamReactingEulerFoamLibs_EXPORT virtual ~AntoineExtended();
