...
tnbLib::autoPtr<tnbLib::diameterModels::coalescenceModel>
tnbLib::diameterModels::coalescenceModel::New
(
    const word& type,
...
tnbLib::diameterModels::coalescenceModel::coalescenceModel
(
    const populationBalanceModel& popBal,
    const dictionary& dict
)
...
void tnbLib::diameterModels::coalescenceModel::correct()
{}
