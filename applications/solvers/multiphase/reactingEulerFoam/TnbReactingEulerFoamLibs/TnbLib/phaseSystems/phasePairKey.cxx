...
bool tnbLib::phasePairKey::ordered() const
{
    return ordered_;
}
...
FoamReactingEulerFoamLibs_EXPORT bool tnbLib::operator==
(
...
FoamReactingEulerFoamLibs_EXPORT tnbLib::Istream& tnbLib::operator>>(Istream& is, phasePairKey& key)
{
...
FoamReactingEulerFoamLibs_EXPORT tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const phasePairKey& key)
{
    os << token::BEGIN_LIST
        << key.first()
        << token::SPACE
