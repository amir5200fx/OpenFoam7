...
#include <linearTsubDiameter.hxx>
...
tnbLib::diameterModels::linearTsub::linearTsub
(
...
tnbLib::tmp<tnbLib::volScalarField> tnbLib::diameterModels::linearTsub::d() const
{
    return d_;
}


void tnbLib::diameterModels::linearTsub::correct()
{
...
bool tnbLib::diameterModels::linearTsub::read(const dictionary& phaseProperties)
{
