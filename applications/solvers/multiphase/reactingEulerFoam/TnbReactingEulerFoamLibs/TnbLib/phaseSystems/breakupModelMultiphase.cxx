...
tnbLib::autoPtr<tnbLib::diameterModels::breakupModel>
tnbLib::diameterModels::breakupModel::New
(
    const word& type,
...
tnbLib::diameterModels::breakupModel::breakupModel
(
    const populationBalanceModel& popBal,
    const dictionary& dict
)
...
void tnbLib::diameterModels::breakupModel::correct()
{}
