...
#include <constantNucleation.hxx>
...
void tnbLib::diameterModels::nucleationModels::constantNucleation::correct()
{
    if
        (
...
void
tnbLib::diameterModels::nucleationModels::constantNucleation::addToNucleationRate
(
