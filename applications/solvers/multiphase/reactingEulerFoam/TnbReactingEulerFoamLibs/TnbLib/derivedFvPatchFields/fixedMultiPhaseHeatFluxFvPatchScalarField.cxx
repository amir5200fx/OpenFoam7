...
#include <fixedMultiPhaseHeatFluxFvPatchScalarField.hxx>
...
void tnbLib::fixedMultiPhaseHeatFluxFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void tnbLib::fixedMultiPhaseHeatFluxFvPatchScalarField::write(Ostream& os) const
{
