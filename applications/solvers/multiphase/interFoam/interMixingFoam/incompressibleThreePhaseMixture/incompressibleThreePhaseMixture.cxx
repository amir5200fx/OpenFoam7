...
void tnbLib::incompressibleThreePhaseMixture::calcNu()
{
    nuModel1_->correct();
    nuModel2_->correct();
    nuModel3_->correct();
...
tnbLib::incompressibleThreePhaseMixture::incompressibleThreePhaseMixture
(
...
tnbLib::incompressibleThreePhaseMixture::mu() const
{
...
tnbLib::incompressibleThreePhaseMixture::muf() const
{
...
tnbLib::tmp<tnbLib::surfaceScalarField>
tnbLib::incompressibleThreePhaseMixture::nuf() const
{
    surfaceScalarField alpha1f(fvc::interpolate(alpha1_));
    surfaceScalarField alpha2f(fvc::interpolate(alpha2_));
    surfaceScalarField alpha3f(fvc::interpolate(alpha3_));
...
bool tnbLib::incompressibleThreePhaseMixture::read()
{
