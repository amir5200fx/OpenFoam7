...
#include "JohnsonJacksonParticleSlipFvPatchVectorFieldTwoPhase.hxx"
...
tnbLib::JohnsonJacksonParticleSlipFvPatchVectorField::
JohnsonJacksonParticleSlipFvPatchVectorField
(
    const fvPatch& p,
...
void tnbLib::JohnsonJacksonParticleSlipFvPatchVectorField::autoMap
(
...
void tnbLib::JohnsonJacksonParticleSlipFvPatchVectorField::rmap
(
...
void tnbLib::JohnsonJacksonParticleSlipFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void tnbLib::JohnsonJacksonParticleSlipFvPatchVectorField::write
(
    Ostream& os
) const
{
