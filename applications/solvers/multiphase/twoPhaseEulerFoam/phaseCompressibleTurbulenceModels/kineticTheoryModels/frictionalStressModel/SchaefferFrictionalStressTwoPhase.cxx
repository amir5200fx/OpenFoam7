...
#include "SchaefferFrictionalStressTwoPhase.hxx"
...
tnbLib::kineticTheoryModels::frictionalStressModels::Schaeffer::Schaeffer
(
...
) const
{
    ...
    return
        ...
        * pow(tnbLib::max(alpha - alphaMinFriction, scalar(0)), 10.0);
}
...
) const
{
    ...
    return
        ...
        * pow(tnbLib::max(alpha - alphaMinFriction, scalar(0)), 9.0);
}


tnbLib::tmp<tnbLib::volScalarField>
tnbLib::kineticTheoryModels::frictionalStressModels::Schaeffer::nu
(
    const phaseModel& phase,
    const dimensionedScalar& alphaMinFriction,
    const dimensionedScalar& alphaMax,
...
bool tnbLib::kineticTheoryModels::frictionalStressModels::Schaeffer::read()
{
