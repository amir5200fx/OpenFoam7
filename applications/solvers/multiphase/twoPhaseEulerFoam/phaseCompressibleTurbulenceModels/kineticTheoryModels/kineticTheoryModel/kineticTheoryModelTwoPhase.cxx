...
tnbLib::RASModels::kineticTheoryModel::kineticTheoryModel
(
...
bool tnbLib::RASModels::kineticTheoryModel::read()
{
    if
        (
            eddyViscosity
...
tnbLib::RASModels::kineticTheoryModel::k() const
{
    NotImplemented;
    return nut_;
}
...
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::RASModels::kineticTheoryModel::epsilon() const
{
    NotImplemented;
    return nut_;
}
...
tnbLib::RASModels::kineticTheoryModel::R() const
{
...
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::RASModels::kineticTheoryModel::pPrime() const
{
...
tnbLib::RASModels::kineticTheoryModel::pPrimef() const
{
...
tnbLib::tmp<tnbLib::volSymmTensorField>
tnbLib::RASModels::kineticTheoryModel::devRhoReff() const
{
    return volSymmTensorField::New
    (
...
tnbLib::RASModels::kineticTheoryModel::divDevRhoReff
(
    volVectorField& U
) const
{
...
void tnbLib::RASModels::kineticTheoryModel::correct()
{
    // Local references
    ...
    if (!equilibrium_)
    {
        ...
        tnbLib::fv::options& fvOptions(tnbLib::fv::options::New(mesh_));
