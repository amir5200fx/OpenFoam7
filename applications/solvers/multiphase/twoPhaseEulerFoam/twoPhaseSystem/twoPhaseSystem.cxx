...
tnbLib::tmp<tnbLib::volScalarField> tnbLib::twoPhaseSystem::rho() const
{
    return phase1_ * phase1_.thermo().rho() + phase2_ * phase2_.thermo().rho();
}


tnbLib::tmp<tnbLib::volVectorField> tnbLib::twoPhaseSystem::U() const
{
    return phase1_ * phase1_.U() + phase2_ * phase2_.U();
}


tnbLib::tmp<tnbLib::surfaceScalarField> tnbLib::twoPhaseSystem::calcPhi() const
{
    return
...
tnbLib::tmp<tnbLib::volScalarField> tnbLib::twoPhaseSystem::Kd() const
{
    return drag_->K();
}


tnbLib::tmp<tnbLib::surfaceScalarField> tnbLib::twoPhaseSystem::Kdf() const
{
    return drag_->Kf();
}


tnbLib::tmp<tnbLib::volScalarField> tnbLib::twoPhaseSystem::Vm() const
{
    return virtualMass_->K();
}


tnbLib::tmp<tnbLib::surfaceScalarField> tnbLib::twoPhaseSystem::Vmf() const
{
    return virtualMass_->Kf();
}


tnbLib::tmp<tnbLib::volScalarField> tnbLib::twoPhaseSystem::Kh() const
{
    return heatTransfer_->K();
}


tnbLib::tmp<tnbLib::volVectorField> tnbLib::twoPhaseSystem::F() const
{
    return lift_->F<vector>() + wallLubrication_->F<vector>();
}


tnbLib::tmp<tnbLib::surfaceScalarField> tnbLib::twoPhaseSystem::Ff() const
{
    return lift_->Ff() + wallLubrication_->Ff();
}


tnbLib::tmp<tnbLib::volScalarField> tnbLib::twoPhaseSystem::D() const
{
    return turbulentDispersion_->D();
}


void tnbLib::twoPhaseSystem::solve()
{
...
void tnbLib::twoPhaseSystem::correct()
{
    phase1_.correct();
    phase2_.correct();
}
...
void tnbLib::twoPhaseSystem::correctTurbulence()
{
...
bool tnbLib::twoPhaseSystem::read()
{
    if (regIOobject::read())
    {
        bool readOK = true;
...
const tnbLib::dimensionedScalar& tnbLib::twoPhaseSystem::sigma() const
{
    return pair_->sigma();
}
