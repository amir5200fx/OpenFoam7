...
void tnbLib::fv::VoFSolidificationMeltingSource::update()
{
...
tnbLib::word tnbLib::fv::VoFSolidificationMeltingSource::alphaSolidName() const
{
    const twoPhaseMixtureThermo& thermo
    (
        mesh_.lookupObject<twoPhaseMixtureThermo>
...
tnbLib::fv::VoFSolidificationMeltingSource::VoFSolidificationMeltingSource
(
...
void tnbLib::fv::VoFSolidificationMeltingSource::addSup
(
    fvMatrix<scalar>& eqn,
    const label fieldi
)
