...
#include <VoFphaseCompressibleTurbulenceModelFwd.hxx>
...
namespace tnbLib
{
	...
	public:
		...
		FoamCompressibleInterFoamLibs_EXPORT compressibleInterPhaseTransportModel
		(
		...
		FoamCompressibleInterFoamLibs_EXPORT tmp<volScalarField> alphaEff() const;

		//- Return the effective momentum stress divergence
		FoamCompressibleInterFoamLibs_EXPORT tmp<fvVectorMatrix> divDevRhoReff(volVectorField& U) const;

		//- Correct the phase mass-fluxes
		// (required for the two-phase transport option)
		FoamCompressibleInterFoamLibs_EXPORT void correctPhasePhi();

		//- Correct the phase or mixture transport models
		FoamCompressibleInterFoamLibs_EXPORT void correct();
