...
namespace tnbLib
{
	...
	namespace surfaceTensionModels
	{
		...
		public:
			...
			static const char* typeName_() { return "liquidProperties"; }
			...
			FoamCompressibleInterFoamLibs_EXPORT liquidProperties
			(
			...
			//- Destructor
			FoamCompressibleInterFoamLibs_EXPORT virtual ~liquidProperties();


			// Member Functions

				//- Surface tension coefficient
			FoamCompressibleInterFoamLibs_EXPORT virtual tmp<volScalarField> sigma() const;

			//- Update surface tension coefficient from given dictionary
			FoamCompressibleInterFoamLibs_EXPORT virtual bool readDict(const dictionary& dict);

			//- Write in dictionary format
			FoamCompressibleInterFoamLibs_EXPORT virtual bool writeData(Ostream& os) const;
		};
