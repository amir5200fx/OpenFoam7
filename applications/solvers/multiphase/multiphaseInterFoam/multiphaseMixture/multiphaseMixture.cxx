...
const tnbLib::scalar tnbLib::multiphaseMixture::convertToRad =
tnbLib::constant::mathematical::pi / 180.0;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void tnbLib::multiphaseMixture::calcAlphas()
{
    scalar level = 0.0;
    alphas_ == 0.0;
...
tnbLib::multiphaseMixture::multiphaseMixture
(
...
tnbLib::multiphaseMixture::rho() const
{
...
tnbLib::multiphaseMixture::rho(const label patchi) const
{
    PtrDictionary<phase>::const_iterator iter = phases_.begin();
...
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::multiphaseMixture::mu() const
{
    PtrDictionary<phase>::const_iterator iter = phases_.begin();
...
tnbLib::tmp<tnbLib::scalarField>
tnbLib::multiphaseMixture::mu(const label patchi) const
{
    PtrDictionary<phase>::const_iterator iter = phases_.begin();
...
tnbLib::multiphaseMixture::muf() const
{
    PtrDictionary<phase>::const_iterator iter = phases_.begin();
...
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::multiphaseMixture::nu() const
{
    return nu_;
}
...
tnbLib::tmp<tnbLib::scalarField>
tnbLib::multiphaseMixture::nu(const label patchi) const
{
...
tnbLib::tmp<tnbLib::surfaceScalarField>
tnbLib::multiphaseMixture::nuf() const
{
...
tnbLib::tmp<tnbLib::surfaceScalarField>
tnbLib::multiphaseMixture::surfaceTensionForce() const
{
...
void tnbLib::multiphaseMixture::solve()
{
    correct();
...
void tnbLib::multiphaseMixture::correct()
{
    forAllIter(PtrDictionary<phase>, phases_, iter)
    {
        iter().correct();
...
tnbLib::tmp<tnbLib::surfaceVectorField> tnbLib::multiphaseMixture::nHatfv
(
...
tnbLib::tmp<tnbLib::surfaceScalarField> tnbLib::multiphaseMixture::nHatf
(
    const volScalarField& alpha1,
    const volScalarField& alpha2
) const
...
void tnbLib::multiphaseMixture::correctContactAngle
(
    const phase& alpha1,
    const phase& alpha2,
...
tnbLib::tmp<tnbLib::volScalarField> tnbLib::multiphaseMixture::K
(
    const phase& alpha1,
    const phase& alpha2
) const
...
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::multiphaseMixture::nearInterface() const
{
...
void tnbLib::multiphaseMixture::solveAlphas
(
    const scalar cAlpha
)
{
...
bool tnbLib::multiphaseMixture::read()
{
