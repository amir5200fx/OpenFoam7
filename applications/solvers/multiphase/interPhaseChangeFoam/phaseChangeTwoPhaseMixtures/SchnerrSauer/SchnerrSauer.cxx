...
tnbLib::phaseChangeTwoPhaseMixtures::SchnerrSauer::SchnerrSauer
(
...
tnbLib::phaseChangeTwoPhaseMixtures::SchnerrSauer::rRb
(
...
tnbLib::phaseChangeTwoPhaseMixtures::SchnerrSauer::alphaNuc() const
{
...
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::phaseChangeTwoPhaseMixtures::SchnerrSauer::pCoeff
(
...
tnbLib::phaseChangeTwoPhaseMixtures::SchnerrSauer::mDotAlphal() const
{
...
tnbLib::Pair<tnbLib::tmp<tnbLib::volScalarField>>
tnbLib::phaseChangeTwoPhaseMixtures::SchnerrSauer::mDotP() const
{
    const volScalarField& p = alpha1().db().lookupObject<volScalarField>("p");
    volScalarField pCoeff(this->pCoeff(p));
...
void tnbLib::phaseChangeTwoPhaseMixtures::SchnerrSauer::correct()
{
    phaseChangeTwoPhaseMixture::correct();
}


bool tnbLib::phaseChangeTwoPhaseMixtures::SchnerrSauer::read()
{
