...
const tnbLib::scalar tnbLib::multiphaseSystem::convertToRad =
tnbLib::constant::mathematical::pi / 180.0;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void tnbLib::multiphaseSystem::calcAlphas()
{
    scalar level = 0.0;
    alphas_ == 0.0;
...
void tnbLib::multiphaseSystem::solveAlphas()
{
...
tnbLib::tmp<tnbLib::surfaceVectorField> tnbLib::multiphaseSystem::nHatfv
(
...
tnbLib::tmp<tnbLib::surfaceScalarField> tnbLib::multiphaseSystem::nHatf
(
    const volScalarField& alpha1,
    const volScalarField& alpha2
) const
...
void tnbLib::multiphaseSystem::correctContactAngle
(
...
tnbLib::tmp<tnbLib::volScalarField> tnbLib::multiphaseSystem::K
(
    const phaseModel& phase1,
    const phaseModel& phase2
) const
...
tnbLib::multiphaseSystem::multiphaseSystem
(
...
tnbLib::tmp<tnbLib::volScalarField> tnbLib::multiphaseSystem::rho() const
{
...
tnbLib::multiphaseSystem::rho(const label patchi) const
{
    PtrDictionary<phaseModel>::const_iterator iter = phases_.begin();
...
tnbLib::tmp<tnbLib::volScalarField> tnbLib::multiphaseSystem::nu() const
{
    PtrDictionary<phaseModel>::const_iterator iter = phases_.begin();
...
tnbLib::tmp<tnbLib::scalarField>
tnbLib::multiphaseSystem::nu(const label patchi) const
{
    PtrDictionary<phaseModel>::const_iterator iter = phases_.begin();
...
tnbLib::tmp<tnbLib::volScalarField> tnbLib::multiphaseSystem::Cvm
(
...
tnbLib::tmp<tnbLib::volVectorField> tnbLib::multiphaseSystem::Svm
(
    const phaseModel& phase
) const
{
...
tnbLib::autoPtr<tnbLib::multiphaseSystem::dragCoeffFields>
tnbLib::multiphaseSystem::dragCoeffs() const
{
...
tnbLib::tmp<tnbLib::volScalarField> tnbLib::multiphaseSystem::dragCoeff
(
    const phaseModel& phase,
...
tnbLib::tmp<tnbLib::surfaceScalarField> tnbLib::multiphaseSystem::surfaceTension
(
    const phaseModel& phase1
) const
{
...
tnbLib::multiphaseSystem::nearInterface() const
{
...
void tnbLib::multiphaseSystem::solve()
{
    forAllIter(PtrDictionary<phaseModel>, phases_, iter)
    {
        iter().correct();
...
bool tnbLib::multiphaseSystem::read()
{
    if (regIOobject::read())
    {
        bool readOK = true;
