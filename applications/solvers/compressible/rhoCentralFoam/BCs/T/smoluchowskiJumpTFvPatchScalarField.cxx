#include <smoluchowskiJumpTFvPatchScalarField.hxx>
...
tnbLib::smoluchowskiJumpTFvPatchScalarField::smoluchowskiJumpTFvPatchScalarField
(
	const fvPatch& p,
...
// Map from self
void tnbLib::smoluchowskiJumpTFvPatchScalarField::autoMap
(
...
void tnbLib::smoluchowskiJumpTFvPatchScalarField::rmap
(
...
void tnbLib::smoluchowskiJumpTFvPatchScalarField::updateCoeffs()
{
	if (updated())
	{
		return;
...
void tnbLib::smoluchowskiJumpTFvPatchScalarField::write(Ostream& os) const
{
