...
tnbLib::label tnbLib::regionSide::otherFace
(
...
tnbLib::label tnbLib::regionSide::otherEdge
(
    const primitiveMesh& mesh,
    const label facei,
    const label edgeI,
...
// fenceEdges.
void tnbLib::regionSide::visitConnectedFaces
(
    const primitiveMesh& mesh,
...
// of region
void tnbLib::regionSide::walkPointConnectedFaces
(
    const primitiveMesh& mesh,
...
// regionFaces side.
void tnbLib::regionSide::walkAllPointConnectedFaces
(
    const primitiveMesh& mesh,
