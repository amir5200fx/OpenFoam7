...
void tnbLib::meshDualiser::checkPolyTopoChange(const polyTopoChange& meshMod)
{
...
// Dump state so far.
void tnbLib::meshDualiser::dumpPolyTopoChange
(
...
tnbLib::label tnbLib::meshDualiser::findDualCell
(
    const label celli,
    const label pointi
) const
...
void tnbLib::meshDualiser::generateDualBoundaryEdges
(
...
// sides.
bool tnbLib::meshDualiser::sameDualCell
(
    const label facei,
    const label pointi
) const
...
tnbLib::label tnbLib::meshDualiser::addInternalFace
(
...
tnbLib::label tnbLib::meshDualiser::addBoundaryFace
(
    const label masterPointi,
    const label masterEdgeI,
    const label masterFacei,
...
void tnbLib::meshDualiser::createFacesAroundEdge
(
...
void tnbLib::meshDualiser::createFaceFromInternalFace
(
    const label facei,
    label& fp,
    polyTopoChange& meshMod
...
void tnbLib::meshDualiser::createFacesAroundBoundaryPoint
(
    const label patchi,
...
tnbLib::meshDualiser::meshDualiser(const polyMesh& mesh)
    :
    mesh_(mesh),
...
void tnbLib::meshDualiser::setRefinement
(
    const bool splitFace,
