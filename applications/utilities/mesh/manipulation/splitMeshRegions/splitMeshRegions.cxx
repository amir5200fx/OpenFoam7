...
//attention: the original ....hxx files has been replaced by ...templates.hxx (by Payvand)
    ...
    if (nUnmatchedRegions)
    {
        ...
        forAll(regionToZone, regioni)
        {
            if (regionToZone[regioni] == -1)
            {
                ...
                {
                    regionNames[regioni] =
                        defaultRegionName + tnbLib::name(nUnmatchedi++);
                }
            }
        }
    }
    ...
    else if (makeCellZones)
    {
        ...
        for (label regioni = 0; regioni < nCellRegions; regioni++)
        {
            ...
            else
            {
                ...
                word zoneName = "region" + tnbLib::name(regioni);
