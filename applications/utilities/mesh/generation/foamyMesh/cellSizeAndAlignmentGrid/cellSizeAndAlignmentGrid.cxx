...
tnbLib::tmp<tnbLib::Field<Type>> filterFarPoints
(
...
template<class T>
tnbLib::tmp<tnbLib::triadField> buildAlignmentField(const T& mesh)
{
...
template<class T>
tnbLib::tmp<tnbLib::pointField> buildPointField(const T& mesh)
{
