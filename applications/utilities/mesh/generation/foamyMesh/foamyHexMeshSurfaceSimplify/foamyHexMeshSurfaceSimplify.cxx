...
//    {}
//
//    inline Point toLocal(const tnbLib::point& pt) const
//    {
//        tnbLib::point p = cmptMultiply(scale_, (pt + offset_));
//        return Point(p.x(), p.y(), p.z());
//    }
//
//    inline tnbLib::point toGlobal(const Point& pt) const
//    {
...
//
//    scalar signedDistance(const tnbLib::point& pt) const
//    {
...
//        //}
//        // tnbLib::List<tnbLib::List<pointIndexHit>> hitInfo;
...
//        //{
//        //    const tnbLib::List<pointIndexHit>& hits = hitInfo[edgeI];
//        //    forAll(hits, i)
//        //    {
...
//        //
//        // tnbLib::List<pointIndexHit> nearestInfo;
...
//        tnbLib::DynamicList<labelledTri> tris(mc.ntrigs());
...
//        {
//            tnbLib::List<pointIndexHit> hitInfo;
