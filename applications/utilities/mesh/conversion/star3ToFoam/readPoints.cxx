...
tnbLib::label tnbLib::starMesh::readVtxLabel(IFstream& is)
{
    char lcs[16];
...
tnbLib::scalar tnbLib::starMesh::readVtxCmpt(IFstream& is)
{
    char lcs[17];
...
void tnbLib::starMesh::readToNl(IFstream& is)
{
    char c;
    do
    {
...
//void tnbLib::starMesh::readPoints(const scalar scaleFactor)
//{
//    label nPoints = 0;
//    label maxLabel = -1;
//
...
//        // from Star vertex numbers to tnbLib pointLabels
//
//        IFstream pointsFile(pointsFileName);
//        label pointLabel;
//
