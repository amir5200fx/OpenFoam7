...
// Merge tolerances
const tnbLib::scalar tnbLib::starMesh::smallMergeTol_ = 1e-3;
const tnbLib::scalar tnbLib::starMesh::cpMergePointTol_ = 1e-4;

// Cell shape models
const tnbLib::cellModel* tnbLib::starMesh::unknownPtr_ =
tnbLib::cellModeller::lookup("unknown");
const tnbLib::cellModel* tnbLib::starMesh::tetPtr_ =
tnbLib::cellModeller::lookup("tet");
const tnbLib::cellModel* tnbLib::starMesh::pyrPtr_ =
tnbLib::cellModeller::lookup("pyr");
const tnbLib::cellModel* tnbLib::starMesh::tetWedgePtr_ =
tnbLib::cellModeller::lookup("tetWedge");
const tnbLib::cellModel* tnbLib::starMesh::prismPtr_ =
tnbLib::cellModeller::lookup("prism");
const tnbLib::cellModel* tnbLib::starMesh::wedgePtr_ =
tnbLib::cellModeller::lookup("wedge");
const tnbLib::cellModel* tnbLib::starMesh::hexPtr_ =
tnbLib::cellModeller::lookup("hex");

const tnbLib::cellModel* tnbLib::starMesh::sammTrim1Ptr_ =
tnbLib::cellModeller::lookup("sammTrim1");
const tnbLib::cellModel* tnbLib::starMesh::sammTrim2Ptr_ =
tnbLib::cellModeller::lookup("sammTrim2");
const tnbLib::cellModel* tnbLib::starMesh::sammTrim3Ptr_ =
tnbLib::cellModeller::lookup("sammTrim3");
const tnbLib::cellModel* tnbLib::starMesh::sammTrim4Ptr_ =
tnbLib::cellModeller::lookup("sammTrim4");
const tnbLib::cellModel* tnbLib::starMesh::sammTrim5Ptr_ =
tnbLib::cellModeller::lookup("sammTrim5");
const tnbLib::cellModel* tnbLib::starMesh::sammTrim8Ptr_ =
tnbLib::cellModeller::lookup("hexagonalPrism");

// Regular cell point addressing
// SAMM point addressing
const tnbLib::label tnbLib::starMesh::regularAddressingTable[6][8] =
{
    { 0,  1,  2,  4, -1, -1, -1, -1},    // tet
...
// SAMM point addressing
const tnbLib::label tnbLib::starMesh::sammAddressingTable[9][12] =
{
...
const tnbLib::label tnbLib::starMesh::sammFacePermutationTable[24][8] =
{
...
const tnbLib::label tnbLib::starMesh::shapeFaceLookup[19][9] =
{
...
void tnbLib::starMesh::createPolyMeshData()
{
...
void tnbLib::starMesh::clearExtraStorage()
{
