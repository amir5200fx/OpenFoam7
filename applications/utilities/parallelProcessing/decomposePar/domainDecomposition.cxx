...
void tnbLib::domainDecomposition::mark
(
...
tnbLib::domainDecomposition::domainDecomposition
(
    const IOobject& io,
...
bool tnbLib::domainDecomposition::writeDecomposition(const bool decomposeSets)
{
    ...
    for (label proci = 0; proci < nProcs_; proci++)
    {
        ...
        (
            time().caseName()/fileName(word("processor") + tnbLib::name(proci))
        );
