...
void tnbLib::domainDecomposition::append(labelList& lst, const label elem)
{
    label sz = lst.size();
    lst.setSize(sz+1);
    lst[sz] = elem;
...
void tnbLib::domainDecomposition::addInterProcFace
(
    const label facei,
...
void tnbLib::domainDecomposition::decomposeMesh(const fileName& dict)
{
