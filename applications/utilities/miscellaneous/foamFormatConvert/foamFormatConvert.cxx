...
{
    template <>
    const ::tnbLib::word IOPtrList<entry>::typeName("IOPtrList<entry>");
    template <>
    int IOPtrList<entry>::debug(::tnbLib::debug::debugSwitch("IOPtrList<entry>", 0));
    template <>
    const tnbLib::RegisterDebugSwitch<IOPtrList<entry>> tnbLib::RegisterDebugSwitch<IOPtrList<
	    entry>>::registerDebugSwitch("IOPtrList<entry>");
}
