...
//
//    /*ReleaseDC(hDC, hWnd);*/
//    ReleaseDC(hWnd, hDC);  // edited by Payvand
//    return hWnd;
//}
//
...
//    CalcFPSDeltaT();
//
//    hWnd = CreateOpenGLWindow((char*)"bunnylod by Stan Melax");
...
//
//    PostString((char*)"Demo by Stan Melax (c)1998", 5, -5, 20);
//    PostString((char*)"Model by Viewpoint Datalabs (c)1996", 5, -4, 20);
//    char buf[128];
//    PostString((char*)"Mesh Reduction Algorithm (non-optimized)", 1, 0, 5);
