...
#include "ensightField.hxx"
#include "ensightParticlePositions.hxx"
#include "ensightCloudField.hxx"
#include "cellSet.hxx"
...
#include "checkMeshMoving.lxx"
    ...
    forAll(Times, timeI)
    {
        ...
        forAll(cloudDirs, cloudI)
        {
            ...
            tnbLib::IOobject* positionsPtr = cloudObjs.lookup(word("positions"));
    ...
    forAllConstIter(wordHashSet, allCloudNames, cloudIter)
    {
        ...
        forAll(Times, timeI)
        {
            ...
            {
                const tnbLib::IOobject obj = *fieldIter();
    ...
    forAll(Times, timeIndex)
    {
        ...
        word timeName = tnbLib::itoa(timeIndex);
