...
void tnbLib::ensightMesh::correct()
{
    patchPartOffset_ = 2;
...
tnbLib::ensightMesh::ensightMesh
(
    const fvMesh& mesh,
...
bool tnbLib::ensightMesh::faceToBeIncluded(const label facei) const
{
    bool res = false;
...
void tnbLib::ensightMesh::barrier()
{
    label appI = 0;
...
tnbLib::cellShapeList tnbLib::ensightMesh::map
(
...
void tnbLib::ensightMesh::writePrims
(
    const cellShapeList& cellShapes,
...
void tnbLib::ensightMesh::writePolysNFaces
(
...
void tnbLib::ensightMesh::writePolysNPointsPerFace
(
    const labelList& polys,
    const cellList& cellFaces,
...
void tnbLib::ensightMesh::writePolysPoints
(
    const labelList& polys,
    const cellList& cellFaces,
    const faceList& faces,
...
void tnbLib::ensightMesh::writeAllPolys
(
    const labelList& pointToGlobal,
    ensightStream& ensightGeometryFile
) const
...
void tnbLib::ensightMesh::writeAllPrims
(
    const char* key,
    const label nPrims,
    const cellShapeList& cellShapes,
...
void tnbLib::ensightMesh::writeFacePrims
(
...
void tnbLib::ensightMesh::writeAllFacePrims
(
    const char* key,
    const labelList& prims,
    const label nPrims,
...
void tnbLib::ensightMesh::writeNSidedNPointsPerFace
(
    const faceList& patchFaces,
    ensightStream& ensightGeometryFile
) const
...
void tnbLib::ensightMesh::writeNSidedPoints
(
    const faceList& patchFaces,
    ensightStream& ensightGeometryFile
) const
...
void tnbLib::ensightMesh::writeAllNSided
(
    const labelList& prims,
    const label nPrims,
    const faceList& patchFaces,
...
void tnbLib::ensightMesh::writeAllPoints
(
...
) const
{
    ...
    {
        timeFile += tnbLib::itoa(timeIndex) + '.';
    }
