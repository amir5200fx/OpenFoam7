...
template<class Type>
void tnbLib::tecplotWriter::writeField(const Field<Type>& fld) const
{
...
template<class Type>
tnbLib::tmp<Field<Type>> tnbLib::tecplotWriter::getPatchField
(
...
template<class Type>
tnbLib::tmp<Field<Type>> tnbLib::tecplotWriter::getFaceField
(
...
tnbLib::wordList tnbLib::tecplotWriter::getNames
(
...
template<class Type>
void tnbLib::tecplotWriter::getTecplotNames
(
