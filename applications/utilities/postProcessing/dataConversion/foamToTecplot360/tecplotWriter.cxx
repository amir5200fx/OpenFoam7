...
tnbLib::tecplotWriter::tecplotWriter(const Time& runTime)
:
    runTime_(runTime)
{}
...
void tnbLib::tecplotWriter::writeInit
(
    const word& name,
...
void tnbLib::tecplotWriter::writePolyhedralZone
(
    const word& zoneName,
    INTEGER4 strandID,
    const fvMesh& mesh,
...
void tnbLib::tecplotWriter::writePolygonalZone
(
    const word& zoneName,
    INTEGER4 strandID,
...
void tnbLib::tecplotWriter::writeOrderedZone
(
    const word& zoneName,
    INTEGER4 strandID,
    const label n,
...
void tnbLib::tecplotWriter::writeConnectivity(const fvMesh& mesh) const
{
...
void tnbLib::tecplotWriter::writeConnectivity
(
    const indirectPrimitivePatch& pp
) const
{
...
void tnbLib::tecplotWriter::writeEnd() const
{
Pout<< "writeEnd" << endl;
