...
const tnbLib::label tnbLib::tabulatedWallFunctions::SpaldingsLaw::maxIters_ = 1000;

const tnbLib::scalar
tnbLib::tabulatedWallFunctions::SpaldingsLaw::tolerance_ = 1e-4;


// * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * //

void tnbLib::tabulatedWallFunctions::SpaldingsLaw::invertFunction()
{
    // Initialise u+ and R
    scalar Re = 0.0;
    scalar uPlus = 1;
...
tnbLib::tabulatedWallFunctions::SpaldingsLaw::SpaldingsLaw
(
...
tnbLib::scalar tnbLib::tabulatedWallFunctions::SpaldingsLaw::yPlus
(
    const scalar uPlus
) const
{
...
tnbLib::scalar tnbLib::tabulatedWallFunctions::SpaldingsLaw::Re
(
    const scalar uPlus
) const
{
...
void tnbLib::tabulatedWallFunctions::SpaldingsLaw::writeData(Ostream& os) const
{
    if (invertedTable_.log10())
    {
