...
tnbLib::label tnbLib::router::count(const label weight) const
{
    label cnt = 0;
...
tnbLib::label tnbLib::router::getValue(const label pathValue) const
{
    forAll(weights_, nodeI)
    {
...
tnbLib::label tnbLib::router::findEndNode
(
    const label startNodeI,
    const label prevNodeI,
...
bool tnbLib::router::route(const labelList& path, const label pathValue)
{
    if (pathValue >= 0)
    {
...
tnbLib::labelList tnbLib::router::getRoute(const label pathValue) const
{
