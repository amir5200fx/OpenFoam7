...
#include <centredCFCCellToCellStencilObject.hxx>
...
//    }
...

    {
        ...
        forAll(stencilPoints, celli)
        {
            writeStencilOBJ
            (
                runTime.path() / "centredCECCell" + tnbLib::name(celli) + ".obj",
    ...
    }
    {
        ...
        forAll(stencilPoints, celli)
        {
            writeStencilOBJ
            (
                runTime.path() / "centredCPCCell" + tnbLib::name(celli) + ".obj",
                mesh.cellCentres()[celli],
                stencilPoints[celli]
            );
        }
    }
    {
        ...
        forAll(stencilPoints, celli)
        {
            writeStencilOBJ
            (
                runTime.path() / "centredCFCCell" + tnbLib::name(celli) + ".obj",
                mesh.cellCentres()[celli],
                stencilPoints[celli]
            );
        }
