...
tnbLib::Rosenbrock34::Rosenbrock34(const ODESystem& ode, const dictionary& dict)
	:
	ODESolver(ode, dict),
...
bool tnbLib::Rosenbrock34::resize()
{
	if (ODESolver::resize())
	{
...
tnbLib::scalar tnbLib::Rosenbrock34::solve
(
	const scalar x0,
...
void tnbLib::Rosenbrock34::solve
(
	scalar& x,
	scalarField& y,
	scalar& dxTry
