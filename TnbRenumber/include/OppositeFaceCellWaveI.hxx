...
void tnbLib::OppositeFaceCellWave<Type, TrackingData>::opposingFaceLabels
(
	const label celli,
...
template<class Type, class TrackingData>
tnbLib::OppositeFaceCellWave<Type, TrackingData>::OppositeFaceCellWave
(
	const polyMesh& mesh,
...
template<class Type, class TrackingData>
tnbLib::label tnbLib::OppositeFaceCellWave<Type, TrackingData>::faceToCell()
{
...
template<class Type, class TrackingData>
tnbLib::label tnbLib::OppositeFaceCellWave<Type, TrackingData>::cellToFace()
{
