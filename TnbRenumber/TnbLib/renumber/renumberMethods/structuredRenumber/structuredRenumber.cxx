#include <structuredRenumber.hxx>

#include <addToRunTimeSelectionTable.hxx>
#include <topoDistanceData.hxx>
#include <fvMeshSubset.hxx>
#include <OppositeFaceCellWave.hxx>
...
tnbLib::structuredRenumber::structuredRenumber
(
...
bool tnbLib::structuredRenumber::layerLess::operator()
(
	const label a,
	const label b
	)
...
tnbLib::labelList tnbLib::structuredRenumber::renumber
(
	const polyMesh& mesh,
