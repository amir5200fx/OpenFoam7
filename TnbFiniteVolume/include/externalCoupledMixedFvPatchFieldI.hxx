...
template<class Type>
tnbLib::word tnbLib::externalCoupledMixedFvPatchField<Type>::lockName = "OpenFOAM";

template<class Type>
tnbLib::string
tnbLib::externalCoupledMixedFvPatchField<Type>::patchKey = "# Patch: ";


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

template<class Type>
tnbLib::fileName tnbLib::externalCoupledMixedFvPatchField<Type>::baseDir() const
{
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::setMaster
(
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::writeGeometry
(
	OFstream& osPoints,
	OFstream& osFaces
) const
...
template<class Type>
tnbLib::fileName tnbLib::externalCoupledMixedFvPatchField<Type>::lockFile() const
{
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::createLockFile() const
{
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::removeLockFile() const
{
	if (!master_ || !Pstream::master())
	{
		return;
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::startWait() const
{
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::wait() const
{
	const fileName fName(lockFile());
	label found = 0;
	label totalTime = 0;
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::initialiseRead
(
	IFstream& is
) const
{
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::readData
(
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::writeData
(
	const fileName& transferFile
) const
{
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::writeHeader
(
	OFstream& os
) const
{
...
template<class Type>
tnbLib::externalCoupledMixedFvPatchField<Type>::
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::initialise
(
	const fileName& transferFile
)
{
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::evaluate
(
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::transferData
(
	OFstream& os
) const
{
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::writeGeometry() const
{
	const volFieldType& cvf =
		static_cast<const volFieldType&>(this->internalField());
...
template<class Type>
void tnbLib::externalCoupledMixedFvPatchField<Type>::write(Ostream& os) const
{
