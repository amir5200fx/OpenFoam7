...
namespace tnbLib
{
	...
	protected:
		...
		FoamFiniteVolume_EXPORT autoPtr<indirectPrimitivePatch> allCoupledFacesPatch() const;
		...
		FoamFiniteVolume_EXPORT void calcFaceStencil
		(
	...
	public:
		...
		// Constructors
			...
			//- Construct from mesh
		FoamFiniteVolume_EXPORT explicit cellToFaceStencil(const polyMesh&);
