...
namespace tnbLib
{
	...
	public:
		...
		static const char* typeName_() { return "fixedFluxPressure"; }
		...
		FoamFiniteVolume_EXPORT fixedFluxPressureFvPatchScalarField
		(
			const fvPatch&,
		...
		FoamFiniteVolume_EXPORT virtual void updateCoeffs(const scalarField& snGradp);
