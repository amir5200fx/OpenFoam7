...
void tnbLib::porosityModels::fixedCoeff::apply
(
	scalarField& Udiag,
	vectorField& Usource,
	const scalarField& V,
...
tnbLib::porosityModels::fixedCoeff::fixedCoeff
(
	const word& name,
...
void tnbLib::porosityModels::fixedCoeff::calcTransformModelData()
{
...
void tnbLib::porosityModels::fixedCoeff::calcForce
(
...
void tnbLib::porosityModels::fixedCoeff::correct
(
	fvVectorMatrix& UEqn
) const
{
...
bool tnbLib::porosityModels::fixedCoeff::writeData(Ostream& os) const
{
