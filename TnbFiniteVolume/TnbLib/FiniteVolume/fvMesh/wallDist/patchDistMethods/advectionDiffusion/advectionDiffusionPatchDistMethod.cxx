...
tnbLib::patchDistMethods::advectionDiffusion::advectionDiffusion
(
...
bool tnbLib::patchDistMethods::advectionDiffusion::correct(volScalarField& y)
{
	return correct(y, const_cast<volVectorField&>(volVectorField::null()));
}


bool tnbLib::patchDistMethods::advectionDiffusion::correct
(
	volScalarField& y,
	volVectorField& n
)
