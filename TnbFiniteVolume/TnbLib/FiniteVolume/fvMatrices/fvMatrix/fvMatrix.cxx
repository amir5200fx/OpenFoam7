...
void tnbLib::fvMatrix<Type>::addToInternalField
(
...
template<class Type>
template<class Type2>
void tnbLib::fvMatrix<Type>::subtractFromInternalField
(
	const labelUList& addr,
	const Field<Type2>& pf,
	Field<Type2>& intf
...
template<class Type>
void tnbLib::fvMatrix<Type>::addBoundaryDiag
(
	scalarField& diag,
...
template<class Type>
void tnbLib::fvMatrix<Type>::addCmptAvBoundaryDiag(scalarField& diag) const
{
	forAll(internalCoeffs_, patchi)
	{
		addToInternalField
...
template<class Type>
void tnbLib::fvMatrix<Type>::addBoundarySource
(
	Field<Type>& source,
	const bool couples
) const
...
void tnbLib::fvMatrix<Type>::setValuesFromList
(
...
template<class Type>
tnbLib::fvMatrix<Type>::fvMatrix(const fvMatrix<Type>& fvm)
	:
...
template<class Type>
tnbLib::fvMatrix<Type>::fvMatrix(const tmp<fvMatrix<Type>>& tfvm)
	:
	lduMatrix
	(
...
template<class Type>
tnbLib::tmp<tnbLib::fvMatrix<Type>> tnbLib::fvMatrix<Type>::clone() const
{
...
template<class Type>
void tnbLib::fvMatrix<Type>::setValues
(
	const labelUList& cellLabels,
...
template<class Type>
void tnbLib::fvMatrix<Type>::setReference
(
	const label celli,
	const Type& value,
...
template<class Type>
void tnbLib::fvMatrix<Type>::relax(const scalar alpha)
{
	if (alpha <= 0)
	{
		return;
...
template<class Type>
void tnbLib::fvMatrix<Type>::relax()
{
	if
		(
...
template<class Type>
void tnbLib::fvMatrix<Type>::boundaryManipulate
(
...
template<class Type>
tnbLib::tmp<tnbLib::scalarField> tnbLib::fvMatrix<Type>::D() const
{
...
template<class Type>
tnbLib::tmp<tnbLib::Field<Type>> tnbLib::fvMatrix<Type>::DD() const
{
...
template<class Type>
tnbLib::tmp<tnbLib::volScalarField> tnbLib::fvMatrix<Type>::A() const
{
...
template<class Type>
tnbLib::tmp<tnbLib::volScalarField> tnbLib::fvMatrix<Type>::H1() const
{
...
template<class Type>
void tnbLib::fvMatrix<Type>::operator=(const fvMatrix<Type>& fvmv)
{
	if (this == &fvmv)
	{
		FatalErrorInFunction
...
template<class Type>
void tnbLib::fvMatrix<Type>::operator=(const tmp<fvMatrix<Type>>& tfvmv)
{
	operator=(tfvmv());
	tfvmv.clear();
}
...
template<class Type>
void tnbLib::fvMatrix<Type>::negate()
{
	lduMatrix::negate();
	source_.negate();
...
template<class Type>
void tnbLib::fvMatrix<Type>::operator+=
(
...
template<class Type>
tnbLib::tmp<tnbLib::fvMatrix<Type>> tnbLib::correction
(
	const fvMatrix<Type>& A
)
{
	tmp<tnbLib::fvMatrix<Type>> tAcorr = A - (A & A.psi());
...
{
	tmp<tnbLib::fvMatrix<Type>> tAcorr = tA - (tA() & tA().psi());
...
template<class Type>
tnbLib::tmp<tnbLib::fvMatrix<Type>> tnbLib::operator==
(
	const fvMatrix<Type>& A,
...
template<class Type>
tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const fvMatrix<Type>& fvm)
{
