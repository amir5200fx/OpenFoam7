#include <mappedFixedInternalValueFvPatchField.hxx>
...
template<class Type>
tnbLib::mappedFixedInternalValueFvPatchField<Type>::
...
template<class Type>
void tnbLib::mappedFixedInternalValueFvPatchField<Type>::updateCoeffs()
{
...
template<class Type>
void tnbLib::mappedFixedInternalValueFvPatchField<Type>::write
(
	Ostream& os
) const
{
