#include <plenumPressureFvPatchScalarField.hxx>
...
tnbLib::plenumPressureFvPatchScalarField::plenumPressureFvPatchScalarField
(
	const fvPatch& p,
...
void tnbLib::plenumPressureFvPatchScalarField::updateCoeffs()
{
	if (updated())
	{
		return;
...
void tnbLib::plenumPressureFvPatchScalarField::write(Ostream& os) const
{
