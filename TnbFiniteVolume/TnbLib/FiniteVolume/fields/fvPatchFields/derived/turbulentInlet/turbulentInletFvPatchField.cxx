...
template<class Type>
tnbLib::turbulentInletFvPatchField<Type>::turbulentInletFvPatchField
(
	const fvPatch& p,
...
template<class Type>
void tnbLib::turbulentInletFvPatchField<Type>::autoMap
(
...
template<class Type>
void tnbLib::turbulentInletFvPatchField<Type>::rmap
(
...
template<class Type>
void tnbLib::turbulentInletFvPatchField<Type>::updateCoeffs()
{
	if (this->updated())
	{
		return;
...
template<class Type>
void tnbLib::turbulentInletFvPatchField<Type>::write(Ostream& os) const
{
