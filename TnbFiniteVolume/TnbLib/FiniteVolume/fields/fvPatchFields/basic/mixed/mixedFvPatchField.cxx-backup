...
template<class Type>
tnbLib::mixedFvPatchField<Type>::mixedFvPatchField
(
	const fvPatch& p,
...
template<class Type>
void tnbLib::mixedFvPatchField<Type>::autoMap
(
...
template<class Type>
void tnbLib::mixedFvPatchField<Type>::rmap
(
...
template<class Type>
void tnbLib::mixedFvPatchField<Type>::evaluate(const Pstream::commsTypes)
{
	if (!this->updated())
	{
		this->updateCoeffs();
...
tnbLib::mixedFvPatchField<Type>::snGrad() const
{
	return
		valueFraction_
...
template<class Type>
tnbLib::tmp<tnbLib::Field<Type>>
tnbLib::mixedFvPatchField<Type>::valueInternalCoeffs
(
...
template<class Type>
tnbLib::tmp<tnbLib::Field<Type>>
tnbLib::mixedFvPatchField<Type>::valueBoundaryCoeffs
(
	const tmp<scalarField>&
) const
{
...
template<class Type>
tnbLib::tmp<tnbLib::Field<Type>>
tnbLib::mixedFvPatchField<Type>::gradientInternalCoeffs() const
{
...
template<class Type>
tnbLib::tmp<tnbLib::Field<Type>>
tnbLib::mixedFvPatchField<Type>::gradientBoundaryCoeffs() const
{
	return
...
template<class Type>
void tnbLib::mixedFvPatchField<Type>::write(Ostream& os) const
{
