...
#define FoamProcessorFvsPatchField_EXPORT __declspec(dllexport)
#else
#ifdef FoamProcessorFvsPatchField_EXPORT_DEFINE
#define FoamProcessorFvsPatchField_EXPORT __declspec(dllexport)
#else
#define FoamProcessorFvsPatchField_EXPORT __declspec(dllimport)
#endif
#endif
...
namespace tnbLib
{
	...
	public:
		...
		static FoamProcessorFvsPatchField_EXPORT const ::tnbLib::word typeName;
		static FoamProcessorFvsPatchField_EXPORT int debug;
