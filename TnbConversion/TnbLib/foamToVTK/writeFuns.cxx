...
void tnbLib::writeFuns::swapWord(label& word32)
{
...
void tnbLib::writeFuns::swapWords(const label nWords, label* words32)
{
...
void tnbLib::writeFuns::writeHeader
(
    std::ostream& os,
    const bool binary,
...
void tnbLib::writeFuns::writeCellDataHeader
(
    std::ostream& os,
    const label nCells,
    const label nFields
...
void tnbLib::writeFuns::writePointDataHeader
(
    std::ostream& os,
    const label nPoints,
    const label nFields
...
void tnbLib::writeFuns::insert(const scalar src, DynamicList<floatScalar>& dest)
{
    dest.append(float(src));
}


void tnbLib::writeFuns::insert(const vector& src, DynamicList<floatScalar>& dest)
{
...
void tnbLib::writeFuns::insert(const tensor& src, DynamicList<floatScalar>& dest)
{
...
void tnbLib::writeFuns::insert(const labelList& src, DynamicList<label>& dest)
{
    dest.append(src);
}
