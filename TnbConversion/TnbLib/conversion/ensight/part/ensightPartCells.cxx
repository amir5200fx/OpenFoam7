...
const tnbLib::polyMesh* const tnbLib::ensightPartCells::polyMeshNullPtr_ = nullptr;

const tnbLib::List<tnbLib::word> tnbLib::ensightPartCells::elemTypes_
(
	IStringStream
	(
...
void tnbLib::ensightPartCells::classify
(
	const polyMesh& mesh,
...
tnbLib::ensightPartCells::ensightPartCells
(
	label partNumber,
...
tnbLib::ensightPartCells::ensightPartCells(const ensightPartCells& part)
	:
	ensightPart(part),
	mesh_(part.mesh_)
{}
...
tnbLib::ensightPartCells::ensightPartCells(Istream& is)
	:
	ensightPart(),
	mesh_(*polyMeshNullPtr_)
{
...
tnbLib::ensightPart::localPoints tnbLib::ensightPartCells::calcLocalPoints() const
{
...
void tnbLib::ensightPartCells::writeConnectivity
(
	ensightGeoFile& os,
	const word& key,
	const labelUList& idList,
...
void tnbLib::ensightPartCells::writeGeometry(ensightGeoFile& os) const
{
