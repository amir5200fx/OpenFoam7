...
tnbLib::labelList tnbLib::polyDualMesh::getFaceOrder
(
...
// is in face order
void tnbLib::polyDualMesh::getPointEdges
(
...
tnbLib::labelList tnbLib::polyDualMesh::collectPatchSideFace
(
...
void tnbLib::polyDualMesh::collectPatchInternalFace
(
	const polyPatch& patch,
	const label patchToDualOffset,
	const labelList& edgeToDualPoint,
...
void tnbLib::polyDualMesh::splitFace
(
	const polyPatch& patch,
	const labelList& pointToDualPoint,
...
void tnbLib::polyDualMesh::dualPatch
(
	const polyPatch& patch,
	const label patchToDualOffset,
	const labelList& edgeToDualPoint,
...
void tnbLib::polyDualMesh::calcDual
(
	const polyMesh& mesh,
...
tnbLib::polyDualMesh::polyDualMesh(const IOobject& io)
	:
	polyMesh(io),
	cellPoint_
	(
...
tnbLib::polyDualMesh::polyDualMesh
(
	const polyMesh& mesh,
	const labelList& featureEdges,
	const labelList& featurePoints
...
void tnbLib::polyDualMesh::calcFeatures
(
	const polyMesh& mesh,
	const scalar featureCos,
