...
const char* const tnbLib::meshReaders::STARCD::defaultBoundaryName =
"Default_Boundary_Region";

const char* const tnbLib::meshReaders::STARCD::defaultSolidBoundaryName =
"Default_Boundary_Solid";

bool tnbLib::meshReaders::STARCD::keepSolids = false;

const int tnbLib::meshReaders::STARCD::starToFoamFaceAddr[4][6] =
{
...
void tnbLib::meshReaders::STARCD::readToNewline(IFstream& is)
{
	char ch = '\n';
	do
	{
...
bool tnbLib::meshReaders::STARCD::readHeader(IFstream& is, word fileSignature)
{
	if (!is.good())
	{
...
void tnbLib::meshReaders::STARCD::readAux(const objectRegistry& registry)
{
...
\*---------------------------------------------------------------------------*/
void tnbLib::meshReaders::STARCD::readPoints
(
...
)
{
	...
	// from Star vertex numbers to tnbLib point labels
	if (nPoints > 0)
	{
		IFstream is(inputName);
		readHeader(is, fileSignature);
...
void tnbLib::meshReaders::STARCD::readCells(const fileName& inputName)
{
...
void tnbLib::meshReaders::STARCD::readBoundary(const fileName& inputName)
{
...
//
void tnbLib::meshReaders::STARCD::cullPoints()
{
...
bool tnbLib::meshReaders::STARCD::readGeometry(const scalar scaleFactor)
{
...
tnbLib::meshReaders::STARCD::STARCD
(
