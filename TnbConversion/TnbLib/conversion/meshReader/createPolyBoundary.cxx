...
void tnbLib::meshReader::addPolyBoundaryFace
(
	const label cellId,
...
void tnbLib::meshReader::createPolyBoundary()
{
...
tnbLib::List<tnbLib::polyPatch*>
tnbLib::meshReader::polyBoundaryPatches(const polyMesh& mesh)
{
