#pragma once
#ifndef _fieldAverageItem_Header
#define _fieldAverageItem_Header
...
Class
	tnbLib::functionObjects::fieldAverageItem

Description
	Helper class to describe what form of averaging to apply.  A set will be
	applied to each base field in tnbLib::fieldAverage, of the form:
...
#endif // !_fieldAverageItem_Header
