...
#include <regionSplit.hxx>  // added by amir
...
void tnbLib::functionObjects::regionSizeDistribution::writeGraph
(
...
void tnbLib::functionObjects::regionSizeDistribution::writeAlphaFields
(
...
tnbLib::Map<tnbLib::label>
tnbLib::functionObjects::regionSizeDistribution::findPatchRegions
(
	const regionSplit& regions
) const
{
...
tnbLib::functionObjects::regionSizeDistribution::divide
(
...
void tnbLib::functionObjects::regionSizeDistribution::writeGraphs
(
...
) const
{
	if (Pstream::master())
	{
		...
		forAll(sortedField, i)
		{
			binSqrSum[indices[i]] += tnbLib::sqr(sortedField[i]);
		}
		scalarField binDev
		(
			sqrt(divide(binSqrSum, binCount) - tnbLib::sqr(binAvg))
		);
...
tnbLib::functionObjects::regionSizeDistribution::regionSizeDistribution
(
	const word& name,
	const Time& runTime,
...
bool tnbLib::functionObjects::regionSizeDistribution::read(const dictionary& dict)
{
...
bool tnbLib::functionObjects::regionSizeDistribution::execute()
{
	return true;
}


bool tnbLib::functionObjects::regionSizeDistribution::write()
{
