...
#include <cyclicPolyPatch.hxx>  // added by amir
...
void tnbLib::fvMeshDistribute::inplaceRenumberWithFlip
(
...
)
{
	...
	{
		tnbLib::inplaceRenumber(oldToNew, lst);
	}
	else
	{
...
tnbLib::labelList tnbLib::fvMeshDistribute::select
(
...
void tnbLib::fvMeshDistribute::checkEqualWordList
(
	const string& msg,
	const wordList& lst
)
...
tnbLib::wordList tnbLib::fvMeshDistribute::mergeWordList(const wordList& procNames)
{
	List<wordList> allNames(Pstream::nProcs());
...
void tnbLib::fvMeshDistribute::printMeshInfo(const fvMesh& mesh)
{
	Pout << "Primitives:" << nl
...
void tnbLib::fvMeshDistribute::printCoupleInfo
(
...
tnbLib::label tnbLib::fvMeshDistribute::findNonEmptyPatch() const
{
...
// non-processor patch.
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::fvMeshDistribute::deleteProcPatches
(
...
// Repatch the mesh.
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::fvMeshDistribute::repatch
(
...
// merge those points.
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::fvMeshDistribute::mergeSharedPoints
(
...
void tnbLib::fvMeshDistribute::getCouplingData
(
...
void tnbLib::fvMeshDistribute::subsetCouplingData
(
	const fvMesh& mesh,
...
void tnbLib::fvMeshDistribute::findCouples
(
	const primitiveMesh& mesh,
	const labelList& sourceFace,
	const labelList& sourceProc,
...
tnbLib::labelList tnbLib::fvMeshDistribute::mapBoundaryData
(
...
tnbLib::labelList tnbLib::fvMeshDistribute::mapPointData
(
	const primitiveMesh& mesh,      // mesh after adding
	const mapAddedPolyMesh& map,
	const labelList& boundaryData0, // on mesh before adding
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::fvMeshDistribute::doRemoveCells
(
...
void tnbLib::fvMeshDistribute::addProcPatches
(
...
tnbLib::labelList tnbLib::fvMeshDistribute::getBoundaryPatch
(
...
void tnbLib::fvMeshDistribute::sendMesh
(
	const label domain,
	const fvMesh& mesh,
...
tnbLib::autoPtr<tnbLib::fvMesh> tnbLib::fvMeshDistribute::receiveMesh
(
	const label domain,
	const wordList& pointZoneNames,
	const wordList& faceZoneNames,
...
tnbLib::fvMeshDistribute::fvMeshDistribute(fvMesh& mesh, const scalar mergeTol)
	:
	mesh_(mesh),
	mergeTol_(mergeTol)
{}
...
tnbLib::labelList tnbLib::fvMeshDistribute::countCells
(
	const labelList& distribution
)
{
...
tnbLib::autoPtr<tnbLib::mapDistributePolyMesh> tnbLib::fvMeshDistribute::distribute
(
	const labelList& distribution
)
{
