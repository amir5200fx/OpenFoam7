...
// Synchronise edges
void tnbLib::createShellMesh::syncEdges
(
...
void tnbLib::createShellMesh::calcPointRegions
(
	const globalMeshData& globalData,
...
tnbLib::createShellMesh::createShellMesh
(
	const primitiveFacePatch& patch,
...
void tnbLib::createShellMesh::setRefinement
(
...
void tnbLib::createShellMesh::updateMesh(const mapPolyMesh& map)
{
