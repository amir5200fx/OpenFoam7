...
void tnbLib::faceCoupleInfo::writeOBJ
(
...
void tnbLib::faceCoupleInfo::writePointsFaces() const
{
...
void tnbLib::faceCoupleInfo::writeEdges
(
...
tnbLib::labelList tnbLib::faceCoupleInfo::findMappedEdges
(
	const edgeList& edges,
...
bool tnbLib::faceCoupleInfo::regionEdge
(
...
tnbLib::label tnbLib::faceCoupleInfo::mostAlignedCutEdge
(
	const bool report,
	const polyMesh& slaveMesh,
...
void tnbLib::faceCoupleInfo::setCutEdgeToPoints(const labelList& cutToMasterEdges)
{
...
tnbLib::label tnbLib::faceCoupleInfo::matchFaces
(
	const scalar absTol,
	const pointField& points0,
	const face& f0,
...
)
{
	...
	forAll(f0, startFp)
	{
		...
		forAll(f1, i)
		{
			scalar distSqr = tnbLib::magSqr(points0[f0[fp0]] - points1[f1[fp1]]);
...
bool tnbLib::faceCoupleInfo::matchPointsThroughFaces
(
	const scalar absTol,
...
tnbLib::scalar tnbLib::faceCoupleInfo::maxDistance
(
	const face& cutF,
	const pointField& cutPoints,
	const face& masterF,
...
void tnbLib::faceCoupleInfo::findPerfectMatchingFaces
(
...
void tnbLib::faceCoupleInfo::findSlavesCoveringMaster
(
	const primitiveMesh& mesh0,
	const primitiveMesh& mesh1,
	const scalar absTol,
...
)
{
			...
			)
	{
		...
		pointIndexHit nearInfo = tree.findNearest(fc, tnbLib::sqr(absTol));
...
tnbLib::label tnbLib::faceCoupleInfo::growCutFaces
(
	const labelList& cutToMasterEdges,
...
void tnbLib::faceCoupleInfo::checkMatch(const labelList& cutToMasterEdges) const
{
...
tnbLib::label tnbLib::faceCoupleInfo::matchEdgeFaces
(
	const labelList& cutToMasterEdges,
	Map<labelList>& candidates
)
...
tnbLib::label tnbLib::faceCoupleInfo::geometricMatchEdgeFaces
(
	Map<labelList>& candidates
)
{
...
void tnbLib::faceCoupleInfo::perfectPointMatch
(
	const scalar absTol,
...
void tnbLib::faceCoupleInfo::subDivisionMatch
(
	const polyMesh& slaveMesh,
	const bool patchDivision,
	const scalar absTol
...
tnbLib::faceCoupleInfo::faceCoupleInfo
(
...
tnbLib::labelList tnbLib::faceCoupleInfo::faceLabels(const polyPatch& pp)
{
...
tnbLib::Map<tnbLib::label> tnbLib::faceCoupleInfo::makeMap(const labelList& lst)
{
...
tnbLib::Map<tnbLib::labelList> tnbLib::faceCoupleInfo::makeMap
(
