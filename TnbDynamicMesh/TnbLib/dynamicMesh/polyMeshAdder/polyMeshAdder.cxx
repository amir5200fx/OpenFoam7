...
tnbLib::label tnbLib::polyMeshAdder::patchIndex
(
	const polyPatch& p,
...
tnbLib::label tnbLib::polyMeshAdder::zoneIndex
(
	const word& curName,
...
void tnbLib::polyMeshAdder::mergePatchNames
(
...
tnbLib::labelList tnbLib::polyMeshAdder::getPatchStarts
(
...
tnbLib::labelList tnbLib::polyMeshAdder::getPatchSizes
(
	const polyBoundaryMesh& patches
)
{
...
tnbLib::List<tnbLib::polyPatch*> tnbLib::polyMeshAdder::combinePatches
(
...
tnbLib::labelList tnbLib::polyMeshAdder::getFaceOrder
(
...
void tnbLib::polyMeshAdder::insertVertices
(
...
//  - all uncoupled of mesh0
//  - all uncoupled of mesh1
void tnbLib::polyMeshAdder::mergePrimitives
(
	const polyMesh& mesh0,
	const polyMesh& mesh1,
...
void tnbLib::polyMeshAdder::mergePointZones
(
...
void tnbLib::polyMeshAdder::mergeFaceZones
(
...
void tnbLib::polyMeshAdder::mergeCellZones
(
...
void tnbLib::polyMeshAdder::mergeZones
(
	const label nAllPoints,
	const labelList& allOwner,
	const label nAllCells,
...
void tnbLib::polyMeshAdder::addZones
(
...
tnbLib::autoPtr<tnbLib::polyMesh> tnbLib::polyMeshAdder::add
(
	const IOobject& io,
	const polyMesh& mesh0,
	const polyMesh& mesh1,
...
tnbLib::autoPtr<tnbLib::mapAddedPolyMesh> tnbLib::polyMeshAdder::add
(
	polyMesh& mesh0,
	const polyMesh& mesh1,
	const faceCoupleInfo& coupleInfo,
...
tnbLib::Map<tnbLib::label> tnbLib::polyMeshAdder::findSharedPoints
(
	const polyMesh& mesh,
...
)
{
	...
	forAllConstIter(Map<labelList>, sharedToMesh, iter)
	{
		...
		if (connectedPointLabels.size() > 1)
		{
			...
			label nUnique = tnbLib::mergePoints
			(
				connectedPoints,
				mergeDist,
				false,
...
void tnbLib::polyMeshAdder::mergePoints
(
	const polyMesh& mesh,
