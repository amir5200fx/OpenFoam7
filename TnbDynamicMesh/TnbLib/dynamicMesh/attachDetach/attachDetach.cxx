...
void tnbLib::attachDetach::checkDefinition()
{
	if
		(
			!faceZoneID_.active()
...
void tnbLib::attachDetach::clearAddressing() const
{
...
tnbLib::attachDetach::attachDetach
(
	const word& name,
	const label index,
...
bool tnbLib::attachDetach::setAttach() const
{
	if (!attached())
	{
		trigger_ = true;
...
bool tnbLib::attachDetach::setDetach() const
{
	if (attached())
	{
		trigger_ = true;
...
bool tnbLib::attachDetach::changeTopology() const
{
	if (manualTrigger())
	{
		if (debug)
...
void tnbLib::attachDetach::setRefinement(polyTopoChange& ref) const
{
...
void tnbLib::attachDetach::updateMesh(const mapPolyMesh&)
{
...
void tnbLib::attachDetach::write(Ostream& os) const
{
	os << nl << type() << nl
		<< name() << nl
		<< faceZoneID_.name() << nl
...
void tnbLib::attachDetach::writeDict(Ostream& os) const
{
