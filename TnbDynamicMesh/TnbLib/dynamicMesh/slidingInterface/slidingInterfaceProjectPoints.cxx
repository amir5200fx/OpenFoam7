...
const tnbLib::scalar tnbLib::slidingInterface::pointMergeTolDefault_ = 0.05;
const tnbLib::scalar tnbLib::slidingInterface::edgeMergeTolDefault_ = 0.01;
const tnbLib::label tnbLib::slidingInterface::nFacesPerSlaveEdgeDefault_ = 5;
const tnbLib::label tnbLib::slidingInterface::edgeFaceEscapeLimitDefault_ = 10;

const tnbLib::scalar tnbLib::slidingInterface::integralAdjTolDefault_ = 0.05;
const tnbLib::scalar
tnbLib::slidingInterface::edgeMasterCatchFractionDefault_ = 0.4;
const tnbLib::scalar tnbLib::slidingInterface::edgeEndCutoffTolDefault_ = 0.0001;
...
bool tnbLib::slidingInterface::projectPoints() const
{
	if (debug)
	{
...
void tnbLib::slidingInterface::clearPointProjection() const
{
	deleteDemandDrivenData(slavePointPointHitsPtr_);
	deleteDemandDrivenData(slavePointEdgeHitsPtr_);
	deleteDemandDrivenData(slavePointFaceHitsPtr_);
