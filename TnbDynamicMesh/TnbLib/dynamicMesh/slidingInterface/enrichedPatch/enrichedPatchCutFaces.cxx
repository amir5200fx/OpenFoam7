...
const tnbLib::label tnbLib::enrichedPatch::maxFaceSizeDebug_ = 100;
...
void tnbLib::enrichedPatch::calcCutFaces() const
{
...
void tnbLib::enrichedPatch::clearCutFaces()
{
...
const tnbLib::faceList& tnbLib::enrichedPatch::cutFaces() const
{
	if (!cutFacesPtr_)
	{
		calcCutFaces();
...
const tnbLib::labelList& tnbLib::enrichedPatch::cutFaceMaster() const
{
...
const tnbLib::labelList& tnbLib::enrichedPatch::cutFaceSlave() const
{
	if (!cutFaceSlavePtr_)
	{
		calcCutFaces();
