...
const tnbLib::label tnbLib::enrichedPatch::enrichedFaceRatio_ = 3;

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void tnbLib::enrichedPatch::calcEnrichedFaces
(
...
const tnbLib::faceList& tnbLib::enrichedPatch::enrichedFaces() const
{
	if (!enrichedFacesPtr_)
	{
		FatalErrorInFunction
