...
void tnbLib::slidingInterface::calcAttachedAddressing() const
{
	if (debug)
	{
		Pout << "void tnbLib::slidingInterface::calcAttachedAddressing() const "
			<< " for object " << name() << " : "
...
void tnbLib::slidingInterface::clearAttachedAddressing() const
{
...
void tnbLib::slidingInterface::renumberAttachedAddressing
(
	const mapPolyMesh& m
) const
{
...
const tnbLib::labelList& tnbLib::slidingInterface::masterFaceCells() const
{
...
const tnbLib::labelList& tnbLib::slidingInterface::slaveFaceCells() const
{
...
const tnbLib::labelList& tnbLib::slidingInterface::masterStickOutFaces() const
{
...
const tnbLib::labelList& tnbLib::slidingInterface::slaveStickOutFaces() const
{
...
const tnbLib::Map<tnbLib::label>& tnbLib::slidingInterface::retiredPointMap() const
{
...
const tnbLib::Map<tnbLib::Pair<tnbLib::edge>>&
tnbLib::slidingInterface::cutPointEdgePairMap() const
{
