...
void tnbLib::slidingInterface::checkDefinition()
{
...
void tnbLib::slidingInterface::clearOut() const
{
...
tnbLib::slidingInterface::slidingInterface
(
	const word& name,
	const label index,
...
void tnbLib::slidingInterface::clearAddressing() const
{
...
const tnbLib::faceZoneID& tnbLib::slidingInterface::masterFaceZoneID() const
{
	return masterFaceZoneID_;
}


const tnbLib::faceZoneID& tnbLib::slidingInterface::slaveFaceZoneID() const
{
	return slaveFaceZoneID_;
}


bool tnbLib::slidingInterface::changeTopology() const
{
	if (coupleDecouple_)
	{
...
void tnbLib::slidingInterface::setRefinement(polyTopoChange& ref) const
{
	if (coupleDecouple_)
	{
		if (attached_)
...
void tnbLib::slidingInterface::modifyMotionPoints(pointField& motionPoints) const
{
	if (debug)
	{
...
void tnbLib::slidingInterface::updateMesh(const mapPolyMesh& m)
{
	if (debug)
	{
...
const tnbLib::pointField& tnbLib::slidingInterface::pointProjection() const
{
...
void tnbLib::slidingInterface::setTolerances(const dictionary&dict, bool report)
{
...
void tnbLib::slidingInterface::write(Ostream& os) const
{
	os << nl << type() << nl
		<< name() << nl
...
void tnbLib::slidingInterface::writeDict(Ostream& os) const
{
