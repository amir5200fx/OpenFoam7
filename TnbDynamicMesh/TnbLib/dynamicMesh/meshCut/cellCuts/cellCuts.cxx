...
tnbLib::label tnbLib::cellCuts::findPartIndex
(
...
tnbLib::boolList tnbLib::cellCuts::expand
(
    const label size,
...
tnbLib::scalarField tnbLib::cellCuts::expand
(
    const label size,
    const labelList& labels,
...
tnbLib::label tnbLib::cellCuts::firstUnique
(
    const labelList& lst,
    const Map<label>& map
)
...
void tnbLib::cellCuts::writeUncutOBJ
(
    const fileName& dir,
    const label celli
) const
...
tnbLib::label tnbLib::cellCuts::edgeEdgeToFace
(
    const label celli,
    const label edgeA,
    const label edgeB
...
tnbLib::label tnbLib::cellCuts::edgeVertexToFace
(
    const label celli,
    const label edgeI,
    const label vertI
...
tnbLib::label tnbLib::cellCuts::vertexVertexToFace
(
    const label celli,
    const label vertA,
    const label vertB
...
void tnbLib::cellCuts::calcFaceCuts() const
{
...
tnbLib::label tnbLib::cellCuts::findEdge
(
    const label facei,
    const label v0,
    const label v1
...
tnbLib::label tnbLib::cellCuts::loopFace
(
    const label celli,
...
bool tnbLib::cellCuts::walkPoint
(
    const label celli,
...
bool tnbLib::cellCuts::crossEdge
(
    const label celli,
    const label startCut,
    const label facei,
...
void tnbLib::cellCuts::calcCellLoops(const labelList& cutCells)
{
...
void tnbLib::cellCuts::walkEdges
(
    const label celli,
    const label pointi,
    const label status,
...
tnbLib::labelList tnbLib::cellCuts::nonAnchorPoints
(
...
bool tnbLib::cellCuts::loopAnchorConsistent
(
    const label celli,
...
bool tnbLib::cellCuts::calcAnchors
(
    const label celli,
    const labelList& loop,
    const pointField& loopPts,
...
tnbLib::pointField tnbLib::cellCuts::loopPoints
(
    const labelList& loop,
...
tnbLib::scalarField tnbLib::cellCuts::loopWeights(const labelList& loop) const
{
...
bool tnbLib::cellCuts::validEdgeLoop
(
    const labelList& loop,
    const scalarField& loopWeights
) const
...
tnbLib::label tnbLib::cellCuts::countFaceCuts
(
    const label facei,
    const labelList& loop
) const
...
bool tnbLib::cellCuts::conservativeValidLoop
(
    const label celli,
    const labelList& loop
) const
...
bool tnbLib::cellCuts::validLoop
(
    const label celli,
    const labelList& loop,
    const scalarField& loopWeights,
...
void tnbLib::cellCuts::setFromCellLoops()
{
...
bool tnbLib::cellCuts::setFromCellLoop
(
    const label celli,
    const labelList& loop,
    const scalarField& loopWeights
...
void tnbLib::cellCuts::setFromCellCutter
(
...
void tnbLib::cellCuts::orientPlanesAndLoops()
{
...
void tnbLib::cellCuts::calcLoopsAndAddressing(const labelList& cutCells)
{
...
void tnbLib::cellCuts::check() const
{
...
tnbLib::pointField tnbLib::cellCuts::loopPoints(const label celli) const
{
    const labelList& loop = cellLoops_[celli];
...
void tnbLib::cellCuts::flip(const label celli)
{
    labelList& loop = cellLoops_[celli];
...
void tnbLib::cellCuts::flipLoopOnly(const label celli)
{
    labelList& loop = cellLoops_[celli];
...
void tnbLib::cellCuts::writeOBJ(Ostream& os) const
{
    label vertI = 0;
...
void tnbLib::cellCuts::writeCellOBJ(const fileName& dir, const label celli) const
{
    const labelList& anchors = cellAnchorPoints_[celli];
