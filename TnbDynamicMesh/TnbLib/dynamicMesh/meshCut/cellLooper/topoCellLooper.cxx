...
const tnbLib::scalar tnbLib::topoCellLooper::featureCos = tnbLib::cos(degToRad(10.0));
...
template<class T>
void tnbLib::topoCellLooper::subsetList
(
    const label startI,
    const label freeI,
    DynamicList<T>& lst
...
//      startVert != -1
//
void tnbLib::topoCellLooper::walkFace
(
...
// not.
tnbLib::labelList tnbLib::topoCellLooper::getSuperEdge
(
    const cellFeatures& features,
    const label facei,
    const label startEdgeI,
...
tnbLib::label tnbLib::topoCellLooper::getAlignedNonFeatureEdge
(
    const vector& refDir,
    const label celli,
    const cellFeatures& features
...
void tnbLib::topoCellLooper::walkAcrossFace
(
    const cellFeatures& features,
    const label facei,
    const label startEdgeI,
...
void tnbLib::topoCellLooper::walkSplitHex
(
    const label celli,
    const cellFeatures& features,
...
tnbLib::topoCellLooper::topoCellLooper(const polyMesh& mesh)
    :
    hexCellLooper(mesh)
{}
...
tnbLib::topoCellLooper::~topoCellLooper()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool tnbLib::topoCellLooper::cut
(
    const vector& refDir,
    const label celli,
