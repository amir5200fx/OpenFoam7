#include <multiDirRefinement.hxx>
...
void tnbLib::multiDirRefinement::addCells
(
...
// original cell.
void tnbLib::multiDirRefinement::update
(
    const Map<label>& splitMap,
    vectorField& field
)
...
tnbLib::labelList tnbLib::multiDirRefinement::splitOffHex(const primitiveMesh& mesh)
{
...
void tnbLib::multiDirRefinement::refineHex8
(
    polyMesh& mesh,
...
void tnbLib::multiDirRefinement::refineAllDirs
(
    polyMesh& mesh,
...
void tnbLib::multiDirRefinement::refineFromDict
(
    polyMesh& mesh,
    List<vectorField>& cellDirections,
...
tnbLib::multiDirRefinement::multiDirRefinement
(
    polyMesh& mesh,
