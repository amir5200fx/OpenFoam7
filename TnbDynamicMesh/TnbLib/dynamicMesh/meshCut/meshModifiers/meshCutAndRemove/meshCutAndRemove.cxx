...
tnbLib::label tnbLib::meshCutAndRemove::firstCommon
(
...
bool tnbLib::meshCutAndRemove::isIn
(
    const edge& twoCuts,
...
tnbLib::label tnbLib::meshCutAndRemove::findCutCell
(
    const cellCuts& cuts,
...
tnbLib::label tnbLib::meshCutAndRemove::findInternalFacePoint
(
...
tnbLib::label tnbLib::meshCutAndRemove::findPatchFacePoint
(
    const face& f,
...
void tnbLib::meshCutAndRemove::faceCells
(
    const cellCuts& cuts,
    const label exposedPatchi,
    const label facei,
...
void tnbLib::meshCutAndRemove::getZoneInfo
(
    const label facei,
    label& zoneID,
    bool& zoneFlip
...
void tnbLib::meshCutAndRemove::addFace
(
...
void tnbLib::meshCutAndRemove::modFace
(
    polyTopoChange& meshMod,
    const label facei,
    const face& newFace,
...
void tnbLib::meshCutAndRemove::copyFace
(
    const face& f,
    const label startFp,
    const label endFp,
...
// (addedPoints_).
void tnbLib::meshCutAndRemove::splitFace
(
    const face& f,
    const label v0,
    const label v1,
...
tnbLib::face tnbLib::meshCutAndRemove::addEdgeCutsToFace(const label facei) const
{
    const face& f = mesh().faces()[facei];
...
tnbLib::face tnbLib::meshCutAndRemove::loopToFace
(
    const label celli,
...
tnbLib::meshCutAndRemove::meshCutAndRemove(const polyMesh& mesh)
    :
    edgeVertex(mesh),
    addedFaces_(),
    addedPoints_()
...
void tnbLib::meshCutAndRemove::setRefinement
(
    const label exposedPatchi,
    const cellCuts& cuts,
...
void tnbLib::meshCutAndRemove::updateMesh(const mapPolyMesh& map)
{
