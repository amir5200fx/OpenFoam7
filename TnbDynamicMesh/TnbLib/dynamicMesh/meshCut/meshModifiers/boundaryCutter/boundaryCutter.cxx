...
void tnbLib::boundaryCutter::getFaceInfo
(
    const label facei,
    label& patchID,
    label& zoneID,
...
tnbLib::face tnbLib::boundaryCutter::addEdgeCutsToFace
(
    const label facei,
...
void tnbLib::boundaryCutter::addFace
(
    const label facei,
    const face& newFace,
...
bool tnbLib::boundaryCutter::splitFace
(
    const label facei,
...
tnbLib::boundaryCutter::boundaryCutter(const polyMesh& mesh)
    :
    mesh_(mesh),
    edgeAddedPoints_(),
    faceAddedPoint_()
...
tnbLib::boundaryCutter::~boundaryCutter()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

void tnbLib::boundaryCutter::setRefinement
(
    const Map<point>& pointToPos,
...
void tnbLib::boundaryCutter::updateMesh(const mapPolyMesh& morphMap)
{
