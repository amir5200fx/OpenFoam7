...
void tnbLib::directions::writeOBJ(Ostream& os, const point& pt)
{
    os << "v " << pt.x() << ' ' << pt.y() << ' ' << pt.z() << endl;
}


void tnbLib::directions::writeOBJ
(
    Ostream& os,
    const point& pt0,
    const point& pt1,
...
void tnbLib::directions::check2D
(
...
tnbLib::vectorField tnbLib::directions::propagateDirection
(
    const polyMesh& mesh,
    const bool useTopo,
    const polyPatch& pp,
