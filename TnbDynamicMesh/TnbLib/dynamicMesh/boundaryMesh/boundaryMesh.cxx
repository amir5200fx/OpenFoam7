...
tnbLib::label tnbLib::boundaryMesh::nFeatureEdges(label pointi) const
{
	label nFeats = 0;
...
tnbLib::label tnbLib::boundaryMesh::nextFeatureEdge
(
	const label edgeI,
	const label vertI
) const
...
// featVisited.
tnbLib::labelList tnbLib::boundaryMesh::collectSegment
(
...
void tnbLib::boundaryMesh::markEdges
(
...
tnbLib::label tnbLib::boundaryMesh::findPatchID
(
...
tnbLib::wordList tnbLib::boundaryMesh::patchNames() const
{
...
tnbLib::label tnbLib::boundaryMesh::whichPatch
(
	const polyPatchList& patches,
	const label facei
) const
...
tnbLib::labelList tnbLib::boundaryMesh::faceToEdge
(
...
tnbLib::labelList tnbLib::boundaryMesh::edgeToFace
(
	const label region,
...
void tnbLib::boundaryMesh::markZone
(
...
// Null constructor
tnbLib::boundaryMesh::boundaryMesh()
	:
	meshPtr_(nullptr),
	patches_(),
	meshFace_(),
...
void tnbLib::boundaryMesh::clearOut()
{
	if (meshPtr_)
	{
		delete meshPtr_;
...
void tnbLib::boundaryMesh::read(const polyMesh& mesh)
{
	patches_.clear();
...
void tnbLib::boundaryMesh::readTriSurface(const fileName& fName)
{
...
void tnbLib::boundaryMesh::writeTriSurface(const fileName& fName) const
{
...
tnbLib::labelList tnbLib::boundaryMesh::getNearest
(
...
void tnbLib::boundaryMesh::patchify
(
...
void tnbLib::boundaryMesh::setFeatureEdges(const scalar minCos)
{
...
void tnbLib::boundaryMesh::setExtraEdges(const label edgeI)
{
...
tnbLib::label tnbLib::boundaryMesh::whichPatch(const label facei) const
{
	forAll(patches_, patchi)
	{
		const boundaryPatch& bp = patches_[patchi];
...
tnbLib::label tnbLib::boundaryMesh::findPatchID(const word& patchName) const
{
	forAll(patches_, patchi)
	{
...
void tnbLib::boundaryMesh::addPatch(const word& patchName)
{
...
void tnbLib::boundaryMesh::deletePatch(const word& patchName)
{
...
void tnbLib::boundaryMesh::changePatchType
(
	const word& patchName,
...
void tnbLib::boundaryMesh::changeFaces
(
...
tnbLib::label tnbLib::boundaryMesh::getNTris(const label facei) const
{
...
tnbLib::label tnbLib::boundaryMesh::getNTris
(
...
void tnbLib::boundaryMesh::triangulate
(
	const label startFacei,
	const label nFaces,
...
tnbLib::label tnbLib::boundaryMesh::getNPoints
(
	const label startFacei,
	const label nFaces
) const
...
void tnbLib::boundaryMesh::triangulateLocal
(
	const label startFacei,
	const label nFaces,
	const label totalNTris,
...
void tnbLib::boundaryMesh::markFaces
(
