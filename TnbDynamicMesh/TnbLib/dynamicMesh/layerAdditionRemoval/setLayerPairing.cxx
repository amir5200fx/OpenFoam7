...
bool tnbLib::layerAdditionRemoval::setLayerPairing() const
{
	// Note:
...
const tnbLib::labelList& tnbLib::layerAdditionRemoval::pointsPairing() const
{
...
const tnbLib::labelList& tnbLib::layerAdditionRemoval::facesPairing() const
{
	if (!facesPairingPtr_)
	{
		FatalErrorInFunction
...
void tnbLib::layerAdditionRemoval::modifyMotionPoints
(
