...
void tnbLib::removePoints::modifyFace
(
	const label facei,
	const face& newFace,
...
tnbLib::removePoints::removePoints
(
	const polyMesh& mesh,
	const bool undoable
)
...
tnbLib::label tnbLib::removePoints::countPointUsage
(
	const scalar minCos,
...
void tnbLib::removePoints::setRefinement
(
...
void tnbLib::removePoints::updateMesh(const mapPolyMesh& map)
{
	if (undoable_)
	{
...
void tnbLib::removePoints::getUnrefimentSet
(
...
) const
{
...

	{
		...
		(
			...
			tnbLib::dummyTransform()      // no transformation
		);
...
void tnbLib::removePoints::setUnrefinement
(
