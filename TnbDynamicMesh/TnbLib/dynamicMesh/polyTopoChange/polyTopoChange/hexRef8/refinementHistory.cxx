...
void tnbLib::refinementHistory::writeEntry
(
...
void tnbLib::refinementHistory::writeDebug
(
...
tnbLib::refinementHistory::splitCell8::splitCell8()
	:
	parent_(-1),
...
tnbLib::refinementHistory::splitCell8::splitCell8(const label parent)
	:
	parent_(parent),
	addedCellsPtr_(nullptr)
{}
...
tnbLib::refinementHistory::splitCell8::splitCell8(Istream& is)
{
	is >> *this;
}


tnbLib::refinementHistory::splitCell8::splitCell8(const splitCell8& sc)
	:
	parent_(sc.parent_),
	addedCellsPtr_
	(
...
void tnbLib::refinementHistory::splitCell8::operator=(const splitCell8& s)
{
	...
	if (this == &s)
	{
		FatalErrorIn("splitCell8::operator=(const tnbLib::splitCell8&)")
...
bool tnbLib::refinementHistory::splitCell8::operator==(const splitCell8& s) const
{
...
void tnbLib::refinementHistory::checkIndices() const
{
	// Check indices.
...
tnbLib::label tnbLib::refinementHistory::allocateSplitCell
(
	const label parent,
	const label i
)
...
void tnbLib::refinementHistory::freeSplitCell(const label index)
{
...
void tnbLib::refinementHistory::markSplit
(
	const label index,
	labelList& oldToNew,
...
void tnbLib::refinementHistory::mark
(
	const label val,
	const label index,
...
tnbLib::label tnbLib::refinementHistory::markCommonCells
(
...
void tnbLib::refinementHistory::add
(
...
void tnbLib::refinementHistory::apply
(
...
tnbLib::refinementHistory::refinementHistory(const IOobject& io)
	:
	regIOobject(io),
	active_(false)
{
...
tnbLib::refinementHistory::refinementHistory
(
	const IOobject& io,
	const List<splitCell8>& splitCells,
	const labelList& visibleCells,
...
tnbLib::refinementHistory::refinementHistory(const IOobject& io, Istream& is)
	:
	regIOobject(io),
	splitCells_(is),
	freeSplitCells_(0),
...
tnbLib::autoPtr<tnbLib::refinementHistory> tnbLib::refinementHistory::clone
(
	const IOobject& io,
...
void tnbLib::refinementHistory::resize(const label size)
{
...
void tnbLib::refinementHistory::updateMesh(const mapPolyMesh& map)
{
	if (active())
	{
...
void tnbLib::refinementHistory::subset
(
...
void tnbLib::refinementHistory::countProc
(
	const label index,
...
void tnbLib::refinementHistory::distribute(const mapDistributePolyMesh& map)
{
	if (!active())
	{
		FatalErrorInFunction
...
void tnbLib::refinementHistory::compact()
{
	if (debug)
	{
...
void tnbLib::refinementHistory::writeDebug() const
{
	writeDebug(visibleCells_, splitCells_);
}


void tnbLib::refinementHistory::storeSplit
(
	const label celli,
...
void tnbLib::refinementHistory::combineCells
(
...
bool tnbLib::refinementHistory::read()
{
...
bool tnbLib::refinementHistory::readData(Istream& is)
{
	is >> *this;
	return !is.bad();
}
...
bool tnbLib::refinementHistory::writeData(Ostream& os) const
{
	os << *this;
