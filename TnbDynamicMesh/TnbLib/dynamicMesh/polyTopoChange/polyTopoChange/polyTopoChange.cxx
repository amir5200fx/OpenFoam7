...
void tnbLib::polyTopoChange::renumberReverseMap
(
	const labelList& map,
...
void tnbLib::polyTopoChange::renumber
(
	const labelList& map,
	labelHashSet& elems
)
...
void tnbLib::polyTopoChange::renumberCompact
(
	const labelList& map,
	labelList& elems
)
...
void tnbLib::polyTopoChange::countMap
(
	const labelList& map,
...
tnbLib::labelHashSet tnbLib::polyTopoChange::getSetIndices
(
...
void tnbLib::polyTopoChange::writeMeshStats(const polyMesh& mesh, Ostream& os)
{
...
void tnbLib::polyTopoChange::getMergeSets
(
...
bool tnbLib::polyTopoChange::hasValidPoints(const face& f) const
{
	forAll(f, fp)
	{
...
tnbLib::pointField tnbLib::polyTopoChange::facePoints(const face& f) const
{
...
void tnbLib::polyTopoChange::checkFace
(
	const face& f,
	const label facei,
	const label own,
...
void tnbLib::polyTopoChange::makeCells
(
...
// of faces
void tnbLib::polyTopoChange::makeCellCells
(
	const label nActiveFaces,
...
tnbLib::label tnbLib::polyTopoChange::getCellOrder
(
...
void tnbLib::polyTopoChange::getFaceOrder
(
	const label nActiveFaces,
...
void tnbLib::polyTopoChange::reorderCompactFaces
(
	const label newSize,
...
void tnbLib::polyTopoChange::compact
(
...
tnbLib::labelList tnbLib::polyTopoChange::selectFaces
(
...
// label)
void tnbLib::polyTopoChange::calcPatchPointMap
(
...
void tnbLib::polyTopoChange::calcFaceInflationMaps
(
	const polyMesh& mesh,
...
void tnbLib::polyTopoChange::calcCellInflationMaps
(
	const polyMesh& mesh,
...
void tnbLib::polyTopoChange::resetZones
(
	const polyMesh& mesh,
	polyMesh& newMesh,
...
void tnbLib::polyTopoChange::calcFaceZonePointMap
(
	const polyMesh& mesh,
...
void tnbLib::polyTopoChange::reorderCoupledFaces
(
...
void tnbLib::polyTopoChange::compactAndReorder
(
	const polyMesh& mesh,
	const bool syncParallel,
	const bool orderCells,
...
tnbLib::polyTopoChange::polyTopoChange(const label nPatches, const bool strict)
	:
	strict_(strict),
	nPatches_(nPatches),
	points_(0),
...
// Construct from components
tnbLib::polyTopoChange::polyTopoChange
(
	const polyMesh& mesh,
	const bool strict
)
...
void tnbLib::polyTopoChange::clear()
{
...
void tnbLib::polyTopoChange::addMesh
(
	const polyMesh& mesh,
...
void tnbLib::polyTopoChange::setCapacity
(
	const label nPoints,
	const label nFaces,
	const label nCells
...
tnbLib::label tnbLib::polyTopoChange::setAction(const topoAction& action)
{
...
tnbLib::label tnbLib::polyTopoChange::addPoint
(
	const point& pt,
...
void tnbLib::polyTopoChange::modifyPoint
(
	const label pointi,
	const point& pt,
...
void tnbLib::polyTopoChange::movePoints(const pointField& newPoints)
{
...
void tnbLib::polyTopoChange::removePoint
(
	const label pointi,
...
tnbLib::label tnbLib::polyTopoChange::addFace
(
	const face& f,
	const label own,
	const label nei,
...
void tnbLib::polyTopoChange::modifyFace
(
	const face& f,
	const label facei,
	const label own,
...
void tnbLib::polyTopoChange::removeFace(const label facei, const label mergeFacei)
{
...
tnbLib::label tnbLib::polyTopoChange::addCell
(
	const label masterPointID,
	const label masterEdgeID,
	const label masterFaceID,
...
void tnbLib::polyTopoChange::modifyCell
(
	const label celli,
	const label zoneID
)
...
void tnbLib::polyTopoChange::removeCell(const label celli, const label mergeCelli)
{
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::polyTopoChange::changeMesh
(
	polyMesh& mesh,
	const bool inflate,
	const bool syncParallel,
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::polyTopoChange::makeMesh
(
