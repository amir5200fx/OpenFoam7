...
void tnbLib::removeFaces::changeCellRegion
(
	const label celli,
...
tnbLib::label tnbLib::removeFaces::changeFaceRegion
(
...
// - removal of edges
// - removal of points
tnbLib::boolList tnbLib::removeFaces::getFacesAffected
(
	const labelList& cellRegion,
...
void tnbLib::removeFaces::writeOBJ
(
...
void tnbLib::removeFaces::mergeFaces
(
	const labelList& cellRegion,
	const labelList& cellRegionMaster,
	const labelHashSet& pointsToRemove,
...
void tnbLib::removeFaces::getFaceInfo
(
	const label facei,
...
tnbLib::face tnbLib::removeFaces::filterFace
(
	const labelHashSet& pointsToRemove,
	const label facei
) const
...
void tnbLib::removeFaces::modFace
(
	const face& f,
...
// Construct from mesh
tnbLib::removeFaces::removeFaces
(
	const polyMesh& mesh,
	const scalar minCos
)
...
tnbLib::label tnbLib::removeFaces::compatibleRemoves
(
	const labelList& facesToRemove,
	labelList& cellRegion,
...
void tnbLib::removeFaces::setRefinement
(
	const labelList& faceLabels,
	const labelList& cellRegion,
	const labelList& cellRegionMaster,
