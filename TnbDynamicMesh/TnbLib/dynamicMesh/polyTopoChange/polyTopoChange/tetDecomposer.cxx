...
void tnbLib::tetDecomposer::modifyFace
(
...
void tnbLib::tetDecomposer::addFace
(
	polyTopoChange& meshMod,
	const face& f,
	const label own,
...
tnbLib::label tnbLib::tetDecomposer::triIndex(const label facei, const label fp)
const
{
...
tnbLib::tetDecomposer::tetDecomposer(const polyMesh& mesh)
	:
	mesh_(mesh)
{}
...
void tnbLib::tetDecomposer::setRefinement
(
...
void tnbLib::tetDecomposer::updateMesh(const mapPolyMesh& map)
{
