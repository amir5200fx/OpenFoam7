...
bool tnbLib::combineFaces::convexFace
(
...
bool tnbLib::combineFaces::validFace
(
	const scalar minConcaveCos,
...
void tnbLib::combineFaces::regioniseFaces
(
	const scalar minCos,
...
bool tnbLib::combineFaces::faceNeighboursValid
(
	const label celli,
...
// Construct from mesh
tnbLib::combineFaces::combineFaces
(
	const polyMesh& mesh,
	const bool undoable
)
...
tnbLib::labelListList tnbLib::combineFaces::getMergeSets
(
...
tnbLib::face tnbLib::combineFaces::getOutsideFace
(
...
void tnbLib::combineFaces::setRefinement
(
...
void tnbLib::combineFaces::updateMesh(const mapPolyMesh& map)
{
	if (undoable_)
	{
...
void tnbLib::combineFaces::setUnrefinement
(
