...
void tnbLib::polyMeshGeometry::updateFaceCentresAndAreas
(
	const pointField& p,
...
void tnbLib::polyMeshGeometry::updateCellCentresAndVols
(
...
tnbLib::labelList tnbLib::polyMeshGeometry::affectedCells
(
	const polyMesh& mesh,
	const labelList& changedFaces
)
...
tnbLib::scalar tnbLib::polyMeshGeometry::checkNonOrtho
(
	const polyMesh& mesh,
	const bool report,
...
bool tnbLib::polyMeshGeometry::checkFaceTet
(
	const polyMesh& mesh,
	const bool report,
...
tnbLib::polyMeshGeometry::polyMeshGeometry(const polyMesh& mesh)
	:
	mesh_(mesh)
{
	correct();
...
void tnbLib::polyMeshGeometry::correct()
{
...
bool tnbLib::polyMeshGeometry::checkFaceDotProduct
(
	const bool report,
...
bool tnbLib::polyMeshGeometry::checkFacePyramids
(
	const bool report,
...
bool tnbLib::polyMeshGeometry::checkFaceTets
(
	const bool report,
	const scalar minTetQuality,
	const polyMesh& mesh,
...
bool tnbLib::polyMeshGeometry::checkFaceSkewness
(
	const bool report,
...
bool tnbLib::polyMeshGeometry::checkFaceWeights
(
	const bool report,
...
bool tnbLib::polyMeshGeometry::checkVolRatio
(
	const bool report,
...
bool tnbLib::polyMeshGeometry::checkFaceAngles
(
	const bool report,
	const scalar maxDeg,
	const polyMesh& mesh,
...
)
{
	...
	const scalar maxSin = tnbLib::sin(degToRad(maxDeg));
	...
	if (report)
	{
		if (maxEdgeSin > small)
		{
			scalar maxConcaveDegr =
				radToDeg(tnbLib::asin(tnbLib::min(1.0, maxEdgeSin)));
...
bool tnbLib::polyMeshGeometry::checkFaceTwist
(
	const bool report,
...
bool tnbLib::polyMeshGeometry::checkTriangleTwist
(
	const bool report,
	const scalar minTwist,
	const polyMesh& mesh,
...
bool tnbLib::polyMeshGeometry::checkFaceFlatness
(
	const bool report,
...
bool tnbLib::polyMeshGeometry::checkFaceArea
(
	const bool report,
...
bool tnbLib::polyMeshGeometry::checkCellDeterminant
(
	const bool report,
