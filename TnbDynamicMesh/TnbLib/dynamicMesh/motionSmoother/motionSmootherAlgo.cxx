...
#include <lduSchedule.hxx>  // added by amir
...
void tnbLib::motionSmootherAlgo::testSyncPositions
(
...
void tnbLib::motionSmootherAlgo::checkFld(const pointScalarField& fld)
{
	forAll(fld, pointi)
	{
...
tnbLib::labelHashSet tnbLib::motionSmootherAlgo::getPoints
(
...
tnbLib::tmp<tnbLib::scalarField> tnbLib::motionSmootherAlgo::calcEdgeWeights
(
...
void tnbLib::motionSmootherAlgo::minSmooth
(
...
void tnbLib::motionSmootherAlgo::scaleField
(
...
void tnbLib::motionSmootherAlgo::subtractField
(
	const labelHashSet& pointLabels,
	const scalar f,
	pointScalarField& fld
...
bool tnbLib::motionSmootherAlgo::isInternalPoint(const label pointi) const
{
	return isInternalPoint_.get(pointi) == 1;
}


void tnbLib::motionSmootherAlgo::getAffectedFacesAndPoints
(
...
tnbLib::motionSmootherAlgo::motionSmootherAlgo
(
	polyMesh& mesh,
	pointMesh& pMesh,
...
const tnbLib::polyMesh& tnbLib::motionSmootherAlgo::mesh() const
{
	return mesh_;
}


const tnbLib::pointMesh& tnbLib::motionSmootherAlgo::pMesh() const
{
	return pMesh_;
}


const tnbLib::indirectPrimitivePatch& tnbLib::motionSmootherAlgo::patch() const
{
	return pp_;
}


const tnbLib::labelList& tnbLib::motionSmootherAlgo::adaptPatchIDs() const
{
	return adaptPatchIDs_;
}


const tnbLib::dictionary& tnbLib::motionSmootherAlgo::paramDict() const
{
	return paramDict_;
}


void tnbLib::motionSmootherAlgo::correct()
{
...
void tnbLib::motionSmootherAlgo::setDisplacementPatchFields
(
...
void tnbLib::motionSmootherAlgo::setDisplacement
(
	const labelList& patchIDs,
...
void tnbLib::motionSmootherAlgo::setDisplacement(pointField& patchDisp)
{
...
void tnbLib::motionSmootherAlgo::correctBoundaryConditions
(
	pointVectorField& displacement
) const
{
...
void tnbLib::motionSmootherAlgo::modifyMotionPoints(pointField& newPoints) const
{
...
void tnbLib::motionSmootherAlgo::movePoints()
{
...
tnbLib::scalar tnbLib::motionSmootherAlgo::setErrorReduction
(
...
bool tnbLib::motionSmootherAlgo::scaleMesh
(
...
tnbLib::tmp<tnbLib::pointField> tnbLib::motionSmootherAlgo::curPoints() const
{
	...
	else
	{
		...
		if (debug)
		{
			Pout << "scale_ after smoothing :"
				<< " min:" << tnbLib::gMin(scale_)
				<< " max:" << tnbLib::gMax(scale_)
				<< endl;
		}
...
void tnbLib::motionSmootherAlgo::updateMesh()
{
