...
#include <patchToPoly2DMesh.hxx>

#include <PatchTools.hxx>

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void tnbLib::patchToPoly2DMesh::flipFaceOrder()
{
...
void tnbLib::patchToPoly2DMesh::createNeighbours()
{
    const edgeList& edges = patch_.edges();
...
tnbLib::labelList tnbLib::patchToPoly2DMesh::internalFaceOrder()
{
...
void tnbLib::patchToPoly2DMesh::addPatchFacesToFaces()
{
    const labelList& meshPoints = patch_.meshPoints();
...
void tnbLib::patchToPoly2DMesh::addPatchFacesToOwner()
{
...
void tnbLib::patchToPoly2DMesh::createPolyMeshComponents()
{
    flipFaceOrder();
...
tnbLib::patchToPoly2DMesh::patchToPoly2DMesh
(
...
void tnbLib::patchToPoly2DMesh::createMesh()
{
