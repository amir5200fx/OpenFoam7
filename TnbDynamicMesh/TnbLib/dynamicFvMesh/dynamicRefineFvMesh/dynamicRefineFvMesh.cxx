...
tnbLib::label tnbLib::dynamicRefineFvMesh::count
(
...
void tnbLib::dynamicRefineFvMesh::calculateProtectedCells
(
...
void tnbLib::dynamicRefineFvMesh::readDict()
{
...
tnbLib::autoPtr<tnbLib::mapPolyMesh>
tnbLib::dynamicRefineFvMesh::refine
(
...
tnbLib::autoPtr<tnbLib::mapPolyMesh>
tnbLib::dynamicRefineFvMesh::unrefine
(
...
tnbLib::scalarField
tnbLib::dynamicRefineFvMesh::maxPointField(const scalarField& pFld) const
{
...
tnbLib::scalarField
tnbLib::dynamicRefineFvMesh::maxCellField(const volScalarField& vFld) const
{
...
tnbLib::scalarField
tnbLib::dynamicRefineFvMesh::cellToPoint(const scalarField& vFld) const
{
...
tnbLib::scalarField tnbLib::dynamicRefineFvMesh::error
(
...
void tnbLib::dynamicRefineFvMesh::selectRefineCandidates
(
...
tnbLib::labelList tnbLib::dynamicRefineFvMesh::selectRefineCells
(
...
tnbLib::labelList tnbLib::dynamicRefineFvMesh::selectUnrefinePoints
(
...
void tnbLib::dynamicRefineFvMesh::extendMarkedCells
(
...
void tnbLib::dynamicRefineFvMesh::checkEightAnchorPoints
(
...
tnbLib::dynamicRefineFvMesh::dynamicRefineFvMesh(const IOobject& io)
	:
	dynamicFvMesh(io),
	meshCutter_(*this),
	dumpLevel_(false),
...
tnbLib::dynamicRefineFvMesh::~dynamicRefineFvMesh()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool tnbLib::dynamicRefineFvMesh::update()
{
...
bool tnbLib::dynamicRefineFvMesh::writeObject
(
