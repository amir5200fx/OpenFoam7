...
void tnbLib::fvMeshDistribute::printFieldInfo(const fvMesh& mesh)
{
...
void tnbLib::fvMeshDistribute::saveBoundaryFields
(
...
template<class T, class Mesh>
void tnbLib::fvMeshDistribute::mapBoundaryFields
(
...
template<class T>
void tnbLib::fvMeshDistribute::saveInternalFields
(
...
template<class T>
void tnbLib::fvMeshDistribute::mapExposedFaces
(
	const mapPolyMesh& map,
...
void tnbLib::fvMeshDistribute::initPatchFields
(
...
template<class GeoField>
void tnbLib::fvMeshDistribute::correctBoundaryConditions()
{
...
template<class GeoField>
void tnbLib::fvMeshDistribute::sendFields
(
	const label domain,
...
template<class GeoField>
void tnbLib::fvMeshDistribute::receiveFields
(
	const label domain,
	const wordList& fieldNames,
