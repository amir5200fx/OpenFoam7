#include <hierarchGeomDecomp.hxx>
...
void tnbLib::hierarchGeomDecomp::setDecompOrder()
{
...
tnbLib::label tnbLib::hierarchGeomDecomp::findLower
(
	const List<scalar>& l,
	const scalar t,
	const label initLow,
...
// avoids extra tests.
void tnbLib::hierarchGeomDecomp::calculateSortedWeightedSizes
(
...
void tnbLib::hierarchGeomDecomp::findBinary
(
	const label sizeTol,
...
void tnbLib::hierarchGeomDecomp::sortComponent
(
	const label sizeTol,
...
tnbLib::labelList tnbLib::hierarchGeomDecomp::decompose
(
	const pointField& points
)
{
...
tnbLib::hierarchGeomDecomp::hierarchGeomDecomp
(
