...
void tnbLib::simpleGeomDecomp::assignToProcessorGroup
(
...
tnbLib::labelList tnbLib::simpleGeomDecomp::decomposeOneProc
(
...
tnbLib::simpleGeomDecomp::simpleGeomDecomp(const dictionary& decompositionDict)
	:
...
tnbLib::labelList tnbLib::simpleGeomDecomp::decompose
(
	const pointField& points
)
{
