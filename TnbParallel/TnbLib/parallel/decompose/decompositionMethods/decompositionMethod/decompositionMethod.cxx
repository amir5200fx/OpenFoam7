...
tnbLib::decompositionMethod::decompositionMethod
(
...
tnbLib::autoPtr<tnbLib::decompositionMethod> tnbLib::decompositionMethod::New
(
	const dictionary& decompositionDict
)
{
	Pout << " tnbLib::decompositionMethod::New " << decompositionDict << endl;
...
tnbLib::labelList tnbLib::decompositionMethod::decompose
(
	const polyMesh& mesh,
...
void tnbLib::decompositionMethod::calcCellCells
(
	const polyMesh& mesh,
...
void tnbLib::decompositionMethod::setConstraints
(
	const polyMesh& mesh,
...
void tnbLib::decompositionMethod::applyConstraints
(
	const polyMesh& mesh,
	const boolList& blockedFace,
	const PtrList<labelList>& specifiedProcessorFaces,
