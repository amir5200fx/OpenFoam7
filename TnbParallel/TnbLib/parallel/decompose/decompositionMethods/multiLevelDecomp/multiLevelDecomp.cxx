...
void tnbLib::multiLevelDecomp::subsetGlobalCellCells
(
...
void tnbLib::multiLevelDecomp::decompose
(
...
tnbLib::multiLevelDecomp::multiLevelDecomp(const dictionary& decompositionDict)
	:
...
bool tnbLib::multiLevelDecomp::parallelAware() const
{
	forAll(methods_, i)
	{
...
tnbLib::labelList tnbLib::multiLevelDecomp::decompose
(
	const polyMesh& mesh,
	const pointField& cc,
