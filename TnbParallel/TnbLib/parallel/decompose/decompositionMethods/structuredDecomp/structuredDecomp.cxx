...
tnbLib::structuredDecomp::structuredDecomp(const dictionary& decompositionDict)
	:
...
bool tnbLib::structuredDecomp::parallelAware() const
{
	return method_().parallelAware();
}


tnbLib::labelList tnbLib::structuredDecomp::decompose
(
	const polyMesh& mesh,
	const pointField& cc,
