...
#include <triSurfaceFields.hxx>  // added by amir
...
namespace tnbLib
{
	...
	const char* tnbLib::NamedEnum
		<
		tnbLib::distributedTriSurfaceMesh::distributionType,
		3
		>::names[] =
	{
		"follow",
...
const tnbLib::NamedEnum<tnbLib::distributedTriSurfaceMesh::distributionType, 3>
tnbLib::distributedTriSurfaceMesh::distributionTypeNames_;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

// Read my additional data from the dictionary
bool tnbLib::distributedTriSurfaceMesh::read()
{
...
bool tnbLib::distributedTriSurfaceMesh::isLocal
(
...
void tnbLib::distributedTriSurfaceMesh::distributeSegment
(
	const label segmentI,
	const point& start,
	const point& end,
...
tnbLib::distributedTriSurfaceMesh::distributeSegments
(
...
void tnbLib::distributedTriSurfaceMesh::findLine
(
...
tnbLib::autoPtr<tnbLib::mapDistribute>
tnbLib::distributedTriSurfaceMesh::calcLocalQueries
(
...
tnbLib::label tnbLib::distributedTriSurfaceMesh::calcOverlappingProcs
(
	const point& centre,
...
tnbLib::List<tnbLib::List<tnbLib::treeBoundBox>>
tnbLib::distributedTriSurfaceMesh::independentlyDistributedBbs
(
	const triSurface& s
)
{
	...
	forAll(s, triI)
	{
		...
		forAll(f, fp)
		{
			...
			bbMin = ::tnbLib::min(bbMin, pt);
			bbMax = ::tnbLib::max(bbMax, pt);
		}
	}
...
bool tnbLib::distributedTriSurfaceMesh::overlaps
(
...
void tnbLib::distributedTriSurfaceMesh::subsetMeshMap
(
	const triSurface& s,
...
tnbLib::triSurface tnbLib::distributedTriSurfaceMesh::subsetMesh
(
	const triSurface& s,
...
tnbLib::label tnbLib::distributedTriSurfaceMesh::findTriangle
(
...
// Merge into allSurf.
void tnbLib::distributedTriSurfaceMesh::merge
(
...
tnbLib::distributedTriSurfaceMesh::distributedTriSurfaceMesh
(
	const IOobject& io,
	const triSurface& s,
...
tnbLib::distributedTriSurfaceMesh::distributedTriSurfaceMesh(const IOobject& io)
	:
	triSurfaceMesh
	(
		tnbLib::IOobject
...
void tnbLib::distributedTriSurfaceMesh::clearOut()
{
	globalTris_.clear();
...
const tnbLib::globalIndex& tnbLib::distributedTriSurfaceMesh::globalTris() const
{
...
void tnbLib::distributedTriSurfaceMesh::findNearest
(
...
void tnbLib::distributedTriSurfaceMesh::findLineAny
(
	const pointField& start,
	const pointField& end,
	List<pointIndexHit>& info
...
void tnbLib::distributedTriSurfaceMesh::findLineAll
(
	const pointField& start,
	const pointField& end,
...
void tnbLib::distributedTriSurfaceMesh::getRegion
(
	const List<pointIndexHit>& info,
	labelList& region
) const
...
void tnbLib::distributedTriSurfaceMesh::getNormal
(
	const List<pointIndexHit>& info,
	vectorField& normal
) const
...
void tnbLib::distributedTriSurfaceMesh::getVolumeType
(
...
tnbLib::triSurface tnbLib::distributedTriSurfaceMesh::overlappingSurface
(
	const triSurface& s,
	const List<treeBoundBox>& bbs,
...
void tnbLib::distributedTriSurfaceMesh::distribute
(
	const List<treeBoundBox>& bbs,
...
bool tnbLib::distributedTriSurfaceMesh::writeObject
(
...
void tnbLib::distributedTriSurfaceMesh::writeStats(Ostream& os) const
{
	boundBox bb;
	label nPoints;
