...
void tnbLib::meshToMesh0::mapField
(
	Field<Type>& toF,
...
template<class Type, class CombineOp>
void tnbLib::meshToMesh0::interpolateField
(
	Field<Type>& toF,
...
template<class Type, class CombineOp>
void tnbLib::meshToMesh0::interpolateInternalField
(
	Field<Type>& toF,
	const GeometricField<Type, fvPatchField, volMesh>& fromVf,
...
template<class Type, class CombineOp>
void tnbLib::meshToMesh0::interpolate
(
...
tnbLib::meshToMesh0::interpolate
(
	const GeometricField<Type, fvPatchField, volMesh>& fromVf,
	meshToMesh0::order ord,
	const CombineOp& cop
