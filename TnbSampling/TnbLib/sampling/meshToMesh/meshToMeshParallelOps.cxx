...
tnbLib::label tnbLib::meshToMesh::calcDistribution
(
	const polyMesh& src,
	const polyMesh& tgt
) const
...
tnbLib::label tnbLib::meshToMesh::calcOverlappingProcs
(
...
tnbLib::autoPtr<tnbLib::mapDistribute> tnbLib::meshToMesh::calcProcMap
(
	const polyMesh& src,
	const polyMesh& tgt
) const
...
void tnbLib::meshToMesh::distributeCells
(
...
void tnbLib::meshToMesh::distributeAndMergeCells
(
	const mapDistribute& map,
	const polyMesh& tgt,
	const globalIndex& globalI,
