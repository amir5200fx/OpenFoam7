...
inline tnbLib::MPPICParcel<ParcelType>::trackingData::trackingData
(
...
template<class ParcelType>
template<class TrackCloudType>
inline void tnbLib::MPPICParcel<ParcelType>::trackingData::updateAverages
(
	const TrackCloudType& cloud
)
{
...
template<class ParcelType>
inline typename tnbLib::MPPICParcel<ParcelType>::trackingData::trackPart
tnbLib::MPPICParcel<ParcelType>::trackingData::part() const
{
	return part_;
}
...
template<class ParcelType>
inline typename tnbLib::MPPICParcel<ParcelType>::trackingData::trackPart&
tnbLib::MPPICParcel<ParcelType>::trackingData::part()
{
	return part_;
}
