#include <ReactingLookupTableInjection.hxx>
...
tnbLib::ReactingLookupTableInjection<CloudType>::ReactingLookupTableInjection
(
...
template<class CloudType>
void tnbLib::ReactingLookupTableInjection<CloudType>::updateMesh()
{
	// Set/cache the injector cells
	forAll(injectors_, i)
	{
...
template<class CloudType>
tnbLib::scalar tnbLib::ReactingLookupTableInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
tnbLib::label tnbLib::ReactingLookupTableInjection<CloudType>::parcelsToInject
(
	const scalar time0,
	const scalar time1
)
...
template<class CloudType>
tnbLib::scalar tnbLib::ReactingLookupTableInjection<CloudType>::volumeToInject
(
	const scalar time0,
	const scalar time1
)
...
template<class CloudType>
void tnbLib::ReactingLookupTableInjection<CloudType>::setPositionAndCell
(
	const label parcelI,
...
template<class CloudType>
void tnbLib::ReactingLookupTableInjection<CloudType>::setProperties
(
	const label parcelI,
	const label nParcels,
	const scalar,
...
template<class CloudType>
bool tnbLib::ReactingLookupTableInjection<CloudType>::fullyDescribed() const
{
	return true;
}
...
template<class CloudType>
bool tnbLib::ReactingLookupTableInjection<CloudType>::validInjection(const label)
{
	return true;
}
