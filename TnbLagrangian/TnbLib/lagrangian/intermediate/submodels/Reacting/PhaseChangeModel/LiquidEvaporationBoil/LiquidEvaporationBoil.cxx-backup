#include <LiquidEvaporationBoil.hxx>
...
tnbLib::tmp<tnbLib::scalarField> tnbLib::LiquidEvaporationBoil<CloudType>::calcXc
(
	const label celli
) const
{
...
template<class CloudType>
tnbLib::scalar tnbLib::LiquidEvaporationBoil<CloudType>::Sh
(
	const scalar Re,
	const scalar Sc
) const
...
template<class CloudType>
tnbLib::LiquidEvaporationBoil<CloudType>::LiquidEvaporationBoil
(
...
template<class CloudType>
void tnbLib::LiquidEvaporationBoil<CloudType>::calculate
(
	const scalar dt,
	const label celli,
	const scalar Re,
...
template<class CloudType>
tnbLib::scalar tnbLib::LiquidEvaporationBoil<CloudType>::dh
(
	const label idc,
	const label idl,
	const scalar p,
...
template<class CloudType>
tnbLib::scalar tnbLib::LiquidEvaporationBoil<CloudType>::Tvap
(
	const scalarField& X
) const
{
...
template<class CloudType>
tnbLib::scalar tnbLib::LiquidEvaporationBoil<CloudType>::TMax
(
	const scalar p,
	const scalarField& X
) const
