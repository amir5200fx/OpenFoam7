...
tnbLib::CompositionModel<CloudType>::CompositionModel(CloudType& owner)
	:
...
template<class CloudType>
tnbLib::CompositionModel<CloudType>::CompositionModel
(
...
template<class CloudType>
const tnbLib::SLGThermo& tnbLib::CompositionModel<CloudType>::thermo() const
{
	return thermo_;
}
...
template<class CloudType>
const tnbLib::basicSpecieMixture&
tnbLib::CompositionModel<CloudType>::carrier() const
{
...
template<class CloudType>
const tnbLib::liquidMixtureProperties&
tnbLib::CompositionModel<CloudType>::liquids() const
{
...
template<class CloudType>
const tnbLib::solidMixtureProperties&
tnbLib::CompositionModel<CloudType>::solids() const
{
...
template<class CloudType>
const tnbLib::phasePropertiesList&
tnbLib::CompositionModel<CloudType>::phaseProps() const
{
	return phaseProps_;
}
...
template<class CloudType>
tnbLib::label tnbLib::CompositionModel<CloudType>::nPhase() const
{
...
template<class CloudType>
const tnbLib::wordList& tnbLib::CompositionModel<CloudType>::phaseTypes() const
{
...
template<class CloudType>
const tnbLib::wordList& tnbLib::CompositionModel<CloudType>::stateLabels() const
{
...
tnbLib::CompositionModel<CloudType>::componentNames(const label phasei) const
{
...
template<class CloudType>
tnbLib::label tnbLib::CompositionModel<CloudType>::carrierId
(
	const word& cmptName,
...
template<class CloudType>
tnbLib::label tnbLib::CompositionModel<CloudType>::localId
(
	const label phasei,
	const word& cmptName,
	const bool allowNotFound
...
template<class CloudType>
tnbLib::label tnbLib::CompositionModel<CloudType>::localToCarrierId
(
	const label phasei,
	const label id,
	const bool allowNotFound
...
template<class CloudType>
const tnbLib::scalarField& tnbLib::CompositionModel<CloudType>::Y0
(
	const label phasei
) const
{
...
template<class CloudType>
tnbLib::scalarField tnbLib::CompositionModel<CloudType>::X
(
	const label phasei,
	const scalarField& Y
) const
...
template<class CloudType>
tnbLib::scalar tnbLib::CompositionModel<CloudType>::H
(
	const label phasei,
	const scalarField& Y,
	const scalar p,
...
template<class CloudType>
tnbLib::scalar tnbLib::CompositionModel<CloudType>::Hs
(
	const label phasei,
	const scalarField& Y,
	const scalar p,
...
template<class CloudType>
tnbLib::scalar tnbLib::CompositionModel<CloudType>::Hc
(
	const label phasei,
	const scalarField& Y,
	const scalar p,
...
template<class CloudType>
tnbLib::scalar tnbLib::CompositionModel<CloudType>::Cp
(
	const label phasei,
	const scalarField& Y,
	const scalar p,
...
template<class CloudType>
tnbLib::scalar tnbLib::CompositionModel<CloudType>::L
(
	const label phasei,
	const scalarField& Y,
	const scalar p,
...
#include <CompositionModelNew.cxx>
