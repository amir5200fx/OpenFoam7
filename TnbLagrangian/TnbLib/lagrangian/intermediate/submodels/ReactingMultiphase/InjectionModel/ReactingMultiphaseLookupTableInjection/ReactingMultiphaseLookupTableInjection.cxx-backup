...
tnbLib::ReactingMultiphaseLookupTableInjection<CloudType>::
...
template<class CloudType>
void tnbLib::ReactingMultiphaseLookupTableInjection<CloudType>::updateMesh()
{
	// Set/cache the injector cells
	forAll(injectors_, i)
	{
...
template<class CloudType>
tnbLib::scalar
tnbLib::ReactingMultiphaseLookupTableInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
tnbLib::label
tnbLib::ReactingMultiphaseLookupTableInjection<CloudType>::parcelsToInject
(
	const scalar time0,
	const scalar time1
)
...
template<class CloudType>
tnbLib::scalar
tnbLib::ReactingMultiphaseLookupTableInjection<CloudType>::volumeToInject
(
	const scalar time0,
	const scalar time1
)
...
template<class CloudType>
void tnbLib::ReactingMultiphaseLookupTableInjection<CloudType>::setPositionAndCell
(
	const label parcelI,
...
template<class CloudType>
void tnbLib::ReactingMultiphaseLookupTableInjection<CloudType>::setProperties
(
	const label parcelI,
	const label nParcels,
	const scalar,
...
template<class CloudType>
bool
tnbLib::ReactingMultiphaseLookupTableInjection<CloudType>::fullyDescribed() const
{
	return true;
}
...
template<class CloudType>
bool tnbLib::ReactingMultiphaseLookupTableInjection<CloudType>::validInjection
(
	const label
)
{
