...
void tnbLib::FacePostProcessing<CloudType>::makeLogFile
(
	const word& zoneName,
	const label zoneI,
	const label nFaces,
...
template<class CloudType>
void tnbLib::FacePostProcessing<CloudType>::write()
{
...
template<class CloudType>
tnbLib::FacePostProcessing<CloudType>::FacePostProcessing
(
...
template<class CloudType>
void tnbLib::FacePostProcessing<CloudType>::postFace(const parcelType& p, bool&)
{
	if
		(
