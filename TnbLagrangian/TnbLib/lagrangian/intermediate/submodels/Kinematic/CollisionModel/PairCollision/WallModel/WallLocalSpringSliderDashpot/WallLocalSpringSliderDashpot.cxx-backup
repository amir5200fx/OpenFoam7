#include <WallLocalSpringSliderDashpot.hxx>
...
void tnbLib::WallLocalSpringSliderDashpot<CloudType>::findMinMaxProperties
(
	scalar& rMin,
	scalar& rhoMax,
	scalar& UMagMax
...
template<class CloudType>
void tnbLib::WallLocalSpringSliderDashpot<CloudType>::evaluateWall
(
...
template<class CloudType>
tnbLib::WallLocalSpringSliderDashpot<CloudType>::WallLocalSpringSliderDashpot
(
...
template<class CloudType>
tnbLib::scalar tnbLib::WallLocalSpringSliderDashpot<CloudType>::pREff
(
...
template<class CloudType>
bool tnbLib::WallLocalSpringSliderDashpot<CloudType>::controlsTimestep() const
{
	return true;
}
...
template<class CloudType>
tnbLib::label tnbLib::WallLocalSpringSliderDashpot<CloudType>::nSubCycles() const
{
	if (!(this->owner().size()))
	{
		return 1;
