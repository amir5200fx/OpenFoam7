#include <PairCollision.hxx>

#include <PairModel.hxx>
#include <WallModel.hxx>
...
tnbLib::scalar tnbLib::PairCollision<CloudType>::cosPhiMinFlatWall = 1 - small;

template<class CloudType>
tnbLib::scalar tnbLib::PairCollision<CloudType>::flatWallDuplicateExclusion =
sqrt(3 * small);
...
template<class CloudType>
void tnbLib::PairCollision<CloudType>::preInteraction()
{
...
template<class CloudType>
void tnbLib::PairCollision<CloudType>::parcelInteraction()
{
...
template<class CloudType>
void tnbLib::PairCollision<CloudType>::realRealInteraction()
{
...
template<class CloudType>
void tnbLib::PairCollision<CloudType>::realReferredInteraction()
{
...
template<class CloudType>
void tnbLib::PairCollision<CloudType>::wallInteraction()
{
...
template<class CloudType>
bool tnbLib::PairCollision<CloudType>::duplicatePointInList
(
...
template<class CloudType>
void tnbLib::PairCollision<CloudType>::postInteraction()
{
...
template<class CloudType>
void tnbLib::PairCollision<CloudType>::evaluatePair
(
...
template<class CloudType>
void tnbLib::PairCollision<CloudType>::evaluateWall
(
	typename CloudType::parcelType& p,
...
template<class CloudType>
tnbLib::PairCollision<CloudType>::PairCollision
(
...
template<class CloudType>
tnbLib::label tnbLib::PairCollision<CloudType>::nSubCycles() const
{
	label nSubCycles = 1;
...
template<class CloudType>
void tnbLib::PairCollision<CloudType>::collide()
{
	preInteraction();
