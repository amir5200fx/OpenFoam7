#include <WallSpringSliderDashpot.hxx>

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

template<class CloudType>
void tnbLib::WallSpringSliderDashpot<CloudType>::findMinMaxProperties
(
	scalar& rMin,
	scalar& rhoMax,
	scalar& UMagMax
...
template<class CloudType>
void tnbLib::WallSpringSliderDashpot<CloudType>::evaluateWall
(
...
template<class CloudType>
tnbLib::WallSpringSliderDashpot<CloudType>::WallSpringSliderDashpot
(
...
template<class CloudType>
tnbLib::scalar tnbLib::WallSpringSliderDashpot<CloudType>::pREff
(
...
template<class CloudType>
bool tnbLib::WallSpringSliderDashpot<CloudType>::controlsTimestep() const
{
	return true;
}
...
template<class CloudType>
tnbLib::label tnbLib::WallSpringSliderDashpot<CloudType>::nSubCycles() const
{
	if (!(this->owner().size()))
	{
		return 1;
