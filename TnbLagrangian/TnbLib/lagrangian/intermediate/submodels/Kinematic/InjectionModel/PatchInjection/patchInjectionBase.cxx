...
tnbLib::patchInjectionBase::patchInjectionBase
(
	const polyMesh& mesh,
...
tnbLib::patchInjectionBase::patchInjectionBase(const patchInjectionBase& pib)
	:
...
void tnbLib::patchInjectionBase::updateMesh(const polyMesh& mesh)
{
...
void tnbLib::patchInjectionBase::setPositionAndCell
(
	const fvMesh& mesh,
	Random& rnd,
	vector& position,
