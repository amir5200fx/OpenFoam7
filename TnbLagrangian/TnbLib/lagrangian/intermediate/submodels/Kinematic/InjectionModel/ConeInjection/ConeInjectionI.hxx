...
void tnbLib::ConeInjection<CloudType>::setInjectionMethod()
{
...
template<class CloudType>
void tnbLib::ConeInjection<CloudType>::setFlowType()
{
	const word flowType =
		this->coeffDict().template lookupOrDefault<word>
		(
...
template<class CloudType>
tnbLib::ConeInjection<CloudType>::ConeInjection
(
...
template<class CloudType>
void tnbLib::ConeInjection<CloudType>::updateMesh()
{
...
template<class CloudType>
tnbLib::scalar tnbLib::ConeInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
tnbLib::label tnbLib::ConeInjection<CloudType>::parcelsToInject
(
	const scalar time0,
	const scalar time1
)
...
template<class CloudType>
tnbLib::scalar tnbLib::ConeInjection<CloudType>::volumeToInject
(
	const scalar time0,
	const scalar time1
)
...
template<class CloudType>
void tnbLib::ConeInjection<CloudType>::setPositionAndCell
(
	const label parcelI,
	const label,
	const scalar time,
...
template<class CloudType>
void tnbLib::ConeInjection<CloudType>::setProperties
(
	const label parcelI,
	const label,
	const scalar time,
...
template<class CloudType>
bool tnbLib::ConeInjection<CloudType>::fullyDescribed() const
{
	return false;
}
...
template<class CloudType>
bool tnbLib::ConeInjection<CloudType>::validInjection(const label)
{
	return true;
}
