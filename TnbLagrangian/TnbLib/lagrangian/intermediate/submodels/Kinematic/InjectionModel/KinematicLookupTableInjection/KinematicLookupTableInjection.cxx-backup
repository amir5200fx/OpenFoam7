#include <KinematicLookupTableInjection.hxx>
...
tnbLib::KinematicLookupTableInjection<CloudType>::KinematicLookupTableInjection
(
...
template<class CloudType>
void tnbLib::KinematicLookupTableInjection<CloudType>::updateMesh()
{
	// Set/cache the injector cells
	forAll(injectors_, i)
	{
...
template<class CloudType>
tnbLib::scalar tnbLib::KinematicLookupTableInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
tnbLib::label tnbLib::KinematicLookupTableInjection<CloudType>::parcelsToInject
(
	const scalar time0,
	const scalar time1
)
...
template<class CloudType>
tnbLib::scalar tnbLib::KinematicLookupTableInjection<CloudType>::volumeToInject
(
	const scalar time0,
	const scalar time1
)
...
template<class CloudType>
void tnbLib::KinematicLookupTableInjection<CloudType>::setPositionAndCell
(
	const label parcelI,
...
template<class CloudType>
void tnbLib::KinematicLookupTableInjection<CloudType>::setProperties
(
	const label parcelI,
	const label nParcels,
	const scalar,
...
template<class CloudType>
bool tnbLib::KinematicLookupTableInjection<CloudType>::fullyDescribed() const
{
	return true;
}
...
template<class CloudType>
bool tnbLib::KinematicLookupTableInjection<CloudType>::validInjection
(
	const label
)
{
