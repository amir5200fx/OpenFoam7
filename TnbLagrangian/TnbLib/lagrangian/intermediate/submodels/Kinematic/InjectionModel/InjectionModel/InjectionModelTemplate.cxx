...
bool tnbLib::InjectionModel<CloudType>::prepareForNextTimeStep
(
	const scalar time,
	label& newParcels,
...
template<class CloudType>
bool tnbLib::InjectionModel<CloudType>::findCellAtPosition
(
	label& celli,
	label& tetFacei,
	label& tetPti,
...
template<class CloudType>
tnbLib::scalar tnbLib::InjectionModel<CloudType>::setNumberOfParticles
(
	const label parcels,
...
template<class CloudType>
void tnbLib::InjectionModel<CloudType>::postInjectCheck
(
...
template<class CloudType>
tnbLib::InjectionModel<CloudType>::InjectionModel(CloudType& owner)
	:
...
template<class CloudType>
tnbLib::InjectionModel<CloudType>::InjectionModel
(
...
template<class CloudType>
void tnbLib::InjectionModel<CloudType>::updateMesh()
{}


template<class CloudType>
tnbLib::scalar tnbLib::InjectionModel<CloudType>::averageParcelMass()
{
	label nTotal = 0.0;
...
void tnbLib::InjectionModel<CloudType>::inject
(
...
template<class CloudType>
template<class TrackCloudType>
void tnbLib::InjectionModel<CloudType>::injectSteadyState
(
	TrackCloudType& cloud,
	typename CloudType::parcelType::trackingData& td,
...
template<class CloudType>
void tnbLib::InjectionModel<CloudType>::info(Ostream& os)
{
