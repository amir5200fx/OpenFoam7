...
tnbLib::InflationInjection<CloudType>::InflationInjection
(
...
tnbLib::InflationInjection<CloudType>::InflationInjection
(
	const tnbLib::InflationInjection<CloudType>& im
)
	:
...
template<class CloudType>
void tnbLib::InflationInjection<CloudType>::updateMesh()
{}


template<class CloudType>
tnbLib::scalar tnbLib::InflationInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
tnbLib::label tnbLib::InflationInjection<CloudType>::parcelsToInject
(
	const scalar time0,
	const scalar time1
)
...
template<class CloudType>
tnbLib::scalar tnbLib::InflationInjection<CloudType>::volumeToInject
(
	const scalar time0,
	const scalar time1
)
...
template<class CloudType>
void tnbLib::InflationInjection<CloudType>::setPositionAndCell
(
	const label parcelI,
	const label,
	const scalar,
...
template<class CloudType>
void tnbLib::InflationInjection<CloudType>::setProperties
(
	const label parcelI,
	const label,
	const scalar,
...
template<class CloudType>
bool tnbLib::InflationInjection<CloudType>::fullyDescribed() const
{
	return false;
}
...
template<class CloudType>
bool tnbLib::InflationInjection<CloudType>::validInjection(const label)
{
	return true;
}
