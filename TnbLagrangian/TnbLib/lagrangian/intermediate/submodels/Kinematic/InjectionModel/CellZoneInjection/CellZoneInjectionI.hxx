...
void tnbLib::CellZoneInjection<CloudType>::setPositions
(
...
template<class CloudType>
tnbLib::CellZoneInjection<CloudType>::CellZoneInjection
(
...
template<class CloudType>
void tnbLib::CellZoneInjection<CloudType>::updateMesh()
{
...
template<class CloudType>
tnbLib::scalar tnbLib::CellZoneInjection<CloudType>::timeEnd() const
{
	// Not used
	return this->SOI_;
}
...
template<class CloudType>
tnbLib::label tnbLib::CellZoneInjection<CloudType>::parcelsToInject
(
	const scalar time0,
	const scalar time1
)
...
template<class CloudType>
tnbLib::scalar tnbLib::CellZoneInjection<CloudType>::volumeToInject
(
	const scalar time0,
	const scalar time1
)
...
template<class CloudType>
void tnbLib::CellZoneInjection<CloudType>::setPositionAndCell
(
	const label parcelI,
...
template<class CloudType>
void tnbLib::CellZoneInjection<CloudType>::setProperties
(
	const label parcelI,
	const label,
	const scalar,
...
template<class CloudType>
bool tnbLib::CellZoneInjection<CloudType>::fullyDescribed() const
{
	return false;
}
...
template<class CloudType>
bool tnbLib::CellZoneInjection<CloudType>::validInjection(const label)
{
	return true;
}
