...
#include <wallPolyPatch.hxx>  // added by amir
...
void tnbLib::InteractionLists<ParticleType>::buildInteractionLists()
{
...
template<class ParticleType>
void tnbLib::InteractionLists<ParticleType>::findExtendedProcBbsInRange
(
...
template<class ParticleType>
void tnbLib::InteractionLists<ParticleType>::buildMap
(
...
template<class ParticleType>
void tnbLib::InteractionLists<ParticleType>::prepareParticlesToRefer
(
...
template<class ParticleType>
void tnbLib::InteractionLists<ParticleType>::prepareParticleToBeReferred
(
...
template<class ParticleType>
void tnbLib::InteractionLists<ParticleType>::fillReferredParticleCloud()
{
	if (writeCloud_)
	{
...
template<class ParticleType>
void tnbLib::InteractionLists<ParticleType>::prepareWallDataToRefer()
{
	const globalIndexAndTransform& globalTransforms =
		mesh_.globalData().globalTransforms();
...
template<class ParticleType>
void tnbLib::InteractionLists<ParticleType>::writeReferredWallFaces() const
{
...
template<class ParticleType>
tnbLib::InteractionLists<ParticleType>::InteractionLists(const polyMesh& mesh)
	:
	mesh_(mesh),
...
template<class ParticleType>
tnbLib::InteractionLists<ParticleType>::InteractionLists
(
	const polyMesh& mesh,
	scalar maxDistance,
	Switch writeCloud,
...
template<class ParticleType>
void tnbLib::InteractionLists<ParticleType>::sendReferredData
(
	const List<DynamicList<ParticleType*>>& cellOccupancy,
...
template<class ParticleType>
void tnbLib::InteractionLists<ParticleType>::receiveReferredData
(
	PstreamBuffers& pBufs,
