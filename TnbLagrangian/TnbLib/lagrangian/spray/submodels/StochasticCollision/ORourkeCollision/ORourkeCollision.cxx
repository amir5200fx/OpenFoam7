...
void tnbLib::ORourkeCollision<CloudType>::collide
(
...
template<class CloudType>
bool tnbLib::ORourkeCollision<CloudType>::collideParcels
(
	const scalar dt,
	parcelType& p1,
	parcelType& p2,
...
template<class CloudType>
bool tnbLib::ORourkeCollision<CloudType>::collideSorted
(
	const scalar dt,
	parcelType& p1,
	parcelType& p2,
...
template<class CloudType>
tnbLib::ORourkeCollision<CloudType>::ORourkeCollision
(
