...
#include <forceSuSp.hxx>  // added by amir

// * * * * * * * * * * *  Protected Member Functions * * * * * * * * * * * * //

template<class ParcelType>
template<class TrackCloudType>
void tnbLib::SprayParcel<ParcelType>::setCellValues
(
...
template<class ParcelType>
template<class TrackCloudType>
void tnbLib::SprayParcel<ParcelType>::cellValueSourceCorrection
(
	TrackCloudType& cloud,
	trackingData& td,
	const scalar dt
...
template<class ParcelType>
template<class TrackCloudType>
void tnbLib::SprayParcel<ParcelType>::calc
(
	TrackCloudType& cloud,
	trackingData& td,
	const scalar dt
...
template<class ParcelType>
template<class TrackCloudType>
void tnbLib::SprayParcel<ParcelType>::calcAtomization
(
	TrackCloudType& cloud,
	trackingData& td,
	const scalar dt
...
template<class ParcelType>
template<class TrackCloudType>
void tnbLib::SprayParcel<ParcelType>::calcBreakup
(
	TrackCloudType& cloud,
	trackingData& td,
	const scalar dt
...
template<class ParcelType>
template<class TrackCloudType>
tnbLib::scalar tnbLib::SprayParcel<ParcelType>::chi
(
	TrackCloudType& cloud,
	trackingData& td,
	const scalarField& X
...
template<class ParcelType>
template<class TrackCloudType>
void tnbLib::SprayParcel<ParcelType>::solveTABEq
(
	TrackCloudType& cloud,
	trackingData& td,
	const scalar dt
...
template<class ParcelType>
tnbLib::SprayParcel<ParcelType>::SprayParcel(const SprayParcel<ParcelType>& p)
	:
	ParcelType(p),
	d0_(p.d0_),
...
template<class ParcelType>
tnbLib::SprayParcel<ParcelType>::SprayParcel
(
