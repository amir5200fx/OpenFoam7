...
const std::size_t tnbLib::molecule::sizeofFields_
(
	...
	sitePositions_(0)
{
	...
	(
		"tnbLib::molecule::molecule"
		"(const Cloud<molecule>& cloud, tnbLib::Istream&), bool"
	);
}


void tnbLib::molecule::readFields(Cloud<molecule>& mC)
{
	bool write = mC.size();
...
void tnbLib::molecule::writeFields(const Cloud<molecule>& mC)
{
...
tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const molecule& mol)
{
	...
	(
		...
		"(tnbLib::Ostream&, const tnbLib::molecule&)"
	);
