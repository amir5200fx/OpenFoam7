...
void tnbLib::potential::setSiteIdList(const dictionary& moleculePropertiesDict)
{
...
void tnbLib::potential::potential::readPotentialDict()
{
...
void tnbLib::potential::potential::readMdInitialiseDict
(
...
tnbLib::potential::potential(const polyMesh& mesh)
	:
	mesh_(mesh)
{
	readPotentialDict();
