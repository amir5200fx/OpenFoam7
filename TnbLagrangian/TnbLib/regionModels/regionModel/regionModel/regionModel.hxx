#pragma once
#ifndef _regionModel_Header
#define _regionModel_Header
...
Class
	tnbLib::regionModels::regionModel
...
namespace tnbLib
{
	...
	namespace regionModels
	{
		...
		public:
			...
			template<class Type>
			tmp<tnbLib::Field<Type>> mapRegionPatchField
			(
				const regionModel& nbrRegion,
				const label regionPatchi,
				const label nbrPatchi,
...
#include <regionModelI.hxx>
#include <regionModelTemplatesI.hxx>

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

//#ifdef NoRepository
//#include <regionModelTemplates.cxx>
//#endif

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

#endif // !_regionModel_Header
