...
#include <fixedValueFvPatchField.hxx>  // added by amir

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class CloudType>
tnbLib::PackingModels::Implicit<CloudType>::Implicit
(
...
template<class CloudType>
void tnbLib::PackingModels::Implicit<CloudType>::cacheFields(const bool store)
{
...
template<class CloudType>
tnbLib::vector tnbLib::PackingModels::Implicit<CloudType>::velocityCorrection
(
