...
tnbLib::LISAAtomization<CloudType>::LISAAtomization
(
...
template<class CloudType>
tnbLib::scalar tnbLib::LISAAtomization<CloudType>::initLiquidCore() const
{
	return 1.0;
}
...
template<class CloudType>
bool tnbLib::LISAAtomization<CloudType>::calcChi() const
{
	return true;
}
...
template<class CloudType>
void tnbLib::LISAAtomization<CloudType>::update
(
	const scalar dt,
	scalar& d,
	scalar& liquidCore,
...
) const
{
	...
	if (pWalk > lBU)
	{
		...
		case method1:
		{
#include <LISASMDCalcMethod1.lxx>
			break;
		}
		case method2:
		{
#include <LISASMDCalcMethod2.lxx>
			break;
		}
		}
