...
template<class CloudType>
tnbLib::TAB<CloudType>::TAB(const TAB<CloudType>& bum)
	:
...
template<class CloudType>
bool tnbLib::TAB<CloudType>::update
(
	const scalar dt,
	const vector& g,
	scalar& d,
	...
	if (omega2 > 0)
	{
		...
		if (a + Wetmp > 1.0)
		{
			...
			if (dt > tb)
			{
				...
				case method1:
				{
#include <TABSMDCalcMethod1.lxx>
					break;
				}
				case method2:
				{
#include <TABSMDCalcMethod2.lxx>
					break;
				}
				}
