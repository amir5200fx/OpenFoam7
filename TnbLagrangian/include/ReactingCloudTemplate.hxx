#pragma once
#ifndef _ReactingCloud_Header
#define _ReactingCloud_Header
...
namespace tnbLib
{
	...
	class DimensionedField;  // added by amir

	class SLGThermo;  // added by amir
