...
inline const tnbLib::ReactingCloud<CloudType>&
tnbLib::ReactingCloud<CloudType>::cloudCopy() const
{
...
tnbLib::ReactingCloud<CloudType>::constProps() const
{
	return constProps_;
}
...
tnbLib::ReactingCloud<CloudType>::constProps()
{
	return constProps_;
}
...
template<class CloudType>
inline const tnbLib::CompositionModel<tnbLib::ReactingCloud<CloudType>>&
tnbLib::ReactingCloud<CloudType>::composition() const
{
...
template<class CloudType>
inline const tnbLib::PhaseChangeModel<tnbLib::ReactingCloud<CloudType>>&
tnbLib::ReactingCloud<CloudType>::phaseChange() const
{
...
template<class CloudType>
inline tnbLib::PhaseChangeModel<tnbLib::ReactingCloud<CloudType>>&
tnbLib::ReactingCloud<CloudType>::phaseChange()
{
	return phaseChangeModel_();
}
...
tnbLib::ReactingCloud<CloudType>::rhoTrans(const label i)
{
	return rhoTrans_[i];
}
...
template<class CloudType>
inline
const tnbLib::PtrList<tnbLib::DimensionedField<tnbLib::scalar, tnbLib::volMesh>>&
tnbLib::ReactingCloud<CloudType>::rhoTrans() const
{
	return rhoTrans_;
}
...
tnbLib::ReactingCloud<CloudType>::rhoTrans()
{
	return rhoTrans_;
}
...
template<class CloudType>
inline tnbLib::tmp<tnbLib::fvScalarMatrix> tnbLib::ReactingCloud<CloudType>::SYi
(
	const label i,
	volScalarField& Yi
) const
...
tnbLib::ReactingCloud<CloudType>::Srho(const label i) const
{
...
template<class CloudType>
inline tnbLib::tmp<tnbLib::DimensionedField<tnbLib::scalar, tnbLib::volMesh>>
tnbLib::ReactingCloud<CloudType>::Srho() const
{
...
tnbLib::ReactingCloud<CloudType>::Srho(volScalarField& rho) const
{
	if (this->solution().coupled())
	{
		tmp<volScalarField> trhoTrans
