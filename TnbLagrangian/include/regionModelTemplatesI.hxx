...
tnbLib::regionModels::regionModel::mapRegionPatchField
(
...
template<class Type>
tnbLib::tmp<tnbLib::Field<Type>>
tnbLib::regionModels::regionModel::mapRegionPatchInternalField
(
	const regionModel& nbrRegion,
	const word& fieldName,
	const label regionPatchi,
...
template<class Type>
void tnbLib::regionModels::regionModel::toPrimary
(
	const label regionPatchi,
...
template<class Type>
void tnbLib::regionModels::regionModel::toRegion
(
	const label regionPatchi,
