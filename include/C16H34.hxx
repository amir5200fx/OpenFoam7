#pragma once
#ifndef _C16H34_Header
#define _C16H34_Header
...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("C16H34");
		static const char* typeName_() { return "C16H34"; }
		...
		// Constructors
			...
			//- Construct null
		FoamThermophysicalModels_EXPORT C16H34();
		...
		FoamThermophysicalModels_EXPORT C16H34(const dictionary& dict);
		...
		//- Ostream Operator
		friend FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C16H34& l);
	};


	FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C16H34& l);
