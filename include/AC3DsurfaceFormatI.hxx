...
template<class Face>
tnbLib::fileFormats::AC3DsurfaceFormat<Face>::AC3DsurfaceFormat
(
...
template<class Face>
bool tnbLib::fileFormats::AC3DsurfaceFormat<Face>::read
(
	const fileName& filename
)
{
	...
	{
		names[zoneI] = word("zone") + tnbLib::name(zoneI);
...
template<class Face>
void tnbLib::fileFormats::AC3DsurfaceFormat<Face>::write
(
	const fileName& filename,
