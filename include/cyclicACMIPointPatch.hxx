#pragma once
#ifndef _cyclicACMIPointPatch_Header
#define _cyclicACMIPointPatch_Header
...
namespace tnbLib
{
	...
	public:
		...
		FoamFvMesh_EXPORT cyclicACMIPointPatch
		(
		...
		//- Destructor
		FoamFvMesh_EXPORT virtual ~cyclicACMIPointPatch();
	};
...
#endif // !_cyclicACMIPointPatch_Header
