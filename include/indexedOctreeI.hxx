...
template<class Type>
tnbLib::volumeType tnbLib::indexedOctree<Type>::calcVolumeType
(
	const label nodeI
) const
{
...
template<class Type>
tnbLib::volumeType tnbLib::indexedOctree<Type>::getVolumeType
(
	const label nodeI,
	const point& sample
) const
...
template<class Type>
tnbLib::volumeType tnbLib::indexedOctree<Type>::getSide
(
...
template<class Type>
void tnbLib::indexedOctree<Type>::findSphere
(
	const label nodeI,
	const point& centre,
...
void tnbLib::indexedOctree<Type>::findNear
(
...
template<class Type>
tnbLib::labelList tnbLib::indexedOctree<Type>::findSphere
(
	const point& centre,
	const scalar radiusSqr
) const
...
template<class Type>
tnbLib::label tnbLib::indexedOctree<Type>::findInside(const point& sample) const
{
...
template<class Type>
const tnbLib::labelList& tnbLib::indexedOctree<Type>::findIndices
(
	const point& sample
) const
{
