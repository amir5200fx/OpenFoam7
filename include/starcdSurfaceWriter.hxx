#pragma once
#ifndef _starcdSurfaceWriter_Header
#define _starcdSurfaceWriter_Header
...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("starcd");
		static const char* typeName_() { return "starcd"; }
		...
		// Constructors
			...
			//- Construct null
		FoamConversion_EXPORT starcdSurfaceWriter();


		//- Destructor
		FoamConversion_EXPORT virtual ~starcdSurfaceWriter();
...
#endif // !_starcdSurfaceWriter_Header
