		...
		if (UPstream::parRun() && UPstream::nProcs(comm) > 1)
		{
			...
			forAll(myComm.below(), belowI)
			{
				...
				else
				{
					...
					//readFromIPstream(myComm.below()[belowI], 0, tag, comm, Value);
				}
		...
		if (UPstream::parRun() && UPstream::nProcs(comm) > 1)
		{
			...
			if (myComm.above() != -1)
			{
				...
				else
				{
					...
					//readFromIPstream(myComm.above(), 0, tag, comm, Value);
				}
			}
			...
			forAllReverse(myComm.below(), belowI)
			{
				...
				else
				{
					...
					//writeToOPstream(myComm.below()[belowI], 0, tag, comm, Value);
				}
			}
		}
	}
