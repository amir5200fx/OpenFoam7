...
#include <globalIndex.hxx>  // added by amir

// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

template<class CloudType>
inline const tnbLib::SprayCloud<CloudType>&
tnbLib::SprayCloud<CloudType>::cloudCopy() const
{
...
template<class CloudType>
inline const tnbLib::AtomizationModel<tnbLib::SprayCloud<CloudType>>&
tnbLib::SprayCloud<CloudType>::atomization() const
{
...
template<class CloudType>
inline tnbLib::AtomizationModel<tnbLib::SprayCloud<CloudType>>&
tnbLib::SprayCloud<CloudType>::atomization()
{
	return atomizationModel_();
}
...
template<class CloudType>
inline const tnbLib::BreakupModel<tnbLib::SprayCloud<CloudType>>&
tnbLib::SprayCloud<CloudType>::breakup() const
{
...
template<class CloudType>
inline tnbLib::BreakupModel<tnbLib::SprayCloud<CloudType>>&
tnbLib::SprayCloud<CloudType>::breakup()
{
	return breakupModel_();
}
...
template<class CloudType>
inline tnbLib::scalar tnbLib::SprayCloud<CloudType>::averageParcelMass() const
{
...
template<class CloudType>
inline tnbLib::scalar tnbLib::SprayCloud<CloudType>::penetration
(
