	...
	namespace RBD
	{
		namespace joints
		{
			...
			public:
				...
				/*TypeName("Ra");*/
				static const char* typeName_() { return "Ra"; }
				...
				FoamRigidBodyMotion_EXPORT Ra(const rigidBodyModel& model, const vector& axis);

				//- Construct for given model from dictionary
				FoamRigidBodyMotion_EXPORT Ra(const rigidBodyModel& model, const dictionary& dict);
				...
				//- Destructor
				FoamRigidBodyMotion_EXPORT virtual ~Ra();
