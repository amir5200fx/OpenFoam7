#pragma once
#ifndef _rodas34_Header
#define _rodas34_Header
...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("rodas34");
		static const char* typeName_() { return "rodas34"; }
		...
		FoamODE_EXPORT rodas34(const ODESystem& ode, const dictionary& dict);
