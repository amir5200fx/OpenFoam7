...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("N2");
		static const char* typeName_() { return "N2"; }
		...
		// Constructors
			...
			//- Construct null
		FoamThermophysicalModels_EXPORT N2();
		...
		FoamThermophysicalModels_EXPORT N2(const dictionary& dict);
		...
		//- Ostream Operator
		friend FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const N2& l);
	};


	FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const N2& l);
