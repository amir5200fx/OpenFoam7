#pragma once
#ifndef _C10H22_Header
#define _C10H22_Header
...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("C10H22");
		static const char* typeName_() { return "C10H22"; }
		...
		// Constructors
			...
			//- Construct null
		FoamThermophysicalModels_EXPORT C10H22();
		...
		FoamThermophysicalModels_EXPORT C10H22(const dictionary& dict);
		...
		//- Ostream Operator
		friend FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C10H22& l);
	};


	FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C10H22& l);
