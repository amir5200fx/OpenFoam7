...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("NSRDSfunc3");
		static const char* typeName_() { return "NSRDSfunc3"; }
		...
		FoamThermophysicalModels_EXPORT NSRDSfunc3
		(
			const scalar a,
			const scalar b,
			const scalar c,
		...
		FoamThermophysicalModels_EXPORT NSRDSfunc3(const dictionary& dict);
