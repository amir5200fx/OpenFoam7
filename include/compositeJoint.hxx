#pragma once
#ifndef _compositeJoint_Header
#define _compositeJoint_Header
	...
	namespace RBD
	{
		...
		namespace joints
		{
				...
				public joint
			{
				...
				FoamRigidBodyMotion_EXPORT void setLastJoint();
			...
			public:
				...
				//TypeName("composite");
				static const char* typeName_() { return "composite"; }
				...
				friend class tnbLib::RBD::rigidBodyModel;


				// Constructors

					//- Construct for given PtrList<joint>
				FoamRigidBodyMotion_EXPORT composite(const PtrList<joint>& joints);

				//- Construct for given model from dictionary
				FoamRigidBodyMotion_EXPORT composite(const rigidBodyModel& model, const dictionary& dict);
				...
				//- Destructor
				FoamRigidBodyMotion_EXPORT virtual ~composite();
