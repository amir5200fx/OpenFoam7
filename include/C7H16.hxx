#pragma once
#ifndef _C7H16_Header
#define _C7H16_Header
...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("C7H16");
		static const char* typeName_() { return "C7H16"; }
		...
		// Constructors
			...
			//- Construct null
		FoamThermophysicalModels_EXPORT C7H16();
		...
		FoamThermophysicalModels_EXPORT C7H16(const dictionary& dict);
		...
		//- Ostream Operator
		friend FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C7H16& l);
	};


	FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C7H16& l);
