...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("NSRDSfunc1");
		static const char* typeName_() { return "NSRDSfunc1"; }
		...
		FoamThermophysicalModels_EXPORT NSRDSfunc1
		(
			const scalar a,
			const scalar b,
			const scalar c,
		...
		FoamThermophysicalModels_EXPORT NSRDSfunc1(const dictionary& dict);
