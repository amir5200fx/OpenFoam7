...
template<class Type>
tnbLib::sampledSets::volFieldSampler<Type>::volFieldSampler
(
...
template<class Type>
void tnbLib::sampledSets::writeSampleFile
(
...
template<class T>
void tnbLib::sampledSets::combineSampledValues
(
...
template<class Type>
void tnbLib::sampledSets::sampleAndWrite
(
