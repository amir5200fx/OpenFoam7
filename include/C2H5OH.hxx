#pragma once
#ifndef _C2H5OH_Header
#define _C2H5OH_Header
...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("C2H5OH");
		static const char* typeName_() { return "C2H5OH"; }
		...
		// Constructors
			...
			//- Construct null
		FoamThermophysicalModels_EXPORT C2H5OH();
		...
		FoamThermophysicalModels_EXPORT C2H5OH(const dictionary& dict);
		...
		//- Ostream Operator
		friend FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C2H5OH& l);
	};


	FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C2H5OH& l);
