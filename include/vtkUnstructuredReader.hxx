#pragma once
#ifndef _vtkUnstructuredReader_Header
#define _vtkUnstructuredReader_Header
...
Class
	tnbLib::vtkUnstructuredReader

Description
	Reader for vtk unstructured_grid legacy files. Supports single CELLS, POINTS
	etc. entry only.

	- all integer types (int, unsigned_int, long etc.) become tnbLib::label
	- all real types (float, double) become tnbLib::scalar
...
#endif // !_vtkUnstructuredReader_Header
