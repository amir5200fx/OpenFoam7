...
tnbLib::SurfaceFilmModel<CloudType>::SurfaceFilmModel(CloudType& owner)
	:
...
template<class CloudType>
tnbLib::SurfaceFilmModel<CloudType>::SurfaceFilmModel
(
...
void tnbLib::SurfaceFilmModel<CloudType>::inject(TrackCloudType& cloud)
{
	if (!this->active())
	{
		return;
...
template<class CloudType>
void tnbLib::SurfaceFilmModel<CloudType>::cacheFilmFields
(
...
template<class CloudType>
void tnbLib::SurfaceFilmModel<CloudType>::setParcelProperties
(
	parcelType& p,
...
template<class CloudType>
void tnbLib::SurfaceFilmModel<CloudType>::info(Ostream& os)
{
	label nTrans0 =
