...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("C6H6");
		static const char* typeName_() { return "C6H6"; }
		...
		// Constructors
			...
			//- Construct null
		FoamThermophysicalModels_EXPORT C6H6();
		...
		FoamThermophysicalModels_EXPORT C6H6(const dictionary& dict);
		...
		//- Ostream Operator
		friend FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C6H6& l);
	};


	FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C6H6& l);
