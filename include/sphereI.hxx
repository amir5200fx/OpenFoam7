...
inline tnbLib::symmTensor tnbLib::RBD::sphere::I
(
	const scalar m,
	const scalar r
) const
{
	return ((2.0 / 5.0)*m*sqr(r))*tnbLib::I;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

inline tnbLib::RBD::sphere::sphere
(
	const word& name,
	const scalar m,
	const vector& c,
...
inline tnbLib::scalar tnbLib::RBD::sphere::r() const
{
	return r_;
}
