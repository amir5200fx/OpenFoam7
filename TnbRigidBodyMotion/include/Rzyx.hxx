	...
	namespace RBD
	{
		namespace joints
		{
			...
			public:
				...
				/*TypeName("Rzyx");*/
				static const char* typeName_() { return "Rzyx"; }
				...
				FoamRigidBodyMotion_EXPORT Rzyx(const rigidBodyModel& model);

				//- Construct for given model from dictionary
				FoamRigidBodyMotion_EXPORT Rzyx(const rigidBodyModel& model, const dictionary& dict);
				...
				//- Destructor
				FoamRigidBodyMotion_EXPORT virtual ~Rzyx();
