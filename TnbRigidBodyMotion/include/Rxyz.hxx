	...
	namespace RBD
	{
		namespace joints
		{
			...
			public:
				...
				/*TypeName("Rxyz");*/
				static const char* typeName_() { return "Rxyz"; }
				...
				FoamRigidBodyMotion_EXPORT Rxyz(const rigidBodyModel& model);

				//- Construct for given model from dictionary
				FoamRigidBodyMotion_EXPORT Rxyz(const rigidBodyModel& model, const dictionary& dict);
				...
				//- Destructor
				FoamRigidBodyMotion_EXPORT virtual ~Rxyz();
