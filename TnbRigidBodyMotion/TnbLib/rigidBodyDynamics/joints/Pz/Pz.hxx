	...
	namespace RBD
	{
		namespace joints
		{
			...
			public:
				...
				/*TypeName("Pz");*/
				static const char* typeName_() { return "Pz"; }
				...
				FoamRigidBodyMotion_EXPORT Pz(const rigidBodyModel& model);

				//- Construct for given model from dictionary
				FoamRigidBodyMotion_EXPORT Pz(const rigidBodyModel& model, const dictionary& dict);
				...
				//- Destructor
				FoamRigidBodyMotion_EXPORT virtual ~Pz();
