	...
	namespace RBD
	{
		namespace joints
		{
			...
			public:
				...
				/*TypeName("Pa");*/
				static const char* typeName_() { return "Pa"; }
				...
				FoamRigidBodyMotion_EXPORT Pa(const rigidBodyModel& model, const vector& axis);

				//- Construct for given model from dictionary
				FoamRigidBodyMotion_EXPORT Pa(const rigidBodyModel& model, const dictionary& dict);
				...
				//- Destructor
				FoamRigidBodyMotion_EXPORT virtual ~Pa();
