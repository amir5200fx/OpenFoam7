	...
	namespace RBD
	{
		namespace joints
		{
			...
			public:
				...
				/*TypeName("Ry");*/
				static const char* typeName_() { return "Ry"; }
				...
				FoamRigidBodyMotion_EXPORT Ry(const rigidBodyModel& model);

				//- Construct for given model from dictionary
				FoamRigidBodyMotion_EXPORT Ry(const rigidBodyModel& model, const dictionary& dict);
				...
				//- Destructor
				FoamRigidBodyMotion_EXPORT virtual ~Ry();
