...
tnbLib::label tnbLib::cellClassification::count
(
...
// faces are pierced.
tnbLib::boolList tnbLib::cellClassification::markFaces
(
...
// 'outside'
void tnbLib::cellClassification::markCells
(
...
void tnbLib::cellClassification::classifyPoints
(
...
bool tnbLib::cellClassification::usesMixedPointsOnly
(
...
void tnbLib::cellClassification::getMeshOutside
(
	const label meshType,
...
tnbLib::cellClassification::cellClassification
(
	const polyMesh& mesh,
...
// Copy constructor
tnbLib::cellClassification::cellClassification(const cellClassification& cType)
	:
	labelList(cType),
	mesh_(cType.mesh())
{}
...
tnbLib::label tnbLib::cellClassification::trimCutCells
(
	const label nLayers,
	const label meshType,
...
tnbLib::label tnbLib::cellClassification::growSurface
(
	const label meshType,
	const label fillType
)
...
// onto the surface.
tnbLib::label tnbLib::cellClassification::fillHangingCells
(
	const label meshType,
	const label fillType,
	const label maxIter
...
tnbLib::label tnbLib::cellClassification::fillRegionEdges
(
	const label meshType,
	const label fillType,
	const label maxIter
...
tnbLib::label tnbLib::cellClassification::fillRegionPoints
(
	const label meshType,
	const label fillType,
	const label maxIter
...
void tnbLib::cellClassification::writeStats(Ostream& os) const
{
	os << "Cells:" << size() << endl
...
void tnbLib::cellClassification::operator=(const tnbLib::cellClassification& rhs)
{
