#include <searchableExtrudedCircle.hxx>
...
tnbLib::searchableExtrudedCircle::searchableExtrudedCircle
(
	const IOobject& io,
...
const tnbLib::wordList& tnbLib::searchableExtrudedCircle::regions() const
{
	if (regions_.empty())
	{
		regions_.setSize(1);
...
tnbLib::label tnbLib::searchableExtrudedCircle::size() const
{
	return eMeshPtr_().points().size();
}


tnbLib::tmp<tnbLib::pointField> tnbLib::searchableExtrudedCircle::coordinates() const
{
	return eMeshPtr_().points();
}


void tnbLib::searchableExtrudedCircle::boundingSpheres
(
	pointField& centres,
...
) const
{
	...
	radiusSqr = tnbLib::sqr(radius_);
	// Add a bit to make sure all points are tested inside
	radiusSqr += tnbLib::sqr(small);
}


void tnbLib::searchableExtrudedCircle::findNearest
(
...
void tnbLib::searchableExtrudedCircle::findParametricNearest
(
	const point& start,
	const point& end,
...
) const
{
	...
	const scalar maxDistSqr(tnbLib::magSqr(bounds().span()));
...
void tnbLib::searchableExtrudedCircle::getRegion
(
...
void tnbLib::searchableExtrudedCircle::getNormal
(
	const List<pointIndexHit>& info,
	vectorField& normal
) const
