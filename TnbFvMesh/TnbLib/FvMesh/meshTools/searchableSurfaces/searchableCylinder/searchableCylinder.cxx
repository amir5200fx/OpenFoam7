#include <searchableCylinder.hxx>
...
tnbLib::tmp<tnbLib::pointField> tnbLib::searchableCylinder::coordinates() const
{
...
void tnbLib::searchableCylinder::boundingSpheres
(
	pointField& centres,
...
) const
{
	...
	radiusSqr.setSize(1);
	radiusSqr[0] = tnbLib::magSqr(point1_ - centres[0]) + tnbLib::sqr(radius_);
...
tnbLib::tmp<tnbLib::pointField> tnbLib::searchableCylinder::points() const
{
...
tnbLib::pointIndexHit tnbLib::searchableCylinder::findNearest
(
	const point& sample,
...
tnbLib::scalar tnbLib::searchableCylinder::radius2(const point& pt) const
{
...
void tnbLib::searchableCylinder::findLineAll
(
	const point& start,
	const point& end,
	pointIndexHit& near,
...
tnbLib::boundBox tnbLib::searchableCylinder::calcBounds() const
{
	...
	min = ::tnbLib::min(min, point2_ - kr);
	max = ::tnbLib::max(max, point2_ + kr);
...
tnbLib::searchableCylinder::searchableCylinder
(
	const IOobject& io,
	const point& point1,
	const point& point2,
...
const tnbLib::wordList& tnbLib::searchableCylinder::regions() const
{
	if (regions_.empty())
	{
		regions_.setSize(1);
...
void tnbLib::searchableCylinder::findNearest
(
...
void tnbLib::searchableCylinder::findLine
(
...
void tnbLib::searchableCylinder::findLineAny
(
	const pointField& start,
	const pointField& end,
	List<pointIndexHit>& info
...
void tnbLib::searchableCylinder::getRegion
(
...
void tnbLib::searchableCylinder::getNormal
(
	const List<pointIndexHit>& info,
	vectorField& normal
) const
...
void tnbLib::searchableCylinder::getVolumeType
(
