...
tnbLib::fileName tnbLib::triSurfaceMesh::checkFile
(
...
tnbLib::fileName tnbLib::triSurfaceMesh::relativeFilePath
(
	const regIOobject& io,
	const fileName& f,
	const bool isGlobal
...
bool tnbLib::triSurfaceMesh::addFaceToEdge
(
	const edge& e,
...
bool tnbLib::triSurfaceMesh::isSurfaceClosed() const
{
...
tnbLib::triSurfaceMesh::triSurfaceMesh(const IOobject& io, const triSurface& s)
	:
...
tnbLib::triSurfaceMesh::triSurfaceMesh(const IOobject& io)
	:
...
tnbLib::triSurfaceMesh::triSurfaceMesh
(
	const IOobject& io,
	const dictionary& dict
)
...
tnbLib::triSurfaceMesh::triSurfaceMesh(const IOobject& io, const bool isGlobal)
	:
	// Find instance for triSurfaceMesh
	searchableSurface(io),
	// Reused found instance in objectRegistry
...
void tnbLib::triSurfaceMesh::clearOut()
{
...
tnbLib::tmp<tnbLib::pointField> tnbLib::triSurfaceMesh::coordinates() const
{
...
void tnbLib::triSurfaceMesh::boundingSpheres
(
	pointField& centres,
...
) const
{
	...
	forAll(*this, facei)
	{
		...
		forAll(f, fp)
		{
			...
			radiusSqr[facei] = max(radiusSqr[facei], tnbLib::magSqr(fc - pt));
		}
	}
...
tnbLib::tmp<tnbLib::pointField> tnbLib::triSurfaceMesh::points() const
{
	return triSurface::points();
}


bool tnbLib::triSurfaceMesh::overlaps(const boundBox& bb) const
{
...
void tnbLib::triSurfaceMesh::movePoints(const pointField& newPoints)
{
	triSurfaceRegionSearch::clearOut();
	edgeTree_.clear();
...
tnbLib::triSurfaceMesh::edgeTree() const
{
	if (edgeTree_.empty())
	{
		// Boundary edges
...
const tnbLib::wordList& tnbLib::triSurfaceMesh::regions() const
{
	if (regions_.empty())
	{
...
bool tnbLib::triSurfaceMesh::hasVolumeType() const
{
	if (surfaceClosed_ == -1)
	{
		if (isSurfaceClosed())
...
void tnbLib::triSurfaceMesh::findNearest
(
...
void tnbLib::triSurfaceMesh::findLine
(
...
void tnbLib::triSurfaceMesh::findLineAny
(
	const pointField& start,
	const pointField& end,
	List<pointIndexHit>& info
...
void tnbLib::triSurfaceMesh::findLineAll
(
	const pointField& start,
	const pointField& end,
...
void tnbLib::triSurfaceMesh::getRegion
(
...
void tnbLib::triSurfaceMesh::getNormal
(
	const List<pointIndexHit>& info,
	vectorField& normal
) const
...
void tnbLib::triSurfaceMesh::getVolumeType
(
...
void tnbLib::triSurfaceMesh::setField(const labelList& values)
{
...
void tnbLib::triSurfaceMesh::getField
(
	const List<pointIndexHit>& info,
	labelList& values
) const
...
bool tnbLib::triSurfaceMesh::writeObject
(
