...
tnbLib::treeDataFace::findNearestOp::findNearestOp
(
...
tnbLib::treeDataFace::findIntersectOp::findIntersectOp
(
	const indexedOctree<treeDataFace>& tree
)
	:
...
tnbLib::pointField tnbLib::treeDataFace::shapePoints() const
{
...
tnbLib::volumeType tnbLib::treeDataFace::getVolumeType
(
...
void tnbLib::treeDataFace::findNearestOp::operator()
(
...
bool tnbLib::treeDataFace::findIntersectOp::operator()
(
	const label index,
	const point& start,
	const point& end,
