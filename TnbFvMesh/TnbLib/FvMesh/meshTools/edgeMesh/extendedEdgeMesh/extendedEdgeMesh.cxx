...
#include <unitConversion.hxx>  // added by amir
...
tnbLib::extendedEdgeMesh::pointStatusNames_;

const tnbLib::NamedEnum<tnbLib::extendedEdgeMesh::edgeStatus, 6>
tnbLib::extendedEdgeMesh::edgeStatusNames_;

const tnbLib::NamedEnum<tnbLib::extendedEdgeMesh::sideVolumeType, 4>
tnbLib::extendedEdgeMesh::sideVolumeTypeNames_;

tnbLib::scalar tnbLib::extendedEdgeMesh::cosNormalAngleTol_ =
tnbLib::cos(degToRad(0.1));


tnbLib::label tnbLib::extendedEdgeMesh::convexStart_ = 0;


tnbLib::label tnbLib::extendedEdgeMesh::externalStart_ = 0;


tnbLib::label tnbLib::extendedEdgeMesh::nPointTypes = 4;


tnbLib::label tnbLib::extendedEdgeMesh::nEdgeTypes = 5;


tnbLib::wordHashSet tnbLib::extendedEdgeMesh::readTypes()
{
	return wordHashSet(*fileExtensionConstructorTablePtr_);
}


tnbLib::wordHashSet tnbLib::extendedEdgeMesh::writeTypes()
{
...
bool tnbLib::extendedEdgeMesh::canReadType
(
	const word& ext,
	const bool verbose
)
...
bool tnbLib::extendedEdgeMesh::canWriteType
(
	const word& ext,
	const bool verbose
)
...
bool tnbLib::extendedEdgeMesh::canRead
(
	const fileName& name,
	const bool verbose
)
...
tnbLib::extendedEdgeMesh::pointStatus
tnbLib::extendedEdgeMesh::classifyFeaturePoint
(
	label ptI
) const
{
...
tnbLib::extendedEdgeMesh::edgeStatus
tnbLib::extendedEdgeMesh::classifyEdge
(
...
tnbLib::extendedEdgeMesh::extendedEdgeMesh()
	:
...
tnbLib::extendedEdgeMesh::extendedEdgeMesh(const extendedEdgeMesh& fem)
	:
	edgeMesh(fem),
...
tnbLib::extendedEdgeMesh::extendedEdgeMesh(extendedEdgeMesh&& fem)
	:
	edgeMesh(move(fem)),
	concaveStart_(fem.concaveStart()),
	mixedStart_(fem.mixedStart()),
...
tnbLib::extendedEdgeMesh::extendedEdgeMesh(Istream& is)
{
	is >> *this;
}
...
tnbLib::extendedEdgeMesh::extendedEdgeMesh(const fileName& name)
	:
	edgeMesh(pointField(0), edgeList(0)),
	concaveStart_(0),
	mixedStart_(0),
...
bool tnbLib::extendedEdgeMesh::read(const fileName& name)
{
	word ext = name.ext();
	if (ext == "gz")
	{
...
bool tnbLib::extendedEdgeMesh::read
(
	const fileName& name,
	const word& ext
)
...
void tnbLib::extendedEdgeMesh::nearestFeaturePoint
(
	const point& sample,
...
void tnbLib::extendedEdgeMesh::nearestFeatureEdge
(
	const point& sample,
	scalar searchDistSqr,
	pointIndexHit& info
...
void tnbLib::extendedEdgeMesh::nearestFeatureEdgeByType
(
	const point& sample,
	const scalarField& searchDistSqr,
	pointIndexHitList& info
...
void tnbLib::extendedEdgeMesh::allNearestFeaturePoints
(
	const point& sample,
...
void tnbLib::extendedEdgeMesh::allNearestFeatureEdges
(
	const point& sample,
...
tnbLib::scalar tnbLib::extendedEdgeMesh::minDisconnectedDist
(
...
const tnbLib::indexedOctree<tnbLib::treeDataPoint>&
tnbLib::extendedEdgeMesh::pointTree() const
{
	if (pointTree_.empty())
	{
...
const tnbLib::indexedOctree<tnbLib::treeDataEdge>&
tnbLib::extendedEdgeMesh::edgeTree() const
{
	if (edgeTree_.empty())
	{
		// Slightly extended bb. Slightly off-centred just so on symmetric
...
const tnbLib::PtrList<tnbLib::indexedOctree<tnbLib::treeDataEdge>>&
tnbLib::extendedEdgeMesh::edgeTreesByType() const
{
...
void tnbLib::extendedEdgeMesh::transfer(extendedEdgeMesh& mesh)
{
...
void tnbLib::extendedEdgeMesh::clear()
{
	edgeMesh::clear();
	concaveStart_ = 0;
	mixedStart_ = 0;
...
void tnbLib::extendedEdgeMesh::add(const extendedEdgeMesh& fem)
{
	// Points
	// ~~~~~~
...
void tnbLib::extendedEdgeMesh::flipNormals()
{
	// Points
	// ~~~~~~
...
void tnbLib::extendedEdgeMesh::writeObj
(
...
void tnbLib::extendedEdgeMesh::writeStats(Ostream& os) const
{
	...
	)
{
	...
	vt = static_cast<tnbLib::extendedEdgeMesh::sideVolumeType>(type);
