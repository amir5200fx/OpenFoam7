...
void tnbLib::momentOfInertia::massPropertiesSolid
(
...
void tnbLib::momentOfInertia::massPropertiesShell
(
	const pointField& pts,
	const triFaceList& triFaces,
	scalar density,
...
tnbLib::tensor tnbLib::momentOfInertia::applyParallelAxisTheorem
(
	scalar mass,
	const vector& cM,
	const tensor& J,
...
tnbLib::tmp<tnbLib::tensorField> tnbLib::momentOfInertia::meshInertia
(
	const polyMesh& mesh
)
{
...
tnbLib::tensor tnbLib::momentOfInertia::meshInertia
(
	const polyMesh& mesh,
	label celli
)
