...
const tnbLib::NamedEnum<tnbLib::mappedPatchBase::sampleMode, 6>
tnbLib::mappedPatchBase::sampleModeNames_;

const tnbLib::NamedEnum<tnbLib::mappedPatchBase::offsetMode, 3>
tnbLib::mappedPatchBase::offsetModeNames_;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

tnbLib::tmp<tnbLib::pointField> tnbLib::mappedPatchBase::facePoints
(
	const polyPatch& pp
) const
{
...
void tnbLib::mappedPatchBase::collectSamples
(
...
void tnbLib::mappedPatchBase::findSamples
(
...
) const
{
	...
	case NEARESTCELL:
	{
		...
		const indexedOctree<tnbLib::treeDataCell>& tree = mesh.cellTree();
		...
		forAll(samples, sampleI)
		{
			...
			if (celli == -1)
			{
				nearest[sampleI].second().first() = tnbLib::sqr(great);
...
void tnbLib::mappedPatchBase::calcMapping() const
{
...
const tnbLib::autoPtr<tnbLib::searchableSurface>& tnbLib::mappedPatchBase::surfPtr()
const
{
...
void tnbLib::mappedPatchBase::calcAMI() const
{
	if (AMIPtr_.valid())
	{
		FatalErrorInFunction
...
tnbLib::tmp<tnbLib::pointField> tnbLib::mappedPatchBase::readListOrField
(
	const word& keyword,
...
tnbLib::mappedPatchBase::mappedPatchBase
(
	const polyPatch& pp
)
	:
...
void tnbLib::mappedPatchBase::clearOut()
{
	mapPtr_.clear();
	AMIPtr_.clear();
	surfPtr_.clear();
...
const tnbLib::polyMesh& tnbLib::mappedPatchBase::sampleMesh() const
{
...
const tnbLib::polyPatch& tnbLib::mappedPatchBase::samplePolyPatch() const
{
...
tnbLib::tmp<tnbLib::pointField> tnbLib::mappedPatchBase::samplePoints
(
	const pointField& fc
) const
{
...
tnbLib::tmp<tnbLib::pointField> tnbLib::mappedPatchBase::samplePoints() const
{
	return samplePoints(facePoints(patch_));
}


tnbLib::pointIndexHit tnbLib::mappedPatchBase::facePoint
(
	const polyMesh& mesh,
	const label facei,
...
void tnbLib::mappedPatchBase::write(Ostream& os) const
{
