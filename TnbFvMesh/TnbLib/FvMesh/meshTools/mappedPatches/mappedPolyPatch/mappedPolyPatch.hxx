#pragma once
#ifndef _mappedPolyPatch_Header
#define _mappedPolyPatch_Header
...
namespace tnbLib
{
	...
	public:
		...
		static const char* typeName_() { return "mappedPatch"; }
		...
		FoamFvMesh_EXPORT mappedPolyPatch
		(
			const word& name,
			const label size,
			const label start,
		...
		//- Destructor
		FoamFvMesh_EXPORT virtual ~mappedPolyPatch();
