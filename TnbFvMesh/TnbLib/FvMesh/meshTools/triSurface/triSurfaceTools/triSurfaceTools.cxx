...
const tnbLib::label tnbLib::triSurfaceTools::ANYEDGE = -1;
const tnbLib::label tnbLib::triSurfaceTools::NOEDGE = -2;
const tnbLib::label tnbLib::triSurfaceTools::COLLAPSED = -3;
...
void tnbLib::triSurfaceTools::calcRefineStatus
(
...
void tnbLib::triSurfaceTools::greenRefine
(
	const triSurface& surf,
	const label facei,
	const label edgeI,
...
tnbLib::triSurface tnbLib::triSurfaceTools::doRefine
(
	const triSurface& surf,
...
tnbLib::scalar tnbLib::triSurfaceTools::faceCosAngle
(
	const point& pStart,
	const point& pEnd,
	const point& pLeft,
...
void tnbLib::triSurfaceTools::protectNeighbours
(
	const triSurface& surf,
	const label vertI,
...
tnbLib::labelHashSet tnbLib::triSurfaceTools::getCollapsedFaces
(
	const triSurface& surf,
	label edgeI
)
...
tnbLib::label tnbLib::triSurfaceTools::vertexUsesFace
(
	const triSurface& surf,
...
void tnbLib::triSurfaceTools::getMergedEdges
(
	const triSurface& surf,
	const label edgeI,
...
tnbLib::scalar tnbLib::triSurfaceTools::edgeCosAngle
(
	const triSurface& surf,
	const label v1,
	const point& pt,
...
tnbLib::scalar tnbLib::triSurfaceTools::collapseMinCosAngle
(
	const triSurface& surf,
	const label v1,
	const point& pt,
...
bool tnbLib::triSurfaceTools::collapseCreatesFold
(
	const triSurface& surf,
	const label v1,
	const point& pt,
...
// a vertex.
//bool tnbLib::triSurfaceTools::collapseCreatesDuplicates
//(
//    const triSurface& surf,
//    const label edgeI,
//    const labelHashSet& collapsedFaces
...
//  - miss()
tnbLib::surfaceLocation tnbLib::triSurfaceTools::cutEdge
(
	const triSurface& s,
	const label triI,
...
void tnbLib::triSurfaceTools::snapToEnd
(
	const triSurface& s,
...
//  - triangle to exclude
tnbLib::surfaceLocation tnbLib::triSurfaceTools::visitFaces
(
	const triSurface& s,
...
)
{
	...
	scalar minDistSqr = tnbLib::sqr(great);
...
void tnbLib::triSurfaceTools::writeOBJ
(
...
void tnbLib::triSurfaceTools::getVertexTriangles
(
	const triSurface& surf,
	const label edgeI,
	labelList& edgeTris
...
tnbLib::labelList tnbLib::triSurfaceTools::getVertexVertices
(
	const triSurface& surf,
	const edge& e
)
...
//void tnbLib::triSurfaceTools::orderVertices
//(
//    const labelledTri& f,
//    const label v1,
//    const label v2,
...
tnbLib::label tnbLib::triSurfaceTools::otherFace
(
	const triSurface& surf,
	const label facei,
	const label edgeI
...
void tnbLib::triSurfaceTools::otherEdges
(
	const triSurface& surf,
	const label facei,
	const label edgeI,
...
void tnbLib::triSurfaceTools::otherVertices
(
	const triSurface& surf,
	const label facei,
	const label vertI,
...
tnbLib::label tnbLib::triSurfaceTools::oppositeEdge
(
	const triSurface& surf,
	const label facei,
	const label vertI
...
tnbLib::label tnbLib::triSurfaceTools::oppositeVertex
(
	const triSurface& surf,
	const label facei,
	const label edgeI
...
tnbLib::label tnbLib::triSurfaceTools::getEdge
(
	const triSurface& surf,
	const label v1,
	const label v2
...
tnbLib::label tnbLib::triSurfaceTools::getTriangle
(
	const triSurface& surf,
	const label e0I,
	const label e1I,
...
tnbLib::triSurface tnbLib::triSurfaceTools::collapseEdges
(
	const triSurface& surf,
...
tnbLib::triSurface tnbLib::triSurfaceTools::redGreenRefine
(
	const triSurface& surf,
...
tnbLib::triSurface tnbLib::triSurfaceTools::greenRefine
(
	const triSurface& surf,
...
tnbLib::label tnbLib::triSurfaceTools::minEdge
(
	const triSurface& surf,
...
tnbLib::label tnbLib::triSurfaceTools::maxEdge
(
	const triSurface& surf,
	const labelList& edgeIndices
)
...
tnbLib::triSurface tnbLib::triSurfaceTools::mergePoints
(
	const triSurface& surf,
...
tnbLib::vector tnbLib::triSurfaceTools::surfaceNormal
(
	const triSurface& surf,
...
tnbLib::triSurfaceTools::sideType tnbLib::triSurfaceTools::edgeSide
(
	const triSurface& surf,
	const point& sample,
...
// Calculate normal on triangle
tnbLib::triSurfaceTools::sideType tnbLib::triSurfaceTools::surfaceSide
(
	const triSurface& surf,
	const point& sample,
	const label nearestFacei
	...
	else
	{
		...
		forAll(pEdges, i)
		{
			...
			if (magEVec > vSmall)
			{
				...
				scalar distSqr = tnbLib::magSqr(sample - perturbPoint);
...
tnbLib::triSurface tnbLib::triSurfaceTools::triangulate
(
...
tnbLib::triSurface tnbLib::triSurfaceTools::triangulateFaceCentre
(
	const polyBoundaryMesh& bMesh,
	const labelHashSet& includePatches,
	const bool verbose
...
tnbLib::triSurface tnbLib::triSurfaceTools::delaunay2D(const List<vector2D>& pts)
{
...
void tnbLib::triSurfaceTools::calcInterpolationWeights
(
...
tnbLib::surfaceLocation tnbLib::triSurfaceTools::classify
(
	const triSurface& s,
	const label triI,
...
tnbLib::surfaceLocation tnbLib::triSurfaceTools::trackToEdge
(
	const triSurface& s,
	const surfaceLocation& start,
	const surfaceLocation& end,
...
void tnbLib::triSurfaceTools::track
(
	const triSurface& s,
