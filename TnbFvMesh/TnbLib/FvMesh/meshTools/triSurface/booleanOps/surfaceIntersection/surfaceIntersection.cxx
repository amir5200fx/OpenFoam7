...
bool tnbLib::surfaceIntersection::excludeEdgeHit
(
...
//// - edgeI
//// - intersection point
//tnbLib::pointIndexHit tnbLib::surfaceIntersection::faceEdgeIntersection
//(
//    const triSurface& surf,
...
void tnbLib::surfaceIntersection::storeIntersection
(
...
// surface2 reversed.
void tnbLib::surfaceIntersection::classifyHit
(
...
//
void tnbLib::surfaceIntersection::doCutEdges
(
	const triSurface& surf1,
...
// Null constructor
tnbLib::surfaceIntersection::surfaceIntersection()
	:
	cutPoints_(0),
	cutEdges_(0),
	facePairToVertex_(0),
...
const tnbLib::pointField& tnbLib::surfaceIntersection::cutPoints() const
{
	return cutPoints_;
}


const tnbLib::edgeList& tnbLib::surfaceIntersection::cutEdges() const
{
	return cutEdges_;
}


const tnbLib::labelPairLookup& tnbLib::surfaceIntersection::facePairToVertex() const
{
	return facePairToVertex_;
}


const tnbLib::labelPairLookup& tnbLib::surfaceIntersection::facePairToEdge() const
{
	return facePairToEdge_;
}


const tnbLib::labelListList& tnbLib::surfaceIntersection::edgeCuts
(
	const bool isFirstSurf
) const
{
...
const tnbLib::labelListList& tnbLib::surfaceIntersection::surf1EdgeCuts() const
{
	return surf1EdgeCuts_;
}


const tnbLib::labelListList& tnbLib::surfaceIntersection::surf2EdgeCuts() const
{
	return surf2EdgeCuts_;
}
