...
void tnbLib::edgeIntersections::checkEdges(const triSurface& surf)
{
...
void tnbLib::edgeIntersections::intersectEdges
(
...
bool tnbLib::edgeIntersections::inlinePerturb
(
	const triSurface& surf1,
	const scalarField& surf1PointTol,   // surf1 tolerance per point
	const label edgeI,
...
bool tnbLib::edgeIntersections::rotatePerturb
(
	const triSurface& surf1,
	const scalarField& surf1PointTol,   // surf1 tolerance per point
	const label edgeI,
...
bool tnbLib::edgeIntersections::offsetPerturb
(
	const triSurface& surf1,
...
// Construct null
tnbLib::edgeIntersections::edgeIntersections()
	:
...
tnbLib::scalarField tnbLib::edgeIntersections::minEdgeLength(const triSurface& surf)
{
	const pointField& localPoints = surf.localPoints();
...
tnbLib::label tnbLib::edgeIntersections::removeDegenerates
(
	const label nIters,
	const triSurface& surf1,
	const triSurfaceSearch& query2,
...
void tnbLib::edgeIntersections::merge
(
