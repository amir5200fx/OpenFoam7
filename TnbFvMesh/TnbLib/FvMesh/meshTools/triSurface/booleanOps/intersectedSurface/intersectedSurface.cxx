#include <intersectedSurface.hxx>
...
const tnbLib::label tnbLib::intersectedSurface::UNVISITED = 0;
const tnbLib::label tnbLib::intersectedSurface::STARTTOEND = 1;
const tnbLib::label tnbLib::intersectedSurface::ENDTOSTART = 2;
const tnbLib::label tnbLib::intersectedSurface::BOTH = STARTTOEND | ENDTOSTART;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

// Write whole pointField and edges to stream
void tnbLib::intersectedSurface::writeOBJ
(
...
void tnbLib::intersectedSurface::writeLocalOBJ
(
	const pointField& points,
	const edgeList& edges,
	const labelList& faceEdges,
...
void tnbLib::intersectedSurface::printVisit
(
	const edgeList& edges,
...
// both faces.
bool tnbLib::intersectedSurface::sameEdgeOrder
(
...
void tnbLib::intersectedSurface::incCount
(
	Map<label>& visited,
	const label key,
	const label offset
...
tnbLib::Map<tnbLib::DynamicList<tnbLib::label>>
tnbLib::intersectedSurface::calcPointEdgeAddressing
(
...
tnbLib::label tnbLib::intersectedSurface::nextEdge
(
	const edgeSurface& eSurf,
	const Map<label>& visited,
	const label facei,
...
tnbLib::face tnbLib::intersectedSurface::walkFace
(
	const edgeSurface& eSurf,
	const label facei,
	const vector& n,
...
void tnbLib::intersectedSurface::findNearestVisited
(
	const edgeSurface& eSurf,
	const label facei,
	const Map<DynamicList<label>>& facePointEdges,
...
tnbLib::faceList tnbLib::intersectedSurface::resplitFace
(
...
)
{
	...
	fileName newFName("face_" + tnbLib::name(facei) + "_newEdges.obj");
...
tnbLib::faceList tnbLib::intersectedSurface::splitFace
(
	const triSurface& surf,
	const label facei,
	edgeSurface& eSurf
...
// Null constructor
tnbLib::intersectedSurface::intersectedSurface()
	:
	triSurface(),
...
tnbLib::intersectedSurface::intersectedSurface(const triSurface& surf)
	:
	triSurface(surf),
	intersectionEdges_(0),
	faceMap_(0),
