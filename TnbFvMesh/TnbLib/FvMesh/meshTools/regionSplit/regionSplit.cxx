...
void tnbLib::regionSplit::calcNonCompactRegionSplit
(
...
tnbLib::autoPtr<tnbLib::globalIndex> tnbLib::regionSplit::calcRegionSplit
(
...
tnbLib::regionSplit::regionSplit(const polyMesh& mesh, const bool doGlobalRegions)
	:
	MeshObject<polyMesh, tnbLib::TopologicalMeshObject, regionSplit>(mesh),
...
tnbLib::regionSplit::regionSplit
(
	const polyMesh& mesh,
	const boolList& blockedFace,
	const bool doGlobalRegions
