...
bool tnbLib::localPointRegion::isDuplicate
(
	const face& f0,
	const face& f1,
	const bool forward
...
void tnbLib::localPointRegion::countPointRegions
(
	const polyMesh& mesh,
...
void tnbLib::localPointRegion::calcPointRegions
(
	const polyMesh& mesh,
...
tnbLib::localPointRegion::localPointRegion(const polyMesh& mesh)
	:
	// nRegions_(0),
	meshPointMap_(0),
	pointRegions_(0),
...
tnbLib::localPointRegion::localPointRegion
(
	const polyMesh& mesh,
...
tnbLib::labelList tnbLib::localPointRegion::findDuplicateFaces
(
...
tnbLib::List<tnbLib::labelPair> tnbLib::localPointRegion::findDuplicateFacePairs
(
	const polyMesh& mesh
)
{
...
void tnbLib::localPointRegion::updateMesh(const mapPolyMesh& map)
{
	{
