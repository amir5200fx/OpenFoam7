#include <primitiveMeshGeometry.hxx>
...
void tnbLib::primitiveMeshGeometry::updateFaceCentresAndAreas
(
	const pointField& p,
...
void tnbLib::primitiveMeshGeometry::updateCellCentresAndVols
(
...
tnbLib::labelList tnbLib::primitiveMeshGeometry::affectedCells
(
	const labelList& changedFaces
) const
{
...
tnbLib::primitiveMeshGeometry::primitiveMeshGeometry
(
...
void tnbLib::primitiveMeshGeometry::correct()
{
...
bool tnbLib::primitiveMeshGeometry::checkFaceDotProduct
(
	const bool report,
...
bool tnbLib::primitiveMeshGeometry::checkFacePyramids
(
	const bool report,
...
bool tnbLib::primitiveMeshGeometry::checkFaceSkewness
(
	const bool report,
...
bool tnbLib::primitiveMeshGeometry::checkFaceWeights
(
	const bool report,
...
bool tnbLib::primitiveMeshGeometry::checkFaceAngles
(
	const bool report,
	const scalar maxDeg,
	const primitiveMesh& mesh,
...
//bool tnbLib::primitiveMeshGeometry::checkFaceFlatness
//(
//    const bool report,
...
// individual triangles and the overall area of the face (which ifself is
// is the average of the areas of the individual triangles).
bool tnbLib::primitiveMeshGeometry::checkFaceTwist
(
	const bool report,
...
bool tnbLib::primitiveMeshGeometry::checkFaceArea
(
	const bool report,
...
bool tnbLib::primitiveMeshGeometry::checkCellDeterminant
(
	const bool report,
