...
bool tnbLib::cellFeatures::faceAlignedEdge(const label facei, const label edgeI)
const
{
...
// but is not edgeI
tnbLib::label tnbLib::cellFeatures::nextEdge
(
...
bool tnbLib::cellFeatures::isCellFeatureEdge
(
	const scalar minCos,
	const label edgeI
) const
...
// edges.
void tnbLib::cellFeatures::walkSuperFace
(
	const label facei,
	const label superFacei,
...
void tnbLib::cellFeatures::calcSuperFaces() const
{
...
tnbLib::cellFeatures::cellFeatures
(
...
bool tnbLib::cellFeatures::isFeaturePoint(const label edge0, const label edge1)
const
{
	if
		(
...
bool tnbLib::cellFeatures::isFeatureVertex(const label facei, const label vertI)
const
{
	if
		(
