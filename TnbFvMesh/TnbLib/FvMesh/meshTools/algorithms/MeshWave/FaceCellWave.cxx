...
const tnbLib::scalar tnbLib::FaceCellWave<Type, TrackingData>::geomTol_ = 1e-6;

template<class Type, class TrackingData>
tnbLib::scalar tnbLib::FaceCellWave<Type, TrackingData>::propagationTol_ = 0.01;

template<class Type, class TrackingData>
int tnbLib::FaceCellWave<Type, TrackingData>::dummyTrackData_ = 12345;
...
template<class Type, class TrackingData>
bool tnbLib::FaceCellWave<Type, TrackingData>::updateCell
(
	const label celli,
...
template<class Type, class TrackingData>
bool tnbLib::FaceCellWave<Type, TrackingData>::updateFace
(
	const label facei,
...
template<class Type, class TrackingData>
void tnbLib::FaceCellWave<Type, TrackingData>::checkCyclic
(
...
bool tnbLib::FaceCellWave<Type, TrackingData>::hasPatch() const
{
...
template<class Type, class TrackingData>
void tnbLib::FaceCellWave<Type, TrackingData>::setFaceInfo
(
...
template<class Type, class TrackingData>
void tnbLib::FaceCellWave<Type, TrackingData>::mergeFaceInfo
(
	const polyPatch& patch,
	const label nFaces,
	const labelList& changedFaces,
...
template<class Type, class TrackingData>
tnbLib::label tnbLib::FaceCellWave<Type, TrackingData>::getChangedPatchFaces
(
	const polyPatch& patch,
...
template<class Type, class TrackingData>
void tnbLib::FaceCellWave<Type, TrackingData>::leaveDomain
(
	const polyPatch& patch,
	const label nFaces,
...
template<class Type, class TrackingData>
void tnbLib::FaceCellWave<Type, TrackingData>::enterDomain
(
	const polyPatch& patch,
	const label nFaces,
	const labelList& faceLabels,
...
template<class Type, class TrackingData>
void tnbLib::FaceCellWave<Type, TrackingData>::transform
(
...
template<class Type, class TrackingData>
void tnbLib::FaceCellWave<Type, TrackingData>::offset
(
	const polyPatch&,
...
template<class Type, class TrackingData>
void tnbLib::FaceCellWave<Type, TrackingData>::handleProcPatches()
{
...
template<class Type, class TrackingData>
void tnbLib::FaceCellWave<Type, TrackingData>::handleCyclicPatches()
{
...
template<class Type, class TrackingData>
void tnbLib::FaceCellWave<Type, TrackingData>::handleAMICyclicPatches()
{
...
template<class Type, class TrackingData>
void tnbLib::FaceCellWave<Type, TrackingData>::handleExplicitConnections()
{
...
template<class Type, class TrackingData>
tnbLib::FaceCellWave<Type, TrackingData>::FaceCellWave
(
	const polyMesh& mesh,
...
template<class Type, class TrackingData>
tnbLib::label tnbLib::FaceCellWave<Type, TrackingData>::getUnsetCells() const
{
...
template<class Type, class TrackingData>
tnbLib::label tnbLib::FaceCellWave<Type, TrackingData>::getUnsetFaces() const
{
...
template<class Type, class TrackingData>
tnbLib::label tnbLib::FaceCellWave<Type, TrackingData>::faceToCell()
{
...
template<class Type, class TrackingData>
tnbLib::label tnbLib::FaceCellWave<Type, TrackingData>::cellToFace()
{
...
// Iterate
template<class Type, class TrackingData>
tnbLib::label tnbLib::FaceCellWave<Type, TrackingData>::iterate(const label maxIter)
{
	if (hasCyclicPatches_)
	{
		// Transfer changed faces across cyclic halves
