...
void tnbLib::faceAreaWeightAMI::calcAddressing
(
...
bool tnbLib::faceAreaWeightAMI::processSourceFace
(
...
void tnbLib::faceAreaWeightAMI::setNextFaces
(
	label& startSeedI,
	label& srcFacei,
	label& tgtFacei,
...
tnbLib::scalar tnbLib::faceAreaWeightAMI::interArea
(
	const label srcFacei,
...
void tnbLib::faceAreaWeightAMI::restartUncoveredSourceFace
(
	List<DynamicList<label>>& srcAddr,
	List<DynamicList<scalar>>& srcWght,
	List<DynamicList<label>>& tgtAddr,
...
tnbLib::scalar
tnbLib::faceAreaWeightAMI::minWeight() const
{
...
tnbLib::faceAreaWeightAMI::faceAreaWeightAMI
(
...
void tnbLib::faceAreaWeightAMI::calculate
(
