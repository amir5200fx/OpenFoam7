...
tnbLib::word tnbLib::AMIInterpolation::interpolationMethodToWord
(
...
typename tnbLib::AMIInterpolation::interpolationMethod
tnbLib::AMIInterpolation::wordTointerpolationMethod(const word& im)
{
...
tnbLib::tmp<tnbLib::scalarField> tnbLib::AMIInterpolation::patchMagSf
(
...
void tnbLib::AMIInterpolation::projectPointsToSurface
(
...
void tnbLib::AMIInterpolation::sumWeights
(
...
void tnbLib::AMIInterpolation::reportSumWeights
(
...
void tnbLib::AMIInterpolation::normaliseWeights
(
	scalarListList& wght,
	const scalarField& wghtSum
)
...
void tnbLib::AMIInterpolation::agglomerate
(
...
void tnbLib::AMIInterpolation::constructFromSurface
(
...
tnbLib::AMIInterpolation::AMIInterpolation
(
	const primitivePatch& srcPatch,
	const primitivePatch& tgtPatch,
	const faceAreaIntersect::triangulationMode& triMode,
...
void tnbLib::AMIInterpolation::update
(
	const primitivePatch& srcPatch,
	const primitivePatch& tgtPatch,
	const bool report
...
void tnbLib::AMIInterpolation::sumWeights(AMIInterpolation& AMI)
{
...
void tnbLib::AMIInterpolation::sumWeights(PtrList<AMIInterpolation>& AMIs)
{
...
void tnbLib::AMIInterpolation::reportSumWeights(AMIInterpolation& AMI)
{
	reportSumWeights
	(
		AMI.srcMagSf_,
...
void tnbLib::AMIInterpolation::normaliseWeights(AMIInterpolation& AMI)
{
...
void tnbLib::AMIInterpolation::normaliseWeights(UPtrList<AMIInterpolation>& AMIs)
{
	UPtrList<scalarListList> srcWeights(AMIs.size());
	forAll(AMIs, i)
	{
...
tnbLib::label tnbLib::AMIInterpolation::srcPointFace
(
	const primitivePatch& srcPatch,
	const primitivePatch& tgtPatch,
	const vector& n,
...
tnbLib::label tnbLib::AMIInterpolation::tgtPointFace
(
	const primitivePatch& srcPatch,
	const primitivePatch& tgtPatch,
	const vector& n,
...
void tnbLib::AMIInterpolation::writeFaceConnectivity
(
	const primitivePatch& srcPatch,
	const primitivePatch& tgtPatch,
...
const
{
	OFstream os("faceConnectivity" + tnbLib::name(Pstream::myProcNo()) + ".obj");
