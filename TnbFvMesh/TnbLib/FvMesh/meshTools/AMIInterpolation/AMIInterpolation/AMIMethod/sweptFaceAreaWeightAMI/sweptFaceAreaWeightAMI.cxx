#include <sweptFaceAreaWeightAMI.hxx>
...
const tnbLib::scalar tnbLib::sweptFaceAreaWeightAMI::minCutRatio_ = 10 * small;

const tnbLib::scalar tnbLib::sweptFaceAreaWeightAMI::maxDot_ =
-cos(degToRad(89.9));
...
void tnbLib::sweptFaceAreaWeightAMI::writeCutTrisVTK
(
...
void tnbLib::sweptFaceAreaWeightAMI::writeFaceOBJ
(
	const face& f,
	const pointField& ps,
	const string& name
...
void tnbLib::sweptFaceAreaWeightAMI::writeProjectionOBJ
(
	const label srcN,
...
tnbLib::label tnbLib::sweptFaceAreaWeightAMI::getSourceProjection
(
...
tnbLib::plane tnbLib::sweptFaceAreaWeightAMI::getCutPlane
(
	const point& p0,
	const point& p1,
	const vector& n0,
...
tnbLib::scalar tnbLib::sweptFaceAreaWeightAMI::interArea
(
...
tnbLib::scalar tnbLib::sweptFaceAreaWeightAMI::minWeight() const
{
	return small;
}


tnbLib::scalar tnbLib::sweptFaceAreaWeightAMI::maxWalkAngle() const
{
	return degToRad(180);
}
...
tnbLib::sweptFaceAreaWeightAMI::~sweptFaceAreaWeightAMI()
{}
