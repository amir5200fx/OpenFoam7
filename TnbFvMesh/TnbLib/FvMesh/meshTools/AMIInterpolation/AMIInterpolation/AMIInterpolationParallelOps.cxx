...
tnbLib::label tnbLib::AMIInterpolation::calcDistribution
(
...
tnbLib::label tnbLib::AMIInterpolation::calcOverlappingProcs
(
...
void tnbLib::AMIInterpolation::distributePatches
(
...
void tnbLib::AMIInterpolation::distributeAndMergePatches
(
	const mapDistribute& map,
	const primitivePatch& tgtPatch,
	const globalIndex& gi,
...
tnbLib::AMIInterpolation::calcProcMap
(
	const primitivePatch& srcPatch,
	const primitivePatch& tgtPatch
) const
