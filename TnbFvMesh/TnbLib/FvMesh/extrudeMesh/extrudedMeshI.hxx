...
tnbLib::pointField tnbLib::extrudedMesh::extrudedPoints
(
...
template<class FaceList, class PointField>
tnbLib::faceList tnbLib::extrudedMesh::extrudedFaces
(
	const PrimitivePatch<FaceList, PointField>& extrudePatch,
	const extrudeModel& model
)
...
template<class FaceList, class PointField>
tnbLib::cellList tnbLib::extrudedMesh::extrudedCells
(
	const PrimitivePatch<FaceList, PointField>& extrudePatch,
	const extrudeModel& model
)
...
template<class FaceList, class PointField>
tnbLib::extrudedMesh::extrudedMesh
(
	const IOobject& io,
	const PrimitivePatch<FaceList, PointField>& extrudePatch,
	const extrudeModel& model
