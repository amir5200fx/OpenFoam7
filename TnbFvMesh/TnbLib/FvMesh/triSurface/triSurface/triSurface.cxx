...
tnbLib::scalar tnbLib::triSurface::pointNormalWeight
(
	const triFace& f,
	const label pi,
	const vector& fa,
...
tnbLib::tmp<tnbLib::vectorField> tnbLib::triSurface::weightedPointNormals() const
{
...
tnbLib::tmp<tnbLib::triadField> tnbLib::triSurface::pointCoordSys
(
...
tnbLib::triSurface::triSurface(triSurface&& ts)
	:
...
tnbLib::faceList tnbLib::triSurface::faces() const
{
	faceList faces(size());
...
tnbLib::tmp<tnbLib::scalarField> tnbLib::triSurface::curvature() const
{
