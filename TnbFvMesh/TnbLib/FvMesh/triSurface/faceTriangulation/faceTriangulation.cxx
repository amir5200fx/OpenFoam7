...
const tnbLib::scalar tnbLib::faceTriangulation::edgeRelTol = 1e-6;


// Edge to the right of face vertex i
tnbLib::label tnbLib::faceTriangulation::right(const label, label i)
{
	return i;
}
...
tnbLib::label tnbLib::faceTriangulation::left(const label size, label i)
{
	return i ? i - 1 : size - 1;
}
...
tnbLib::tmp<tnbLib::vectorField> tnbLib::faceTriangulation::calcEdges
(
	const face& f,
...
void tnbLib::faceTriangulation::calcHalfAngle
(
	const vector& normal,
	const vector& e0,
	const vector& e1,
...
)
{
	...
	{
		// 3rd or 4th quadrant
		cosHalfAngle = -tnbLib::sqrt(0.5*(1 + cos));
		sinHalfAngle = tnbLib::sqrt(0.5*(1 - cos));
	}
	else
	{
		// 1st or 2nd quadrant
...
tnbLib::pointHit tnbLib::faceTriangulation::rayEdgeIntersect
(
	const vector& normal,
...
// contains point
bool tnbLib::faceTriangulation::triangleContainsPoint
(
	const vector& n,
	const point& p0,
	const point& p1,
...
void tnbLib::faceTriangulation::findDiagonal
(
	const pointField& points,
	const face& f,
...
tnbLib::label tnbLib::faceTriangulation::findStart
(
	const face& f,
	const vectorField& edges,
	const vector& normal
...
// polygons.
bool tnbLib::faceTriangulation::split
(
	const bool fallBack,
	const pointField& points,
	const face& f,
...
tnbLib::faceTriangulation::faceTriangulation()
	:
	triFaceList()
{}
...
tnbLib::faceTriangulation::faceTriangulation(Istream& is)
	:
	triFaceList(is)
{}
