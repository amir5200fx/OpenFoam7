...
void tnbLib::blockDescriptor::check(const Istream& is)
{
...
void tnbLib::blockDescriptor::findCurvedFaces()
{
...
tnbLib::blockDescriptor::blockDescriptor
(
...
tnbLib::FixedList<tnbLib::pointField, 6>
tnbLib::blockDescriptor::facePoints(const pointField& points) const
{
...
void tnbLib::blockDescriptor::correctFacePoints
(
	FixedList<pointField, 6>& facePoints
) const
{
...
void tnbLib::blockDescriptor::write
(
	Ostream& os,
	const label val,
	const dictionary& d
