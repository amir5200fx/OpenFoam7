...
#include <searchableSurfacesQueries.hxx>  // added by amir
...
tnbLib::projectCurveEdge::projectCurveEdge
(
...
tnbLib::projectCurveEdge::position(const scalarList& lambdas) const
{
	...
	if (debug)
	{
		debugStr.reset
		(
			new OBJstream("projectCurveEdge_" + tnbLib::name(eIter++) + ".obj")
		);
