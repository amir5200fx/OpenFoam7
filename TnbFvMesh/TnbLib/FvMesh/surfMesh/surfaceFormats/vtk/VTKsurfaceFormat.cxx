...
template<class Face>
void tnbLib::fileFormats::VTKsurfaceFormat<Face>::writeHeaderPolygons
(
	Ostream& os,
...
template<class Face>
tnbLib::fileFormats::VTKsurfaceFormat<Face>::VTKsurfaceFormat
(
...
template<class Face>
bool tnbLib::fileFormats::VTKsurfaceFormat<Face>::read
(
	const fileName& filename
)
{
	...
	forAll(zoneNames, i)
	{
		zoneNames[i] = "zone" + tnbLib::name(i);
	}
...
template<class Face>
void tnbLib::fileFormats::VTKsurfaceFormat<Face>::write
(
	const fileName& filename,
