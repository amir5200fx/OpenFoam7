...
template<class Face>
inline void tnbLib::fileFormats::STARCDsurfaceFormat<Face>::writeShell
(
	Ostream& os,
	const Face& f,
	const label cellId,
...
template<class Face>
tnbLib::fileFormats::STARCDsurfaceFormat<Face>::STARCDsurfaceFormat
(
...
template<class Face>
bool tnbLib::fileFormats::STARCDsurfaceFormat<Face>::read
(
	const fileName& filename
)
{
		...
		if (typeId == starcdShellType_)
		{
			...
			else
			{
				...
				if (tableNameIter == cellTableLookup.end())
				{
					dynNames.append
					(
						word("cellTable_") + ::tnbLib::name(cellTableId)
					);
				}
				else
				{
...
template<class Face>
void tnbLib::fileFormats::STARCDsurfaceFormat<Face>::write
(
	const fileName& filename,
