...
template<class Face>
inline bool tnbLib::MeshedSurface<Face>::isTri()
{
	return false;
}
...
template<class Face>
tnbLib::wordHashSet tnbLib::MeshedSurface<Face>::readTypes()
{
...
template<class Face>
tnbLib::wordHashSet tnbLib::MeshedSurface<Face>::writeTypes()
{
...
template<class Face>
bool tnbLib::MeshedSurface<Face>::canReadType
(
	const word& ext,
	const bool verbose
)
...
template<class Face>
bool tnbLib::MeshedSurface<Face>::canWriteType
(
	const word& ext,
	const bool verbose
)
...
template<class Face>
bool tnbLib::MeshedSurface<Face>::canRead
(
	const fileName& name,
	const bool verbose
)
...
template<class Face>
void tnbLib::MeshedSurface<Face>::write
(
	const fileName& name,
...
template<class Face>
tnbLib::MeshedSurface<Face>::MeshedSurface()
	:
...
template<class Face>
tnbLib::MeshedSurface<Face>::MeshedSurface(const surfMesh& mesh)
	:
	ParentType(List<Face>(), pointField())
{
...
template<class Face>
tnbLib::MeshedSurface<Face>::MeshedSurface(const fileName& name)
	:
	ParentType(List<Face>(), pointField())
{
	read(name);
...
template<class Face>
void tnbLib::MeshedSurface<Face>::remapFaces
(
...
template<class Face>
void tnbLib::MeshedSurface<Face>::clear()
{
	ParentType::clearOut();
...
template<class Face>
void tnbLib::MeshedSurface<Face>::movePoints(const pointField& newPoints)
{
...
template<class Face>
void tnbLib::MeshedSurface<Face>::scalePoints(const scalar scaleFactor)
{
	// avoid bad scaling
...
template<class Face>
void tnbLib::MeshedSurface<Face>::reset
(
	pointField&& pointLst,
	List<Face>&& faceLst,
	surfZoneList&& zoneLst
...
template<class Face>
void tnbLib::MeshedSurface<Face>::cleanup(const bool verbose)
{
...
template<class Face>
bool tnbLib::MeshedSurface<Face>::stitchFaces
(
	const scalar tol,
	const bool verbose
)
...
template<class Face>
bool tnbLib::MeshedSurface<Face>::checkFaces
(
	const bool verbose
)
{
...
template<class Face>
tnbLib::label tnbLib::MeshedSurface<Face>::triangulate()
{
	return triangulate
	(
...
template<class Face>
tnbLib::MeshedSurface<Face> tnbLib::MeshedSurface<Face>::subsetMesh
(
...
template<class Face>
void tnbLib::MeshedSurface<Face>::transfer
(
	MeshedSurface<Face>& surf
)
{
...
template<class Face>
bool tnbLib::MeshedSurface<Face>::read(const fileName& name)
{
	word ext = name.ext();
	if (ext == "gz")
	{
...
template<class Face>
bool tnbLib::MeshedSurface<Face>::read
(
	const fileName& name,
	const word& ext
)
...
template<class Face>
void tnbLib::MeshedSurface<Face>::operator=(const MeshedSurface& surf)
{
	clear();
...
template<class Face>
tnbLib::MeshedSurface<Face>::operator tnbLib::MeshedSurfaceProxy<Face>() const
{
...
#include <MeshedSurfaceZones.cxx>
#include <MeshedSurfaceIO.cxx>
#include <MeshedSurfaceNew.cxx>
