...
template<class Face>
tnbLib::wordHashSet tnbLib::UnsortedMeshedSurface<Face>::readTypes()
{
...
template<class Face>
tnbLib::wordHashSet tnbLib::UnsortedMeshedSurface<Face>::writeTypes()
{
...
template<class Face>
bool tnbLib::UnsortedMeshedSurface<Face>::canReadType
(
	const word& ext,
	const bool verbose
)
...
template<class Face>
bool tnbLib::UnsortedMeshedSurface<Face>::canWriteType
(
	const word& ext,
	const bool verbose
)
...
template<class Face>
bool tnbLib::UnsortedMeshedSurface<Face>::canRead
(
	const fileName& name,
	const bool verbose
)
...
template<class Face>
void tnbLib::UnsortedMeshedSurface<Face>::write
(
	const fileName& name,
...
template<class Face>
tnbLib::UnsortedMeshedSurface<Face>::UnsortedMeshedSurface()
	:
	ParentType()
{}
...
template<class Face>
tnbLib::UnsortedMeshedSurface<Face>::UnsortedMeshedSurface(const fileName& name)
	:
	ParentType()
{
	read(name);
...
template<class Face>
void tnbLib::UnsortedMeshedSurface<Face>::setOneZone()
{
...
template<class Face>
void tnbLib::UnsortedMeshedSurface<Face>::setZones
(
...
template<class Face>
void tnbLib::UnsortedMeshedSurface<Face>::remapFaces
(
...
template<class Face>
void tnbLib::UnsortedMeshedSurface<Face>::setSize(const label s)
{
...
template<class Face>
void tnbLib::UnsortedMeshedSurface<Face>::clear()
{
	ParentType::clear();
	zoneIds_.clear();
	zoneToc_.clear();
...
template<class Face>
tnbLib::surfZoneList tnbLib::UnsortedMeshedSurface<Face>::sortedZones
(
	labelList& faceMap
) const
{
	...
	forAllIter(Map<label>, lookup, iter)
	{
		...
		{
			name = word("zone") + ::tnbLib::name(zoneI);
		}
...
template<class Face>
tnbLib::UnsortedMeshedSurface<Face>
tnbLib::UnsortedMeshedSurface<Face>::subsetMesh
(
...
template<class Face>
tnbLib::UnsortedMeshedSurface<Face> tnbLib::UnsortedMeshedSurface<Face>::subsetMesh
(
	const labelHashSet& include
) const
{
...
template<class Face>
void tnbLib::UnsortedMeshedSurface<Face>::reset
(
	pointField&& pointLst,
	List<Face>&& faceLst,
	List<label>&& zoneIds
...
template<class Face>
void tnbLib::UnsortedMeshedSurface<Face>::transfer
(
	UnsortedMeshedSurface<Face>& surf
)
{
...
template<class Face>
bool tnbLib::UnsortedMeshedSurface<Face>::read(const fileName& name)
{
	word ext = name.ext();
	if (ext == "gz")
	{
...
template<class Face>
bool tnbLib::UnsortedMeshedSurface<Face>::read
(
	const fileName& name,
	const word& ext
)
...
template<class Face>
void tnbLib::UnsortedMeshedSurface<Face>::operator=
(
	const UnsortedMeshedSurface<Face>& surf
	)
{
...
template<class Face>
tnbLib::UnsortedMeshedSurface<Face>::operator
tnbLib::MeshedSurfaceProxy<Face>() const
{
	labelList faceMap;
...
#include <UnsortedMeshedSurfaceNew.cxx>
