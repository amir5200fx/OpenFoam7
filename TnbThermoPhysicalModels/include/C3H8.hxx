...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("C3H8");
		static const char* typeName_() { return "C3H8"; }
		...
		// Constructors
			...
			//- Construct null
		FoamThermophysicalModels_EXPORT C3H8();
		...
		FoamThermophysicalModels_EXPORT C3H8(const dictionary& dict);
		...
		//- Ostream Operator
		friend FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C3H8& l);
	};


	FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C3H8& l);
