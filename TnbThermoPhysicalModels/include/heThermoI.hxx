...
void tnbLib::heThermo<BasicThermo, MixtureType>::
...
template<class BasicThermo, class MixtureType>
void tnbLib::heThermo<BasicThermo, MixtureType>::init()
{
...
template<class BasicThermo, class MixtureType>
tnbLib::heThermo<BasicThermo, MixtureType>::heThermo
(
	const fvMesh& mesh,
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField> tnbLib::heThermo<BasicThermo, MixtureType>::he
(
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::scalarField> tnbLib::heThermo<BasicThermo, MixtureType>::he
(
	const scalarField& p,
	const scalarField& T,
...
tnbLib::heThermo<BasicThermo, MixtureType>::hc() const
{
	const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::scalarField> tnbLib::heThermo<BasicThermo, MixtureType>::Cp
(
	const scalarField& p,
	const scalarField& T,
	const label patchi
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::heThermo<BasicThermo, MixtureType>::Cp() const
{
	const fvMesh& mesh = this->T_.mesh();
...
tnbLib::heThermo<BasicThermo, MixtureType>::Cv
(
	const scalarField& p,
	const scalarField& T,
	const label patchi
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::heThermo<BasicThermo, MixtureType>::Cv() const
{
	const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::scalarField> tnbLib::heThermo<BasicThermo, MixtureType>::gamma
(
	const scalarField& p,
	const scalarField& T,
	const label patchi
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::heThermo<BasicThermo, MixtureType>::gamma() const
{
	const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::scalarField> tnbLib::heThermo<BasicThermo, MixtureType>::Cpv
(
	const scalarField& p,
	const scalarField& T,
	const label patchi
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::heThermo<BasicThermo, MixtureType>::Cpv() const
{
	const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::scalarField> tnbLib::heThermo<BasicThermo, MixtureType>::CpByCpv
(
	const scalarField& p,
	const scalarField& T,
	const label patchi
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::heThermo<BasicThermo, MixtureType>::CpByCpv() const
{
	const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::scalarField> tnbLib::heThermo<BasicThermo, MixtureType>::THE
(
	const scalarField& h,
	const scalarField& p,
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField> tnbLib::heThermo<BasicThermo, MixtureType>::W
(
) const
{
	const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::scalarField> tnbLib::heThermo<BasicThermo, MixtureType>::W
(
	const label patchi
) const
{
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::heThermo<BasicThermo, MixtureType>::kappa() const
{
	tmp<tnbLib::volScalarField> kappa(Cp()*this->alpha_);
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::scalarField> tnbLib::heThermo<BasicThermo, MixtureType>::kappa
(
	const label patchi
) const
{
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::heThermo<BasicThermo, MixtureType>::alphahe() const
{
	tmp<tnbLib::volScalarField> alphaEff(this->CpByCpv()*this->alpha_);
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::scalarField>
tnbLib::heThermo<BasicThermo, MixtureType>::alphahe(const label patchi) const
{
	return
		this->CpByCpv
		(
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::heThermo<BasicThermo, MixtureType>::kappaEff
(
	const volScalarField& alphat
) const
{
	tmp<tnbLib::volScalarField> kappaEff(Cp()*(this->alpha_ + alphat));
...
template<class BasicThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::heThermo<BasicThermo, MixtureType>::alphaEff
(
	const volScalarField& alphat
) const
{
	tmp<tnbLib::volScalarField> alphaEff(this->CpByCpv()*(this->alpha_ + alphat));
...
template<class BasicThermo, class MixtureType>
bool tnbLib::heThermo<BasicThermo, MixtureType>::read()
{
	if (BasicThermo::read())
	{
