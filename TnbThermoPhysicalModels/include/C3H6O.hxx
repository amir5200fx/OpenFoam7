#pragma once
#ifndef _C3H6O_Header
#define _C3H6O_Header
...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("C3H6O");
		static const char* typeName_() { return "C3H6O"; }
		...
		// Constructors
			...
			//- Construct null
		FoamThermophysicalModels_EXPORT C3H6O();
		...
		FoamThermophysicalModels_EXPORT C3H6O(const dictionary& dict);
		...
		//- Ostream Operator
		friend FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C3H6O& l);
	};


	FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C3H6O& l);
