#pragma once
#ifndef _C8H18_Header
#define _C8H18_Header
...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("C8H18");
		static const char* typeName_() { return "C8H18"; }
		...
		// Constructors
			...
			//- Construct null
		FoamThermophysicalModels_EXPORT C8H18();
		...
		FoamThermophysicalModels_EXPORT C8H18(const dictionary& dict);
		...
		//- Ostream Operator
		friend FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C8H18& l);
	};


	FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C8H18& l);
