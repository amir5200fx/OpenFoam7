...
void tnbLib::heheuPsiThermo<BasicPsiThermo, MixtureType>::calculate()
{
...
template<class BasicPsiThermo, class MixtureType>
tnbLib::heheuPsiThermo<BasicPsiThermo, MixtureType>::heheuPsiThermo
(
	const fvMesh& mesh,
...
template<class BasicPsiThermo, class MixtureType>
void tnbLib::heheuPsiThermo<BasicPsiThermo, MixtureType>::correct()
{
	if (debug)
	{
		InfoInFunction << endl;
...
tnbLib::heheuPsiThermo<BasicPsiThermo, MixtureType>::heu
(
	const scalarField& p,
...
tnbLib::heheuPsiThermo<BasicPsiThermo, MixtureType>::Tb() const
{
...
template<class BasicPsiThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::heheuPsiThermo<BasicPsiThermo, MixtureType>::psiu() const
{
...
template<class BasicPsiThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::heheuPsiThermo<BasicPsiThermo, MixtureType>::psib() const
{
...
template<class BasicPsiThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::heheuPsiThermo<BasicPsiThermo, MixtureType>::muu() const
{
...
template<class BasicPsiThermo, class MixtureType>
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::heheuPsiThermo<BasicPsiThermo, MixtureType>::mub() const
{
