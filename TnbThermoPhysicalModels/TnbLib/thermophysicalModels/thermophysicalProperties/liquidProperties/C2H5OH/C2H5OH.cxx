...
tnbLib::C2H5OH::C2H5OH(const dictionary& dict)
	:
	C2H5OH()
{
...
void tnbLib::C2H5OH::writeData(Ostream& os) const
{
...
FoamThermophysicalModels_EXPORT tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const C2H5OH& l)
{
	l.writeData(os);
	return os;
}
