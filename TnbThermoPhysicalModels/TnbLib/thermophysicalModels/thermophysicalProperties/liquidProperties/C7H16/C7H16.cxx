...
tnbLib::C7H16::C7H16(const dictionary& dict)
	:
	C7H16()
{
...
void tnbLib::C7H16::writeData(Ostream& os) const
{
...
FoamThermophysicalModels_EXPORT tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const C7H16& l)
{
	l.writeData(os);
	return os;
}
