...
tnbLib::C16H34::C16H34(const dictionary& dict)
	:
	C16H34()
{
...
void tnbLib::C16H34::writeData(Ostream& os) const
{
...
FoamThermophysicalModels_EXPORT tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const C16H34& l)
{
	l.writeData(os);
	return os;
}
