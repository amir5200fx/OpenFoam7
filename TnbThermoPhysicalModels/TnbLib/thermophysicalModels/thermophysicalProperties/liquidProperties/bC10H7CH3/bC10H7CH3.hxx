#pragma once
#ifndef _bC10H7CH3_Header
#define _bC10H7CH3_Header
...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("bC11H10");
		static const char* typeName_() { return "bC11H10"; }
		...
		// Constructors
			...
			//- Construct null
		FoamThermophysicalModels_EXPORT bC10H7CH3();
		...
		FoamThermophysicalModels_EXPORT bC10H7CH3(const dictionary& dict);
		...
		//- Ostream Operator
		friend FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const bC10H7CH3& l);
	};


	FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const bC10H7CH3& l);
...
#include <bC10H7CH3I.hxx>

#endif // !_bC10H7CH3_Header
