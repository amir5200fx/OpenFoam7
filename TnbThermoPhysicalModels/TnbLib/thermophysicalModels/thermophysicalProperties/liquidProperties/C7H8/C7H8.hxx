...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("C7H8");
		static const char* typeName_() { return "C7H8"; }
		...
		// Constructors
			...
			//- Construct null
		FoamThermophysicalModels_EXPORT C7H8();
		...
		FoamThermophysicalModels_EXPORT C7H8(const dictionary& dict);
		...
		//- Ostream Operator
		friend FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C7H8& l);
	};


	FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C7H8& l);
