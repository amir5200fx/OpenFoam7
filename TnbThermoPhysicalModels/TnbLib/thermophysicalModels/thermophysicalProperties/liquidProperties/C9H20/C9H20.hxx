#pragma once
#ifndef _C9H20_Header
#define _C9H20_Header
...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("C9H20");
		static const char* typeName_() { return "C9H20"; }
		...
		// Constructors
			...
			//- Construct null
		FoamThermophysicalModels_EXPORT C9H20();
		...
		FoamThermophysicalModels_EXPORT C9H20(const dictionary& dict);
		...
		//- Ostream Operator
		friend FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C9H20& l);
	};


	FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const C9H20& l);
