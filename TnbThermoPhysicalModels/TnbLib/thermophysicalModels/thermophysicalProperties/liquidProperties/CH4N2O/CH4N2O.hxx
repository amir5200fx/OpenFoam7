#pragma once
#ifndef _CH4N2O_Header
#define _CH4N2O_Header
...
namespace tnbLib
{
	...
	public:
		...
		//TypeName("CH4N2O");
		static const char* typeName_() { return "CH4N2O"; }
		...
		// Constructors
			...
			//- Construct null
		FoamThermophysicalModels_EXPORT CH4N2O();
		...
		FoamThermophysicalModels_EXPORT CH4N2O(const dictionary& dict);
		...
		//- Ostream Operator
		friend FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const CH4N2O& l);
	};


	FoamThermophysicalModels_EXPORT Ostream& operator<<(Ostream& os, const CH4N2O& l);
