...
tnbLib::C4H10O::C4H10O(const dictionary& dict)
	:
	C4H10O()
{
...
void tnbLib::C4H10O::writeData(Ostream& os) const
{
...
FoamThermophysicalModels_EXPORT tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const C4H10O& l)
{
	l.writeData(os);
	return os;
}
