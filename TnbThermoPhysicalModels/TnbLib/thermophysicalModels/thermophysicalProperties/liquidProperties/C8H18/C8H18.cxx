...
tnbLib::C8H18::C8H18(const dictionary& dict)
	:
	C8H18()
{
...
void tnbLib::C8H18::writeData(Ostream& os) const
{
...
FoamThermophysicalModels_EXPORT tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const C8H18& l)
{
	l.writeData(os);
	return os;
}
