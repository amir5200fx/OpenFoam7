...
tnbLib::IDEA::IDEA(const dictionary& dict)
	:
	IDEA()
{
...
void tnbLib::IDEA::writeData(Ostream& os) const
{
...
FoamThermophysicalModels_EXPORT tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const IDEA& l)
{
	l.writeData(os);
	return os;
}
