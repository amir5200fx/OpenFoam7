...
tnbLib::aC10H7CH3::aC10H7CH3(const dictionary& dict)
	:
	aC10H7CH3()
{
...
void tnbLib::aC10H7CH3::writeData(Ostream& os) const
{
...
FoamThermophysicalModels_EXPORT tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const aC10H7CH3& l)
{
	l.writeData(os);
	return os;
}
