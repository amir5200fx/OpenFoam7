...
tnbLib::TDACChemistryModel<ReactionThermo, ThermoType>::TDACChemistryModel
(
...
template<class ReactionThermo, class ThermoType>
void tnbLib::TDACChemistryModel<ReactionThermo, ThermoType>::omega
(
...
template<class ReactionThermo, class ThermoType>
tnbLib::scalar tnbLib::TDACChemistryModel<ReactionThermo, ThermoType>::omega
(
...
template<class ReactionThermo, class ThermoType>
void tnbLib::TDACChemistryModel<ReactionThermo, ThermoType>::derivatives
(
	const scalar time,
	const scalarField& c,
	scalarField& dcdt
...
template<class ReactionThermo, class ThermoType>
void tnbLib::TDACChemistryModel<ReactionThermo, ThermoType>::jacobian
(
	const scalar t,
	const scalarField& c,
	scalarField& dcdt,
...
tnbLib::scalar tnbLib::TDACChemistryModel<ReactionThermo, ThermoType>::solve
(
