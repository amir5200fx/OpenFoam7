...
void tnbLib::binaryTree<CompType, ThermoType>::insertNode
(
	chP*& phi0,
	bn*& newNode
)
...
template<class CompType, class ThermoType>
bool tnbLib::binaryTree<CompType, ThermoType>::inSubTree
(
...
template<class CompType, class ThermoType>
void tnbLib::binaryTree<CompType, ThermoType>::deleteSubTree(bn* subTreeRoot)
{
...
template<class CompType, class ThermoType>
void tnbLib::binaryTree<CompType, ThermoType>::transplant(bn* u, bn* v)
{
	if (v != nullptr)
	{
		// u is root_
...
template<class CompType, class ThermoType>
tnbLib::chemPointISAT<CompType, ThermoType>*
tnbLib::binaryTree<CompType, ThermoType>::chemPSibling(bn* y)
{
	if (y->parent() != nullptr)
	{
...
template<class CompType, class ThermoType>
tnbLib::chemPointISAT<CompType, ThermoType>*
tnbLib::binaryTree<CompType, ThermoType>::chemPSibling(chP* x)
{
	if (size_ > 1)
	{
...
template<class CompType, class ThermoType>
tnbLib::binaryNode<CompType, ThermoType>*
tnbLib::binaryTree<CompType, ThermoType>::nodeSibling(bn* y)
{
	if (y->parent() != nullptr)
	{
...
template<class CompType, class ThermoType>
tnbLib::binaryNode<CompType, ThermoType>*
tnbLib::binaryTree<CompType, ThermoType>::nodeSibling(chP* x)
{
	if (size_ > 1)
	{
		if (x == x->node()->leafLeft())
...
template<class CompType, class ThermoType>
void tnbLib::binaryTree<CompType, ThermoType>::deleteAllNode(bn* subTreeRoot)
{
	if (subTreeRoot != nullptr)
	{
...
template<class CompType, class ThermoType>
tnbLib::binaryTree<CompType, ThermoType>::binaryTree
(
...
template<class CompType, class ThermoType>
tnbLib::label tnbLib::binaryTree<CompType, ThermoType>::depth(bn* subTreeRoot)
{
...
template<class CompType, class ThermoType>
void tnbLib::binaryTree<CompType, ThermoType>::insertNewLeaf
(
	const scalarField& phiq,
...
template<class CompType, class ThermoType>
void tnbLib::binaryTree<CompType, ThermoType>::binaryTreeSearch
(
	const scalarField& phiq,
	bn* node,
	chP*& nearest
...
template<class CompType, class ThermoType>
bool tnbLib::binaryTree<CompType, ThermoType>::secondaryBTSearch
(
	const scalarField& phiq,
	chP*& x
)
...
template<class CompType, class ThermoType>
void tnbLib::binaryTree<CompType, ThermoType>::deleteLeaf(chP*& phi0)
{
...
template<class CompType, class ThermoType>
void tnbLib::binaryTree<CompType, ThermoType>::balance()
{
...
template<class CompType, class ThermoType>
tnbLib::chemPointISAT<CompType, ThermoType>*
tnbLib::binaryTree<CompType, ThermoType>::treeMin(bn* subTreeRoot)
{
	if (subTreeRoot != nullptr)
	{
...
template<class CompType, class ThermoType>
tnbLib::chemPointISAT<CompType, ThermoType>*
tnbLib::binaryTree<CompType, ThermoType>::treeSuccessor(chP* x)
{
	if (size_ > 1)
	{
		if (x == x->node()->leafLeft())
...
template<class CompType, class ThermoType>
void tnbLib::binaryTree<CompType, ThermoType>::clear()
{
...
template<class CompType, class ThermoType>
bool tnbLib::binaryTree<CompType, ThermoType>::isFull()
{
...
template<class CompType, class ThermoType>
void tnbLib::binaryTree<CompType, ThermoType>::resetNumRetrieve()
{
