...
tnbLib::chemistryTabulationMethods::ISAT<CompType, ThermoType>::ISAT
(
...
template<class CompType, class ThermoType>
void tnbLib::chemistryTabulationMethods::ISAT<CompType, ThermoType>::addToMRU
(
...
template<class CompType, class ThermoType>
void tnbLib::chemistryTabulationMethods::ISAT<CompType, ThermoType>::calcNewC
(
	chemPointISAT<CompType, ThermoType>* phi0,
...
template<class CompType, class ThermoType>
bool tnbLib::chemistryTabulationMethods::ISAT<CompType, ThermoType>::grow
(
	chemPointISAT<CompType, ThermoType>* phi0,
	const scalarField& phiq,
...
template<class CompType, class ThermoType>
bool
tnbLib::chemistryTabulationMethods::ISAT<CompType, ThermoType>::cleanAndBalance()
{
...
template<class CompType, class ThermoType>
void tnbLib::chemistryTabulationMethods::ISAT<CompType, ThermoType>::computeA
(
...
template<class CompType, class ThermoType>
bool tnbLib::chemistryTabulationMethods::ISAT<CompType, ThermoType>::retrieve
(
...
template<class CompType, class ThermoType>
tnbLib::label tnbLib::chemistryTabulationMethods::ISAT<CompType, ThermoType>::add
(
	const scalarField& phiq,
	const scalarField& Rphiq,
	const scalar rho,
...
template<class CompType, class ThermoType>
void
tnbLib::chemistryTabulationMethods::ISAT<CompType, ThermoType>::writePerformance()
{
	if (this->log())
	{
		nRetrievedFile_()
