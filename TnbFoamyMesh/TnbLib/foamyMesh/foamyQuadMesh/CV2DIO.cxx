...
void tnbLib::CV2D::writePoints(const fileName& fName, bool internalOnly) const
{
...
void tnbLib::CV2D::writeTriangles(const fileName& fName, bool internalOnly) const
{
...
void tnbLib::CV2D::writeFaces(const fileName& fName, bool internalOnly) const
{
...
void tnbLib::CV2D::extractPatches
(
    wordList& patchNames,
...
void tnbLib::CV2D::writePatch(const fileName& fName) const
{
