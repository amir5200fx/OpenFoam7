...
void tnbLib::CV2D::insertPointPair
(
...
bool tnbLib::CV2D::insertPointPairAtIntersection
(
    Triangulation::Finite_vertices_iterator& vit,
...
tnbLib::label tnbLib::CV2D::insertBoundaryConformPointPairs
(
...
void tnbLib::CV2D::markNearBoundaryPoints()
{
    label count = 0;
    for
        (
