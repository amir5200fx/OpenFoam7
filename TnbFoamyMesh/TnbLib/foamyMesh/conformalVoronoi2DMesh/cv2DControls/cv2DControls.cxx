...
tnbLib::cv2DControls::cv2DControls
(
    ...
    minCellSize2_(tnbLib::sqr(minCellSize_)),
    ...
    nearWallAlignedDist2_(tnbLib::sqr(nearWallAlignedDist_)),
    ...
    minEdgeLen2_(tnbLib::sqr(minEdgeLen_)),
    ...
    maxNotchLen2_(tnbLib::sqr(maxNotchLen_)),
    ...
    minNearPointDist2_(tnbLib::sqr(minNearPointDist_)),
...
void tnbLib::cv2DControls::write(Ostream& os) const
{
    os.indentLevel() = 1;
    os.precision(2);
...
FoamFoamyMesh_EXPORT tnbLib::Ostream& tnbLib::operator<<(Ostream& os, const cv2DControls& s)
{
    s.write(os);
    return os;
}
