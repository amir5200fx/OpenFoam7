...
#include <searchablePlateFeatures.hxx>
...
namespace tnbLib
{
    ...
    const tnbLib::label edgesArray[4][2] =
    {
        {0, 1}, // 0
        {0, 3},
        {2, 1}, // 2
...
tnbLib::edgeList tnbLib::searchablePlateFeatures::calcEdges
(
...
tnbLib::searchablePlateFeatures::searchablePlateFeatures
(
...
tnbLib::searchablePlateFeatures::features() const
{
