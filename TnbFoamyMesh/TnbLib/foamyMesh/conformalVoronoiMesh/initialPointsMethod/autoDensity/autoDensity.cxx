...
namespace tnbLib
{
    ...
    void tnbLib::autoDensity::writeOBJ
    (
    ...
    bool tnbLib::autoDensity::combinedOverlaps(const treeBoundBox& box) const
    {
        if (Pstream::parRun())
        {
            return
    ...
    bool tnbLib::autoDensity::combinedInside(const point& p) const
    {
        if (Pstream::parRun())
        {
            return
    ...
    tnbLib::Field<bool> tnbLib::autoDensity::combinedWellInside
    (
    ...
    bool tnbLib::autoDensity::combinedWellInside
    (
        const point& p,
        scalar size
    ) const
    ...
    tnbLib::label tnbLib::autoDensity::recurseAndFill
    (
    ...
    ) const
    {
        ...
        for (direction i = 0; i < 8; i++)
        {
            ...
            word newName = recursionName + "_" + tnbLib::name(i);
    ...
    bool tnbLib::autoDensity::fillBox
    (
        DynamicList<Vb::Point>& initialPoints,
        const treeBoundBox& bb,
        bool overlapping
