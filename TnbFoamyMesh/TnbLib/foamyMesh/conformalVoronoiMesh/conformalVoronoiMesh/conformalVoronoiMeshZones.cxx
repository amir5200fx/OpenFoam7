...
void tnbLib::conformalVoronoiMesh::calcNeighbourCellCentres
(
    const polyMesh& mesh,
...
void tnbLib::conformalVoronoiMesh::selectSeparatedCoupledFaces
(
    const polyMesh& mesh,
    boolList& selected
) const
...
void tnbLib::conformalVoronoiMesh::findCellZoneInsideWalk
(
    const polyMesh& mesh,
...
) const
{
    ...
    forAll(locationSurfaces, i)
    {
        ...
        const tnbLib::point& insidePoint = surfZones[surfI].zoneInsidePoint();
...
tnbLib::labelList tnbLib::conformalVoronoiMesh::calcCellZones
(
    const pointField& cellCentres
) const
{
...
void tnbLib::conformalVoronoiMesh::calcFaceZones
(
    const polyMesh& mesh,
    const pointField& cellCentres,
...
void tnbLib::conformalVoronoiMesh::addZones
(
    polyMesh& mesh,
    const pointField& cellCentres
) const
