...
void tnbLib::conformalVoronoiMesh::calcDualMesh
(
    pointField& points,
...
void tnbLib::conformalVoronoiMesh::calcTetMesh
(
    pointField& points,
...
void tnbLib::conformalVoronoiMesh::mergeIdenticalDualVertices
(
...
tnbLib::label tnbLib::conformalVoronoiMesh::mergeIdenticalDualVertices
(
    const pointField& pts,
    Map<label>& dualPtIndexMap
) const
{
            ...
            )
    {
        ...
        {
            const tnbLib::point& p1 = pts[c1I];
            const tnbLib::point& p2 = pts[c2I];
...
//void tnbLib::conformalVoronoiMesh::smoothSurface
//(
//    pointField& pts,
...
//
//
//tnbLib::label tnbLib::conformalVoronoiMesh::smoothSurfaceDualFaces
//(
//    pointField& pts,
//    const labelList& boundaryPts,
//    Map<label>& dualPtIndexMap
...
void tnbLib::conformalVoronoiMesh::deferredCollapseFaceSet
(
    labelList& owner,
    labelList& neighbour,
...
tnbLib::autoPtr<tnbLib::polyMesh>
tnbLib::conformalVoronoiMesh::createPolyMeshFromPoints
(
    const pointField& pts
) const
{
...
void tnbLib::conformalVoronoiMesh::checkCellSizing()
{
...
tnbLib::labelHashSet tnbLib::conformalVoronoiMesh::findOffsetPatchFaces
(
    const polyMesh& mesh,
...
) const
{
    ...
    forAll(patches, patchi)
    {
        ...
        forAll(localFaces, pLFI)
        {
            ...
            const tnbLib::point& faceCentre = f.centre(localPoints);
    ...
    return tnbLib::move(offsetBoundaryCells);
}


tnbLib::labelHashSet tnbLib::conformalVoronoiMesh::checkPolyMeshQuality
(
    const pointField& pts
) const
{
...
tnbLib::label tnbLib::conformalVoronoiMesh::classifyBoundaryPoint
(
    Cell_handle cit
) const
{
...
void tnbLib::conformalVoronoiMesh::indexDualVertices
(
    pointField& pts,
    labelList& boundaryPts
)
            ...
            )
    {
        ...
        if (!cit->hasFarPoint())
        {
            ...
            if (Pstream::parRun() && cit->parallelDualVertex())
            {
                ...
                pts[cit->cellIndex()] = tnbLib::point
                (
...
void tnbLib::conformalVoronoiMesh::reindexDualVertices
(
...
tnbLib::label tnbLib::conformalVoronoiMesh::createPatchInfo
(
    wordList& patchNames,
    PtrList<dictionary>& patchDicts
) const
...
tnbLib::vector tnbLib::conformalVoronoiMesh::calcSharedPatchNormal
(
    Cell_handle c1,
    Cell_handle c2
) const
{
    List<tnbLib::point> patchEdge(2, point::max);
...
bool tnbLib::conformalVoronoiMesh::boundaryDualFace
(
    Cell_handle c1,
    Cell_handle c2
) const
...
void tnbLib::conformalVoronoiMesh::createFacesOwnerNeighbourAndPatches
(
    const pointField& pts,
    faceList& faces,
    labelList& owner,
...
void tnbLib::conformalVoronoiMesh::sortFaces
(
    faceList& faces,
    labelList& owner,
    labelList& neighbour
...
void tnbLib::conformalVoronoiMesh::sortProcPatches
(
...
void tnbLib::conformalVoronoiMesh::addPatches
(
...
void tnbLib::conformalVoronoiMesh::removeUnusedPoints
(
    faceList& faces,
    pointField& pts,
    labelList& boundaryPts
...
tnbLib::labelList tnbLib::conformalVoronoiMesh::removeUnusedCells
(
    labelList& owner,
    labelList& neighbour
) const
