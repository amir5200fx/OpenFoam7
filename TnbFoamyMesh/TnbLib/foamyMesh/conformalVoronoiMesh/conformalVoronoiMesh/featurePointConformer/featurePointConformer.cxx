...
const tnbLib::scalar tnbLib::featurePointConformer::tolParallel = 1e-3;


// * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * //

tnbLib::vector tnbLib::featurePointConformer::sharedFaceNormal
(
...
tnbLib::label tnbLib::featurePointConformer::getSign
(
...
void tnbLib::featurePointConformer::addMasterAndSlavePoints
(
    const DynamicList<tnbLib::point>& masterPoints,
    const DynamicList<tnbLib::indexedVertexEnum::vertexType>& masterPointsTypes,
...
) const
{
    ...
    forAll(masterPoints, pI)
    {
        ...
        const tnbLib::point& masterPt = masterPoints[pI];
        ...
        forAll(masterPointPlanes, planeI)
        {
            ...
            const tnbLib::point slavePt = reflPlane.mirror(masterPt);
...
void tnbLib::featurePointConformer::createMasterAndSlavePoints
(
    const extendedFeatureEdgeMesh& feMesh,
    const label ptI,
    DynamicList<Vb>& pts
) const
{
    ...
    const tnbLib::point& featPt = feMesh.points()[ptI];
    ...
    DynamicList<tnbLib::point> masterPoints;
    ...
    if (circ.size()) do
    {
        ...
        if (masterPoints.empty())
        {
            ...
            tnbLib::point pt = featPt + pointMotionDirection;
...
//            const tnbLib::point reflectedPoint = reflectPointInPlane
//            (
//                masterPoints.last(),
//                firstPlane.last()()
//            );
...
void tnbLib::featurePointConformer::createMixedFeaturePoints
(
    DynamicList<Vb>& pts
) const
{
    ...
    forAll(feMeshes, i)
    {
        ...
        {
            const tnbLib::point& featPt = points[ptI];
...
//                createFeaturePoints(feMesh, ptI, pts, types);
                ...
                const tnbLib::point& pt = points[ptI];
...
void tnbLib::featurePointConformer::createFeaturePoints(DynamicList<Vb>& pts)
{
    const PtrList<extendedFeatureEdgeMesh>& feMeshes
    (
        geometryToConformTo_.features()
...
tnbLib::featurePointConformer::featurePointConformer
(
...
void tnbLib::featurePointConformer::distribute
(
...
void tnbLib::featurePointConformer::reIndexPointPairs
(
