...
void tnbLib::conformalVoronoiMesh::cellSizeMeshOverlapsBackground() const
{
    const cellShapeControlMesh& cellSizeMesh =
        cellShapeControl_.shapeControlMesh();

    DynamicList<tnbLib::point> pts(number_of_vertices());
...
void tnbLib::conformalVoronoiMesh::insertInternalPoints
(
    List<Point>& points,
    bool distribute
)
{
    ...
    {
        List<tnbLib::point> transferPoints(points.size());
        ...
        // place
        tnbLib::autoPtr<tnbLib::mapDistribute> map
        (
...
tnbLib::Map<tnbLib::label> tnbLib::conformalVoronoiMesh::insertPointPairs
(
    List<Vb>& vertices,
    bool distribute,
    bool reIndex
...
void tnbLib::conformalVoronoiMesh::insertSurfacePointPairs
(
...
)
{
    forAll(surfaceHits, i)
    {
        ...
        const tnbLib::point& surfacePt(surfaceHit.hitPoint());
...
void tnbLib::conformalVoronoiMesh::insertEdgePointGroups
(
...
bool tnbLib::conformalVoronoiMesh::nearFeaturePt(const tnbLib::point& pt) const
{
...
bool tnbLib::conformalVoronoiMesh::surfacePtNearFeatureEdge
(
...
void tnbLib::conformalVoronoiMesh::insertInitialPoints()
{
    ...
    if (foamyHexMeshControls().objOutput())
    {
        ...
        (
            ...
            *this,
            tnbLib::indexedVertexEnum::vtInternal
        );
    }
}


void tnbLib::conformalVoronoiMesh::distribute()
{
    if (!Pstream::parRun())
    {
        return;
    ...
    DynamicList<tnbLib::point> points(number_of_vertices());
    DynamicList<tnbLib::indexedVertexEnum::vertexType> types
    (
        number_of_vertices()
    );
...
void tnbLib::conformalVoronoiMesh::buildCellSizeAndAlignmentMesh()
{
...
void tnbLib::conformalVoronoiMesh::setVertexSizeAndAlignment()
{
...
tnbLib::face tnbLib::conformalVoronoiMesh::buildDualFace
(
...
tnbLib::label tnbLib::conformalVoronoiMesh::maxFilterCount
(
    const Delaunay::Finite_edges_iterator& eit
) const
{
...
bool tnbLib::conformalVoronoiMesh::ownerAndNeighbour
(
    Vertex_handle vA,
    Vertex_handle vB,
    label& owner,
...
tnbLib::conformalVoronoiMesh::conformalVoronoiMesh
(
    const Time& runTime,
...
void tnbLib::conformalVoronoiMesh::initialiseForMotion()
{
    if (foamyHexMeshControls().objOutput())
    {
    ...
    if (foamyHexMeshControls().objOutput())
    {
        ...
        (
            ...
            *this,
            tnbLib::indexedVertexEnum::vtUnassigned,
            tnbLib::indexedVertexEnum::vtExternalFeaturePoint
        );
    }
}


void tnbLib::conformalVoronoiMesh::initialiseForConformation()
{
    if (Pstream::parRun())
    {
...
void tnbLib::conformalVoronoiMesh::move()
{
                ...
                )
        {
            ...
            if (rABMag < small)
            {
                        ...
                        )
                {
                    ...
                    {
                        const tnbLib::point pt(0.5 * (dVA + dVB));
            ...
            > foamyHexMeshControls().insertionDistCoeff()
                            ...
                            )
                    {
                        ...
                        {
                            const tnbLib::point newPt(0.5 * (dVA + dVB));
    ...
    if (foamyHexMeshControls().objOutput())
    {
        ...
        if (reconformToSurface())
        {
            ...
            (
                ...
                + ".obj",
                *this,
                tnbLib::indexedVertexEnum::vtInternalSurface,
                tnbLib::indexedVertexEnum::vtInternalFeaturePoint
            );
            ...
            (
                ...
                + ".obj",
                *this,
                tnbLib::indexedVertexEnum::vtExternalSurface,
                tnbLib::indexedVertexEnum::vtExternalFeaturePoint
            );
                    ...
                    )
            {
                ...
                tnbLib::point ptA(topoint(vA->point()));
                tnbLib::point ptB(topoint(vB->point()));
...
void tnbLib::conformalVoronoiMesh::checkCoPlanarCells() const
{
