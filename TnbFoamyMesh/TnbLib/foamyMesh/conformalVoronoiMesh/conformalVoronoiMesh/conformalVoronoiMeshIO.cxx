...
void tnbLib::conformalVoronoiMesh::timeCheck
(
...
void tnbLib::conformalVoronoiMesh::writeMesh(const fileName& instance)
{
...
tnbLib::autoPtr<tnbLib::fvMesh> tnbLib::conformalVoronoiMesh::createDummyMesh
(
    const IOobject& io,
...
void tnbLib::conformalVoronoiMesh::checkProcessorPatchesMatch
(
    const PtrList<dictionary>& patchDicts
) const
{
...
void tnbLib::conformalVoronoiMesh::reorderPoints
(
    pointField& points,
    labelList& boundaryPts,
    faceList& faces,
...
void tnbLib::conformalVoronoiMesh::reorderProcessorPatches
(
    const word& meshName,
...
void tnbLib::conformalVoronoiMesh::writeMesh
(
    const word& meshName,
    const fileName& instance,
    pointField& points,
...
void tnbLib::conformalVoronoiMesh::writeCellSizes
(
    const fvMesh& mesh
) const
{
...
void tnbLib::conformalVoronoiMesh::writeCellAlignments
(
    const fvMesh& mesh
) const
{
...
void tnbLib::conformalVoronoiMesh::writeCellCentres
(
    const fvMesh& mesh
) const
{
...
tnbLib::labelHashSet tnbLib::conformalVoronoiMesh::findRemainingProtrusionSet
(
    const polyMesh& mesh
) const
{
    ...
    forAll(patches, patchi)
    {
        ...
        forAll(patch.localPoints(), pLPI)
        {
            ...
            const tnbLib::point& pt = patch.localPoints()[pLPI];
    ...
    return tnbLib::move(protrudingCells);
}


void tnbLib::conformalVoronoiMesh::writePointPairs
(
