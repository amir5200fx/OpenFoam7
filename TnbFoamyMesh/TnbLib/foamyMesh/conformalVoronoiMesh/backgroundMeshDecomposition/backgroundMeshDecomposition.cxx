...
tnbLib::autoPtr<tnbLib::mapDistribute> tnbLib::backgroundMeshDecomposition::buildMap
(
...
void tnbLib::backgroundMeshDecomposition::initialRefinement()
{
...
void tnbLib::backgroundMeshDecomposition::printMeshData
(
    const polyMesh& mesh
) const
{
...
bool tnbLib::backgroundMeshDecomposition::refineCell
(
    label celli,
    volumeType volType,
...
tnbLib::labelList tnbLib::backgroundMeshDecomposition::selectRefinementCells
(
    List<volumeType>& volumeStatus,
    volScalarField& cellWeights
) const
...
void tnbLib::backgroundMeshDecomposition::buildPatchAndTree()
{
...
tnbLib::backgroundMeshDecomposition::backgroundMeshDecomposition
(
    const Time& runTime,
    Random& rndGen,
...
tnbLib::autoPtr<tnbLib::mapDistributePolyMesh>
tnbLib::backgroundMeshDecomposition::distribute
(
    volScalarField& cellWeights
)
{
...
bool tnbLib::backgroundMeshDecomposition::positionOnThisProcessor
(
    const point& pt
) const
{
...
tnbLib::boolList tnbLib::backgroundMeshDecomposition::positionOnThisProcessor
(
...
bool tnbLib::backgroundMeshDecomposition::overlapsThisProcessor
(
...
tnbLib::pointIndexHit tnbLib::backgroundMeshDecomposition::findLine
(
    const point& start,
    const point& end
) const
...
tnbLib::pointIndexHit tnbLib::backgroundMeshDecomposition::findLineAny
(
    const point& start,
    const point& end
) const
...
tnbLib::labelList tnbLib::backgroundMeshDecomposition::processorNearestPosition
(
    const List<point>& pts
) const
{
...
tnbLib::List<tnbLib::List<tnbLib::pointIndexHit>>
tnbLib::backgroundMeshDecomposition::intersectsProcessors
(
...
bool tnbLib::backgroundMeshDecomposition::overlapsOtherProcessors
(
    const point& centre,
    const scalar& radiusSqr
) const
...
tnbLib::labelList tnbLib::backgroundMeshDecomposition::overlapProcessors
(
    const point& centre,
    const scalar radiusSqr
) const
...
//            if (bFTreePtr_().findNearest(centre, radiusSqr).hit())
    ...
    return tnbLib::move(toProc);
}


//tnbLib::labelListList tnbLib::backgroundMeshDecomposition::overlapsProcessors
//(
...
//tnbLib::labelListList tnbLib::backgroundMeshDecomposition::overlapProcessors
//(
//    const point& cc,
//    const scalar rSqr
//) const
