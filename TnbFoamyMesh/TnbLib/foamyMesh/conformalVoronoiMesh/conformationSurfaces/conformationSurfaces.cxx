...
void tnbLib::conformationSurfaces::hasBoundedVolume
(
...
void tnbLib::conformationSurfaces::readFeatures
(
    const label surfI,
...
tnbLib::conformationSurfaces::conformationSurfaces
(
    const Time& runTime,
    Random& rndGen,
...
bool tnbLib::conformationSurfaces::overlaps(const treeBoundBox& bb) const
{
    forAll(surfaces_, s)
    {
...
tnbLib::Field<bool> tnbLib::conformationSurfaces::inside
(
...
bool tnbLib::conformationSurfaces::inside
(
...
tnbLib::Field<bool> tnbLib::conformationSurfaces::outside
(
    const pointField& samplePts
) const
{
...
bool tnbLib::conformationSurfaces::outside
(
    const point& samplePt
) const
{
...
tnbLib::Field<bool> tnbLib::conformationSurfaces::wellInOutSide
(
    const pointField& samplePts,
...
tnbLib::Field<bool> tnbLib::conformationSurfaces::wellInside
(
    const pointField& samplePts,
    const scalarField& testDistSqr
) const
...
bool tnbLib::conformationSurfaces::wellInside
(
    const point& samplePt,
    scalar testDistSqr
) const
...
tnbLib::Field<bool> tnbLib::conformationSurfaces::wellOutside
(
    const pointField& samplePts,
    const scalarField& testDistSqr
) const
...
bool tnbLib::conformationSurfaces::wellOutside
(
    const point& samplePt,
    scalar testDistSqr
) const
...
bool tnbLib::conformationSurfaces::findSurfaceAnyIntersection
(
    const point& start,
    const point& end
) const
...
void tnbLib::conformationSurfaces::findSurfaceAnyIntersection
(
    const point& start,
    const point& end,
    pointIndexHit& surfHit,
...
void tnbLib::conformationSurfaces::findSurfaceAllIntersections
(
    const point& start,
    const point& end,
...
void tnbLib::conformationSurfaces::findSurfaceNearestIntersection
(
    const point& start,
    const point& end,
    pointIndexHit& surfHit,
...
void tnbLib::conformationSurfaces::findSurfaceNearest
(
    const point& sample,
...
void tnbLib::conformationSurfaces::findFeaturePointNearest
(
    const point& sample,
    scalar nearestDistSqr,
    pointIndexHit& fpHit,
...
void tnbLib::conformationSurfaces::findEdgeNearest
(
    const point& sample,
    scalar nearestDistSqr,
...
void tnbLib::conformationSurfaces::findEdgeNearestByType
(
    const point& sample,
    scalar nearestDistSqr,
    List<pointIndexHit>& edgeHits,
...
void tnbLib::conformationSurfaces::findAllNearestEdges
(
    const point& sample,
...
void tnbLib::conformationSurfaces::writeFeatureObj(const fileName& prefix) const
{
...
tnbLib::label tnbLib::conformationSurfaces::findPatch
(
    const point& ptA,
    const point& ptB
) const
...
tnbLib::label tnbLib::conformationSurfaces::findPatch(const point& pt) const
{
    pointIndexHit surfHit;
    label hitSurface;
...
tnbLib::label tnbLib::conformationSurfaces::getPatchID
(
...
tnbLib::extendedFeatureEdgeMesh::sideVolumeType
tnbLib::conformationSurfaces::meshableSide
(
    const label hitSurface,
    const pointIndexHit& surfHit
) const
...
void tnbLib::conformationSurfaces::getNormal
(
    const label hitSurface,
