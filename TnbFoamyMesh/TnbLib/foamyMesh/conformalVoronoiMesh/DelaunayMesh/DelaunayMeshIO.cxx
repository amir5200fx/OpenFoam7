...
void tnbLib::DelaunayMesh<Triangulation>::sortFaces
(
    faceList& faces,
    labelList& owner,
    labelList& neighbour
...
template<class Triangulation>
void tnbLib::DelaunayMesh<Triangulation>::addPatches
(
...
template<class Triangulation>
void tnbLib::DelaunayMesh<Triangulation>::printInfo(Ostream& os) const
{
...
template<class Triangulation>
void tnbLib::DelaunayMesh<Triangulation>::printVertexInfo(Ostream& os) const
{
    label nInternal = 0;
...
tnbLib::DelaunayMesh<Triangulation>::createMesh
(
    const fileName& name,
