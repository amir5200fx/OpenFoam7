...
#include <searchableSurfaceControl.hxx>
...
tnbLib::cellShapeControl::cellShapeControl
(
    const Time& runTime,
...
tnbLib::scalarField tnbLib::cellShapeControl::cellSize
(
...
tnbLib::scalar tnbLib::cellShapeControl::cellSize(const point& pt) const
{
    barycentric bary;
...
tnbLib::tensor tnbLib::cellShapeControl::cellAlignment(const point& pt) const
{
    barycentric bary;
    cellShapeControlMesh::Cell_handle ch;
...
void tnbLib::cellShapeControl::cellSizeAndAlignment
(
    const point& pt,
    scalar& size,
    tensor& alignment
