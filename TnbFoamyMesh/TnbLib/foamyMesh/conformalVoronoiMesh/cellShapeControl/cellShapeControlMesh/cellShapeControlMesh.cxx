...
//tnbLib::tensor tnbLib::cellShapeControlMesh::requiredAlignment
//(
...
//        vector spoke
//        (
//            tnbLib::cos(i*constant::mathematical::twoPi/s),
//            tnbLib::sin(i*constant::mathematical::twoPi/s),
//            0
//        );
//
//        spoke *= spanMag;
...
tnbLib::label tnbLib::cellShapeControlMesh::removePoints()
{
    label nRemoved = 0;
    for
        (
...
tnbLib::tmp<tnbLib::pointField> tnbLib::cellShapeControlMesh::cellCentres() const
{
            ...
            )
    {
        ...
        const tnbLib::point centre = topoint
        (
            CGAL::centroid<baseK>
            (
                c->vertex(0)->point(),
...
void tnbLib::cellShapeControlMesh::writeTriangulation()
{
    OFstream str
    (
...
tnbLib::cellShapeControlMesh::cellShapeControlMesh(const Time& runTime)
    :
...
tnbLib::cellShapeControlMesh::~cellShapeControlMesh()
{}


// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //

void tnbLib::cellShapeControlMesh::barycentricCoords
(
    const tnbLib::point& pt,
    barycentric& bary,
    Cell_handle& ch
...
tnbLib::boundBox tnbLib::cellShapeControlMesh::bounds() const
{
...
void tnbLib::cellShapeControlMesh::distribute
(
...
tnbLib::tensorField tnbLib::cellShapeControlMesh::dumpAlignments() const
{
...
void tnbLib::cellShapeControlMesh::write() const
{
...
tnbLib::label tnbLib::cellShapeControlMesh::estimateCellCount
(
