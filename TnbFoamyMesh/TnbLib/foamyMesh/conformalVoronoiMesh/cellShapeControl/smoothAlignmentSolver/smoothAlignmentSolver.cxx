...
tnbLib::tmp<tnbLib::Field<Type>> tnbLib::smoothAlignmentSolver::filterFarPoints
(
...
tnbLib::autoPtr<tnbLib::mapDistribute> tnbLib::smoothAlignmentSolver::buildReferredMap
(
    const Triangulation& mesh,
    labelList& indices
)
...
template<class Triangulation>
tnbLib::autoPtr<tnbLib::mapDistribute> tnbLib::smoothAlignmentSolver::buildMap
(
    const Triangulation& mesh,
...
template<class Triangulation>
tnbLib::tmp<tnbLib::triadField> tnbLib::smoothAlignmentSolver::buildAlignmentField
(
    const Triangulation& mesh
)
{
...
template<class Triangulation>
tnbLib::tmp<tnbLib::pointField> tnbLib::smoothAlignmentSolver::buildPointField
(
    const Triangulation& mesh
)
{
...
void tnbLib::smoothAlignmentSolver::applyBoundaryConditions
(
...
tnbLib::smoothAlignmentSolver::smoothAlignmentSolver(cellShapeControlMesh& mesh)
    :
    mesh_(mesh)
{}
...
tnbLib::smoothAlignmentSolver::~smoothAlignmentSolver()
{}


// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //

void tnbLib::smoothAlignmentSolver::smoothAlignments
(
