...
tnbLib::scalar tnbLib::controlMeshRefinement::calcFirstDerivative
(
...
//tnbLib::scalar tnbLib::controlMeshRefinement::calcSecondDerivative
//(
//    const tnbLib::point& a,
//    const scalar& cellSizeA,
...
bool tnbLib::controlMeshRefinement::detectEdge
(
...
{
    tnbLib::point a(startPt);
    tnbLib::point b(endPt);

    tnbLib::point midPoint = (a + b) / 2.0;
    ...
    while (true)
    {
        ...
        // Region 1
        tnbLib::point midPoint1 = (a + midPoint) / 2.0;
        ...
        // Region 2
        tnbLib::point midPoint2 = (midPoint + b) / 2.0;
...
tnbLib::pointHit tnbLib::controlMeshRefinement::findDiscontinuities
(
...
tnbLib::controlMeshRefinement::controlMeshRefinement
(
...
void tnbLib::controlMeshRefinement::initialMeshPopulation
(
...
)
{
    ...
    forAll(controlFunctions, fI)
    {
        ...
        DynamicList<tnbLib::point> extraPts;
...
tnbLib::label tnbLib::controlMeshRefinement::refineMesh
(
    const autoPtr<backgroundMeshDecomposition>& decomposition
)
{
            ...
            )
    {
        ...
        if (hitPt.hit())
        {
            const tnbLib::point& pt = hitPt.hitPoint();
