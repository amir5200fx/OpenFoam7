...
bool tnbLib::cellSizeAndAlignmentControls::evalCellSizeFunctions
(
    const point& pt,
    scalar& minSize,
    label& maxPriority
...
tnbLib::cellSizeAndAlignmentControls::cellSizeAndAlignmentControls
(
    const Time& runTime,
...
tnbLib::scalar tnbLib::cellSizeAndAlignmentControls::cellSize
(
    const point& pt
) const
{
