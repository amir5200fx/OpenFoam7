...
//tnbLib::tensor tnbLib::surfaceControl::requiredAlignment
//(
...
tnbLib::searchableSurfaceControl::searchableSurfaceControl
(
    const Time& runTime,
    const word& name,
...
void tnbLib::searchableSurfaceControl::initialVertices
(
    pointField& pts,
    scalarField& sizes,
...
void tnbLib::searchableSurfaceControl::cellSizeFunctionVertices
(
...
bool tnbLib::searchableSurfaceControl::cellSize
(
    const tnbLib::point& pt,
    scalar& cellSize,
    label& priority
