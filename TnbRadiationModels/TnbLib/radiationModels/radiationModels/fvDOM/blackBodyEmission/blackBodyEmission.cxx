...
const tnbLib::List<tnbLib::Tuple2<tnbLib::scalar, tnbLib::scalar>>
tnbLib::radiationModels::blackBodyEmission::emissivePowerTable
(
	IStringStream
	(
		"("
...
tnbLib::radiationModels::blackBodyEmission::blackBodyEmission
(
	const label nLambda,
...
tnbLib::scalar tnbLib::radiationModels::blackBodyEmission::fLambdaT
(
...
tnbLib::radiationModels::blackBodyEmission::deltaLambdaT
(
	const volScalarField& T,
...
tnbLib::tmp<tnbLib::volScalarField>
tnbLib::radiationModels::blackBodyEmission::EbDeltaLambdaT
(
	const volScalarField& T,
	const Vector2D<scalar>& band
) const
...
void tnbLib::radiationModels::blackBodyEmission::correct
(
	const label lambdaI,
	const Vector2D<scalar>& band
)
