...
void tnbLib::radiationModels::viewFactor::initialise()
{
...
tnbLib::radiationModels::viewFactor::viewFactor(const volScalarField& T)
	:
...
tnbLib::radiationModels::viewFactor::viewFactor
(
...
bool tnbLib::radiationModels::viewFactor::read()
{
...
void tnbLib::radiationModels::viewFactor::insertMatrixElements
(
...
void tnbLib::radiationModels::viewFactor::calculate()
{
...
tnbLib::tmp<tnbLib::volScalarField> tnbLib::radiationModels::viewFactor::Rp() const
{
...
tnbLib::radiationModels::viewFactor::Ru() const
{
