...
tnbLib::labelList tnbLib::medialAxisMeshMover::getFixedValueBCs
(
...
)
{
	...
	return tnbLib::move(adaptPatchIDs);
}


tnbLib::autoPtr<tnbLib::indirectPrimitivePatch>
tnbLib::medialAxisMeshMover::getPatch
(
	const polyMesh& mesh,
...
void tnbLib::medialAxisMeshMover::smoothPatchNormals
(
...
void tnbLib::medialAxisMeshMover::smoothNormals
(
	const label nSmoothDisp,
...
bool tnbLib::medialAxisMeshMover::isMaxEdge
(
...
void tnbLib::medialAxisMeshMover::update(const dictionary& coeffDict)
{
	Info << typeName
	...
	scalar minMedialAxisAngleCos = tnbLib::cos
	(
	...
	//    wall.
	{
		...
		forAll(patches, patchi)
		{
					...
					)
			{
				...
				else
				{
					...
					scalar slipFeatureAngleCos = tnbLib::cos
					(
		...
		forAll(pointMedialDist, pointi)
		{
			if (pointMedialDist[pointi].valid(dummyTrackData))
			{
				medialDist_[pointi] = tnbLib::sqrt
				(
	...
	forAll(medialRatio_, pointi)
	{
		...
		else
		{
			...
			{
				medialRatio_[pointi] = mDist / (tnbLib::sqrt(wDist2) + mDist);
			}
		}
	}
...
bool tnbLib::medialAxisMeshMover::unmarkExtrusion
(
...
void tnbLib::medialAxisMeshMover::syncPatchDisplacement
(
...
void tnbLib::medialAxisMeshMover::minSmoothField
(
	const label nSmoothDisp,
	const PackedBoolList& isPatchMasterPoint,
	const PackedBoolList& isPatchMasterEdge,
...
// large feature angle
void tnbLib::medialAxisMeshMover::
...
void tnbLib::medialAxisMeshMover::findIsolatedRegions
(
...
void tnbLib::medialAxisMeshMover::smoothLambdaMuDisplacement
(
	const label nSmoothDisp,
	const PackedBoolList& isMeshMasterPoint,
	const PackedBoolList& isMeshMasterEdge,
...
tnbLib::medialAxisMeshMover::medialAxisMeshMover
(
...
void tnbLib::medialAxisMeshMover::calculateDisplacement
(
...
)
{
	...
	const scalar minCosLayerTermination = tnbLib::cos
	(
...
bool tnbLib::medialAxisMeshMover::shrinkMesh
(
...
bool tnbLib::medialAxisMeshMover::move
(
...
void tnbLib::medialAxisMeshMover::movePoints(const pointField& p)
{
