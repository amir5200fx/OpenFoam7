...
void tnbLib::refinementFeatures::read
(
...
void tnbLib::refinementFeatures::buildTrees(const label featI)
{
	const extendedEdgeMesh& eMesh = operator[](featI);
...
void tnbLib::refinementFeatures::findHigherLevel
(
	const pointField& pt,
	const label featI,
	labelList& maxLevel
...
tnbLib::refinementFeatures::regionEdgeTrees() const
{
...
tnbLib::refinementFeatures::refinementFeatures
(
	const objectRegistry& io,
	const PtrList<dictionary>& featDicts
)
...
void tnbLib::refinementFeatures::findNearestEdge
(
...
void tnbLib::refinementFeatures::findNearestRegionEdge
(
	const pointField& samples,
	const scalarField& nearestDistSqr,
	labelList& nearFeature,
...
//void tnbLib::refinementFeatures::findNearestPoint
//(
//    const pointField& samples,
//    const scalarField& nearestDistSqr,
//    labelList& nearFeature,
...
tnbLib::scalar tnbLib::refinementFeatures::maxDistance() const
{
