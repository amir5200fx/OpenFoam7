#include <snappyRefineDriver.hxx>
...
tnbLib::snappyRefineDriver::snappyRefineDriver
(
...
tnbLib::label tnbLib::snappyRefineDriver::featureEdgeRefine
(
...
tnbLib::label tnbLib::snappyRefineDriver::surfaceOnlyRefine
(
	const refinementParameters& refineParams,
	const label maxIter
)
...
tnbLib::label tnbLib::snappyRefineDriver::gapOnlyRefine
(
	const refinementParameters& refineParams,
	const label maxIter
)
...
tnbLib::label tnbLib::snappyRefineDriver::danglingCellRefine
(
	const refinementParameters& refineParams,
	const label nFaces,
	const label maxIter
...
void tnbLib::snappyRefineDriver::removeInsideCells
(
	const refinementParameters& refineParams,
...
tnbLib::label tnbLib::snappyRefineDriver::shellRefine
(
	const refinementParameters& refineParams,
	const label maxIter
)
...
void tnbLib::snappyRefineDriver::baffleAndSplitMesh
(
	const refinementParameters& refineParams,
...
void tnbLib::snappyRefineDriver::zonify
(
	const refinementParameters& refineParams
)
{
...
void tnbLib::snappyRefineDriver::splitAndMergeBaffles
(
	const refinementParameters& refineParams,
	const snapParameters& snapParams,
	const bool handleSnapProblems,
...
void tnbLib::snappyRefineDriver::mergePatchFaces
(
	const refinementParameters& refineParams,
	const dictionary& motionDict
)
{
	...
	meshRefiner_.mergeEdgesUndo(tnbLib::cos(degToRad(45.0)), motionDict);
...
void tnbLib::snappyRefineDriver::doRefine
(
