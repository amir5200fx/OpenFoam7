...
void tnbLib::snappyLayerDriver::dumpDisplacement
(
...
tnbLib::tmp<tnbLib::scalarField> tnbLib::snappyLayerDriver::avgPointData
(
	const indirectPrimitivePatch& pp,
...
// points in pointSet.
void tnbLib::snappyLayerDriver::checkManifold
(
...
void tnbLib::snappyLayerDriver::checkMeshManifold() const
{
...
bool tnbLib::snappyLayerDriver::unmarkExtrusion
(
...
void tnbLib::snappyLayerDriver::handleNonManifolds
(
	const indirectPrimitivePatch& pp,
...
void tnbLib::snappyLayerDriver::handleFeatureAngle
(
	const indirectPrimitivePatch& pp,
	const labelList& meshEdges,
	const scalar minCos,
...
// the face.
void tnbLib::snappyLayerDriver::handleWarpedFaces
(
	const indirectPrimitivePatch& pp,
...
//void tnbLib::snappyLayerDriver::handleMultiplePatchFaces
//(
//    const indirectPrimitivePatch& pp,
//    pointField& patchDisp,
//    labelList& patchNLayers,
...
void tnbLib::snappyLayerDriver::setNumLayers
(
...
tnbLib::snappyLayerDriver::makeLayerDisplacementField
(
...
void tnbLib::snappyLayerDriver::growNoExtrusion
(
	const indirectPrimitivePatch& pp,
	pointField& patchDisp,
	labelList& patchNLayers,
...
void tnbLib::snappyLayerDriver::determineSidePatches
(
...
void tnbLib::snappyLayerDriver::calculateLayerThickness
(
	const indirectPrimitivePatch& pp,
	const labelList& patchIDs,
...
void tnbLib::snappyLayerDriver::syncPatchDisplacement
(
	const indirectPrimitivePatch& pp,
...
// patch point.
void tnbLib::snappyLayerDriver::getPatchDisplacement
(
	const indirectPrimitivePatch& pp,
...
bool tnbLib::snappyLayerDriver::sameEdgeNeighbour
(
...
void tnbLib::snappyLayerDriver::getVertexString
(
	const indirectPrimitivePatch& pp,
	const labelListList& globalEdgeFaces,
	const label facei,
...
tnbLib::label tnbLib::snappyLayerDriver::truncateDisplacement
(
	const globalIndex& globalFaces,
	const labelListList& edgeGlobalFaces,
	const indirectPrimitivePatch& pp,
...
void tnbLib::snappyLayerDriver::setupLayerInfoTruncation
(
	const indirectPrimitivePatch& pp,
	const labelList& patchNLayers,
	const List<extrudeMode>& extrudeStatus,
...
bool tnbLib::snappyLayerDriver::cellsUseFace
(
	const polyMesh& mesh,
...
tnbLib::label tnbLib::snappyLayerDriver::checkAndUnmark
(
...
tnbLib::label tnbLib::snappyLayerDriver::countExtrusion
(
	const indirectPrimitivePatch& pp,
	const List<extrudeMode>& extrudeStatus
)
...
void tnbLib::snappyLayerDriver::getLayerCellsFaces
(
	const polyMesh& mesh,
	const addPatchCellLayer& addLayer,
...
void tnbLib::snappyLayerDriver::printLayerData
(
	const fvMesh& mesh,
	const labelList& patchIDs,
...
bool tnbLib::snappyLayerDriver::writeLayerData
(
	const fvMesh& mesh,
	const labelList& patchIDs,
	const labelList& cellNLayers,
...
tnbLib::snappyLayerDriver::snappyLayerDriver
(
...
void tnbLib::snappyLayerDriver::mergePatchFacesUndo
(
	const layerParameters& layerParams,
...
)
{
	...
	scalar minCos = tnbLib::cos(degToRad(planarAngle));

	scalar concaveCos = tnbLib::cos(degToRad(layerParams.concaveAngle()));
...
void tnbLib::snappyLayerDriver::addLayers
(
	const layerParameters& layerParams,
	const dictionary& motionDict,
	const labelList& patchIDs,
...
void tnbLib::snappyLayerDriver::doLayers
(
