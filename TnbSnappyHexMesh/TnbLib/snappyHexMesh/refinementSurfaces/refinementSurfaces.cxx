...
tnbLib::refinementSurfaces::refinementSurfaces
(
...
// tnbLib::labelList tnbLib::refinementSurfaces::countRegions(const triSurface& s)
// {
...
// void tnbLib::refinementSurfaces::wantedRefinementLevel
// (
...
// surface.
void tnbLib::refinementSurfaces::setMinLevelFields
(
	const shellSurfaces& shells
)
{
...
// number.
void tnbLib::refinementSurfaces::findHigherIntersection
(
...
void tnbLib::refinementSurfaces::findAllHigherIntersections
(
	const pointField& start,
	const pointField& end,
	const labelList& currentLevel,   // current cell refinement level
...
void tnbLib::refinementSurfaces::findNearestIntersection
(
...
void tnbLib::refinementSurfaces::findAnyIntersection
(
	const pointField& start,
	const pointField& end,
...
void tnbLib::refinementSurfaces::findNearest
(
	const labelList& surfacesToTest,
...
void tnbLib::refinementSurfaces::findNearestRegion
(
	const labelList& surfacesToTest,
	const pointField& samples,
	const scalarField& nearestDistSqr,
...
//tnbLib::label tnbLib::refinementSurfaces::findHighestIntersection
//(
//    const point& start,
//    const point& end,
...
void tnbLib::refinementSurfaces::findInside
(
