...
tnbLib::labelList tnbLib::meshRefinement::getChangedFaces
(
...
// refinement
bool tnbLib::meshRefinement::markForRefine
(
...
void tnbLib::meshRefinement::markFeatureCellLevel
(
...
tnbLib::label tnbLib::meshRefinement::markFeatureRefinement
(
	const pointField& keepPoints,
	const label nAllowRefine,
...
tnbLib::label tnbLib::meshRefinement::markInternalDistanceToFeatureRefinement
(
	const label nAllowRefine,
...
tnbLib::label tnbLib::meshRefinement::markInternalRefinement
(
	const label nAllowRefine,
...
// for refinement.
tnbLib::labelList tnbLib::meshRefinement::getRefineCandidateFaces
(
...
tnbLib::label tnbLib::meshRefinement::markSurfaceRefinement
(
	const label nAllowRefine,
...
tnbLib::label tnbLib::meshRefinement::countMatches
(
...
tnbLib::label tnbLib::meshRefinement::markSurfaceCurvatureRefinement
(
...
bool tnbLib::meshRefinement::isGap
(
...
// Mark small gaps
bool tnbLib::meshRefinement::isNormalGap
(
	const scalar planarCos,
	const vector& point0,
	const vector& normal0,
...
) const
{
	...
	if (magD > mergeDistance())
	{
		...
		if (avg != vector::zero)
		{
			...
			if (mag(avg&d) > tnbLib::cos(degToRad(45)))
			{
				return true;
			}
			else
...
bool tnbLib::meshRefinement::checkProximity
(
	const scalar planarCos,
	const label nAllowRefine,
...
tnbLib::label tnbLib::meshRefinement::markProximityRefinement
(
	const scalar planarCos,
	const label nAllowRefine,
	const labelList& neiLevel,
...
tnbLib::labelList tnbLib::meshRefinement::refineCandidates
(
	const pointField& keepPoints,
	const scalar curvature,
...
) const
{
	...
	else
	{
		...
		const scalar planarCos = tnbLib::cos(degToRad(planarAngle));
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::meshRefinement::refine
(
...
tnbLib::meshRefinement::refineAndBalance
(
	const string& msg,
...
tnbLib::autoPtr<tnbLib::mapDistributePolyMesh>
tnbLib::meshRefinement::balanceAndRefine
(
	const string& msg,
	decompositionMethod& decomposer,
	fvMeshDistribute& distributor,
