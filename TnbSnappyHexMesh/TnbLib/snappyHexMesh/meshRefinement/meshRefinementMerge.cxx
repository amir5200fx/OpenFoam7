...
//tnbLib::label tnbLib::meshRefinement::mergePatchFaces
//(
//    const scalar minCos,
...
//tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::meshRefinement::mergeEdges
//(
//    const scalar minCos
//)
//{
...
tnbLib::label tnbLib::meshRefinement::mergePatchFacesUndo
(
	const scalar minCos,
	const scalar concaveCos,
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::meshRefinement::doRemovePoints
(
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::meshRefinement::doRestorePoints
(
	removePoints& pointRemover,
...
tnbLib::labelList tnbLib::meshRefinement::collectFaces
(
...
tnbLib::labelList tnbLib::meshRefinement::growFaceCellFace
(
	const labelHashSet& set
) const
{
...
// Remove points not used by any face or points used by only two faces where
// the edges are in line
tnbLib::label tnbLib::meshRefinement::mergeEdgesUndo
(
	const scalar minCos,
	const dictionary& motionDict
)
