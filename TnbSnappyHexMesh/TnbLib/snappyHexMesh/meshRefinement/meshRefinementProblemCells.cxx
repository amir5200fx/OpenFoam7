...
void tnbLib::meshRefinement::markBoundaryFace
(
	const label facei,
...
void tnbLib::meshRefinement::findNearest
(
...
tnbLib::Map<tnbLib::label> tnbLib::meshRefinement::findEdgeConnectedProblemCells
(
...
) const
{
	...
	forAll(candidateFaces, i)
	{
		...
		if (angle >= 0)
		{
			if (mag(n & nearestNormal[i]) < tnbLib::sin(angle))
			{
...
// cell centres
bool tnbLib::meshRefinement::isCollapsedFace
(
...
bool tnbLib::meshRefinement::isCollapsedCell
(
	const pointField& points,
...
tnbLib::labelList tnbLib::meshRefinement::nearestPatch
(
...
tnbLib::labelList tnbLib::meshRefinement::markFacesOnProblemCells
(
...
tnbLib::labelList tnbLib::meshRefinement::markFacesOnProblemCellsGeometric
(
