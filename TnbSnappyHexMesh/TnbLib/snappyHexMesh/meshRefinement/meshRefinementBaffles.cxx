...
tnbLib::label tnbLib::meshRefinement::createBaffle
(
	const label facei,
...
void tnbLib::meshRefinement::getBafflePatches
(
...
tnbLib::Map<tnbLib::labelPair> tnbLib::meshRefinement::getZoneBafflePatches
(
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::meshRefinement::createBaffles
(
...
void tnbLib::meshRefinement::checkZoneFaces() const
{
	const faceZoneMesh& fZones = mesh_.faceZones();
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::meshRefinement::createZoneBaffles
(
	const labelList& globalToMasterPatch,
	const labelList& globalToSlavePatch,
...
tnbLib::List<tnbLib::labelPair> tnbLib::meshRefinement::freeStandingBaffles
(
...
) const
{
	...
	if (nFiltered > 0)
	{
		...
		const scalar planarAngleCos = tnbLib::cos(degToRad(planarAngle));
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::meshRefinement::mergeBaffles
(
	const List<labelPair>& couples
)
{
...
void tnbLib::meshRefinement::findCellZoneGeometric
(
	const pointField& neiCc,
...
void tnbLib::meshRefinement::findCellZoneInsideWalk
(
...
bool tnbLib::meshRefinement::calcRegionToZone
(
...
void tnbLib::meshRefinement::findCellZoneTopo
(
...
void tnbLib::meshRefinement::makeConsistentFaceIndex
(
...
void tnbLib::meshRefinement::handleSnapProblems
(
...
tnbLib::labelList tnbLib::meshRefinement::freeStandingBaffleFaces
(
...
void tnbLib::meshRefinement::calcPatchNumMasterFaces
(
...
tnbLib::label tnbLib::meshRefinement::markPatchZones
(
	const indirectPrimitivePatch& patch,
...
void tnbLib::meshRefinement::consistentOrientation
(
	const PackedBoolList& isMasterFace,
	const indirectPrimitivePatch& patch,
	const labelList& nMasterFacesPerEdge,
...
void tnbLib::meshRefinement::baffleAndSplitMesh
(
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::meshRefinement::splitMesh
(
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::meshRefinement::dupNonManifoldPoints
(
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::meshRefinement::zonify
(
	const point& keepPoint,
