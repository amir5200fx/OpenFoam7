...
#include <cyclicSlipPointPatchFields.hxx>
...
namespace tnbLib
{
	...
	const char* tnbLib::NamedEnum
		<
		tnbLib::meshRefinement::IOdebugType,
		5
		>::names[] =
	{
		"mesh",
	...
	const char* tnbLib::NamedEnum
		<
		tnbLib::meshRefinement::IOoutputType,
		1
		>::names[] =
	{
		"layerInfo"
	...
	const char* tnbLib::NamedEnum
		<
		tnbLib::meshRefinement::IOwriteType,
		5
		>::names[] =
	{
		"mesh",
...
const tnbLib::NamedEnum<tnbLib::meshRefinement::IOdebugType, 5>
tnbLib::meshRefinement::IOdebugTypeNames;

const tnbLib::NamedEnum<tnbLib::meshRefinement::IOoutputType, 1>
tnbLib::meshRefinement::IOoutputTypeNames;

const tnbLib::NamedEnum<tnbLib::meshRefinement::IOwriteType, 5>
tnbLib::meshRefinement::IOwriteTypeNames;


tnbLib::meshRefinement::writeType tnbLib::meshRefinement::writeLevel_;

tnbLib::meshRefinement::outputType tnbLib::meshRefinement::outputLevel_;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void tnbLib::meshRefinement::calcNeighbourData
(
	labelList& neiLevel,
	pointField& neiCc
)  const
...
void tnbLib::meshRefinement::updateIntersections(const labelList& changedFaces)
{
	const pointField& cellCentres = mesh_.cellCentres();
...
void tnbLib::meshRefinement::testSyncPointList
(
	const string& msg,
	const polyMesh& mesh,
...
void tnbLib::meshRefinement::checkData()
{
...
void tnbLib::meshRefinement::setInstance(const fileName& inst)
{
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::meshRefinement::doRemoveCells
(
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::meshRefinement::splitFaces
(
...
//void tnbLib::meshRefinement::getCoupledRegionMaster
//(
...
//
//
//void tnbLib::meshRefinement::calcLocalRegions
//(
//    const globalIndex& globalCells,
...
//
//
//tnbLib::label tnbLib::meshRefinement::getShiftedRegion
//(
...
//void tnbLib::meshRefinement::addUnique(const label elem, labelList& lst)
//{
...
//
//
//void tnbLib::meshRefinement::calcRegionRegions
//(
//    const labelList& globalRegion,
//    const Map<label>& globalToLocalRegion,
//    const Map<label>& coupledRegionToMaster,
...
tnbLib::meshRefinement::meshRefinement
(
	fvMesh& mesh,
...
tnbLib::label tnbLib::meshRefinement::countHits() const
{
	// Stats on edges to test. Count proc faces only once.
	PackedBoolList isMasterFace(syncTools::getMasterFaces(mesh_));
...
//tnbLib::labelList tnbLib::meshRefinement::decomposeCombineRegions
//(
//    const scalarField& cellWeights,
//    const boolList& blockedFace,
...
tnbLib::autoPtr<tnbLib::mapDistributePolyMesh> tnbLib::meshRefinement::balance
(
...
tnbLib::labelList tnbLib::meshRefinement::intersectedFaces() const
{
...
tnbLib::labelList tnbLib::meshRefinement::intersectedPoints() const
{
...
tnbLib::autoPtr<tnbLib::indirectPrimitivePatch> tnbLib::meshRefinement::makePatch
(
	const polyMesh& mesh,
...
tnbLib::tmp<tnbLib::pointVectorField> tnbLib::meshRefinement::makeDisplacementField
(
...
void tnbLib::meshRefinement::checkCoupledFaceZones(const polyMesh& mesh)
{
...
void tnbLib::meshRefinement::calculateEdgeWeights
(
	const polyMesh& mesh,
...
tnbLib::label tnbLib::meshRefinement::addMeshedPatch
(
	const word& name,
...
tnbLib::labelList tnbLib::meshRefinement::meshedPatches() const
{
	const polyBoundaryMesh& patches = mesh_.boundaryMesh();
...
void tnbLib::meshRefinement::selectSeparatedCoupledFaces(boolList& selected) const
{
	const polyBoundaryMesh& patches = mesh_.boundaryMesh();
...
tnbLib::label tnbLib::meshRefinement::findRegion
(
	const polyMesh& mesh,
...
tnbLib::autoPtr<tnbLib::mapPolyMesh> tnbLib::meshRefinement::splitMeshRegions
(
...
void tnbLib::meshRefinement::distribute(const mapDistributePolyMesh& map)
{
...
void tnbLib::meshRefinement::updateMesh
(
...
void tnbLib::meshRefinement::storeData
(
...
bool tnbLib::meshRefinement::write() const
{
...
tnbLib::PackedBoolList tnbLib::meshRefinement::getMasterPoints
(
	const polyMesh& mesh,
	const labelList& meshPoints
)
...
tnbLib::PackedBoolList tnbLib::meshRefinement::getMasterEdges
(
	const polyMesh& mesh,
...
void tnbLib::meshRefinement::printMeshInfo(const bool debug, const string& msg)
const
{
...
tnbLib::word tnbLib::meshRefinement::timeName() const
{
...
void tnbLib::meshRefinement::dumpRefinementLevel() const
{
...
void tnbLib::meshRefinement::dumpIntersections(const fileName& prefix) const
{
	{
		const pointField& cellCentres = mesh_.cellCentres();
...
void tnbLib::meshRefinement::write
(
...
tnbLib::meshRefinement::writeType tnbLib::meshRefinement::writeLevel()
{
	return writeLevel_;
}


void tnbLib::meshRefinement::writeLevel(const writeType flags)
{
	writeLevel_ = flags;
}


tnbLib::meshRefinement::outputType tnbLib::meshRefinement::outputLevel()
{
	return outputLevel_;
}


void tnbLib::meshRefinement::outputLevel(const outputType flags)
{
	outputLevel_ = flags;
}
