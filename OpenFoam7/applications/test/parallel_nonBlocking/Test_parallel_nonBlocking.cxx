...
int tnbLib::Test_parallel_nonBlocking(int argc, char* argv[])
{
...
#include <createTime.lxx>
	...
	label request1 = -1;
	{
		tnbLib::reduce(data1, sumOp<scalar>(), Pstream::msgType(), request1);
	}

	scalar data2 = 0.1;
	label request2 = -1;
	{
		tnbLib::reduce(data2, sumOp<scalar>(), Pstream::msgType(), request2);
	}
