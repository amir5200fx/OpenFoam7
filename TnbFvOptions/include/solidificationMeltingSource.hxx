#pragma once
#ifndef _solidificationMeltingSource_Header
#define _solidificationMeltingSource_Header
...
namespace tnbLib
{
	namespace fv
	{
		...
		public:
			...
			static FoamFvOptions_EXPORT const NamedEnum<thermoMode, 2> thermoModeTypeNames_;
		...
		private:
			...
			FoamFvOptions_EXPORT tmp<volScalarField> Cp() const;

			//- Return the gravity vector
			FoamFvOptions_EXPORT vector g() const;

			//- Update the model
			FoamFvOptions_EXPORT void update(const volScalarField& Cp);
		...
		public:
			...
			static const char* typeName_() { return "solidificationMeltingSource"; }
			...
			FoamFvOptions_EXPORT solidificationMeltingSource
			(
			...
			FoamFvOptions_EXPORT virtual void addSup(fvMatrix<scalar>& eqn, const label fieldi);

			//- Add implicit contribution to momentum equation
			FoamFvOptions_EXPORT virtual void addSup(fvMatrix<vector>& eqn, const label fieldi);
...
//#ifdef NoRepository
//#include <solidificationMeltingSourceTemplates.cxx>
//#endif

#include <solidificationMeltingSourceTemplatesI.hxx>

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

#endif // !_solidificationMeltingSource_Header
